...
Tonyu.classes.user.Boot=Tonyu.klass(Tonyu.classes.kernel.Actor,[],{
...
Tonyu.klass.addMeta(Tonyu.classes.user.Boot,{"fullName":"user.Boot","namespace":"user","shortName":"Boot","decls":{"methods":{"main":{"nowait":false},"initSprites":{"nowait":false},"initThread":{"nowait":false},"stop":{"nowait":false},"initFPSParams":{"nowait":true},"setFrameRate":{"nowait":true},"getMeasureFps":{"nowait":true},"getMeasureRps":{"nowait":true},"waitFrame":{"nowait":false},"measureFps":{"nowait":true}}}});
...
Tonyu.klass.ensureNamespace(Tonyu.classes,'user');
Tonyu.classes.user.PlainChar=Tonyu.klass(Tonyu.classes.kernel.Actor,[],{
  ...
  drawText :function _trc_PlainChar_drawText(x,y,text,col,size) {
    ...
    tp = _this.all(Tonyu.classes.user.T1Text).find(function (t) {
  ...
  drawLine :function _trc_PlainChar_drawLine(x,y,tx,ty,col) {
    ...
    tp = _this.all(Tonyu.classes.user.T1Line).find(function (t) {
...
Tonyu.klass.addMeta(Tonyu.classes.user.PlainChar,{"fullName":"user.PlainChar","namespace":"user","shortName":"PlainChar","decls":{"methods":{"main":{"nowait":false},"new":{"nowait":false},"wait":{"nowait":false},"notify":{"nowait":false},"draw":{"nowait":true},"setVisible":{"nowait":false},"onDraw":{"nowait":false},"update":{"nowait":false},"onUpdate":{"nowait":true},"initSprite":{"nowait":false},"tMain":{"nowait":false},"angle1":{"nowait":false},"color":{"nowait":false},"drawText":{"nowait":false},"drawLine":{"nowait":false},"appear":{"nowait":false},"trunc":{"nowait":true},"loadPage":{"nowait":false}}}});

Tonyu.klass.ensureNamespace(Tonyu.classes,'user');
Tonyu.classes.user.SecretChar=Tonyu.klass(Tonyu.classes.user.PlainChar,[],{
...
Tonyu.klass.ensureNamespace(Tonyu.classes,'user');
Tonyu.classes.user.SpriteChar=Tonyu.klass(Tonyu.classes.user.PlainChar,[],{
...
Tonyu.klass.ensureNamespace(Tonyu.classes,'user');
Tonyu.classes.user.T1Page=Tonyu.klass(Tonyu.classes.user.PlainChar,[],{
...
Tonyu.klass.ensureNamespace(Tonyu.classes,'user');
Tonyu.classes.user.TextChar=Tonyu.klass(Tonyu.classes.user.PlainChar,[],{
...
Tonyu.klass.ensureNamespace(Tonyu.classes,'user');
Tonyu.classes.user.Ball=Tonyu.klass(Tonyu.classes.user.SpriteChar,[],{
...
Tonyu.klass.addMeta(Tonyu.classes.user.Ball,{"fullName":"user.Ball","namespace":"user","shortName":"Ball","decls":{"methods":{"main":{"nowait":false},"tes":{"nowait":true},"tokuten":{"nowait":false}}}});
...
Tonyu.klass.ensureNamespace(Tonyu.classes,'user');
Tonyu.classes.user.Enemy=Tonyu.klass(Tonyu.classes.user.SpriteChar,[],{
...
Tonyu.klass.addMeta(Tonyu.classes.user.Enemy,{"fullName":"user.Enemy","namespace":"user","shortName":"Enemy","decls":{"methods":{"main":{"nowait":false},"onUpdate":{"nowait":true},"attack":{"nowait":false}}}});
...
Tonyu.klass.ensureNamespace(Tonyu.classes,'user');
Tonyu.classes.user.Player=Tonyu.klass(Tonyu.classes.user.SpriteChar,[],{
...
Tonyu.klass.ensureNamespace(Tonyu.classes,'user');
Tonyu.classes.user.Racket=Tonyu.klass(Tonyu.classes.user.SpriteChar,[],{
...
Tonyu.klass.addMeta(Tonyu.classes.user.Racket,{"fullName":"user.Racket","namespace":"user","shortName":"Racket","decls":{"methods":{"main":{"nowait":false},"crashTo":{"nowait":true}}}});

Tonyu.klass.ensureNamespace(Tonyu.classes,'user');
Tonyu.classes.user.Replay=Tonyu.klass(Tonyu.classes.user.TextChar,[],{
...
Tonyu.klass.addMeta(Tonyu.classes.user.Replay,{"fullName":"user.Replay","namespace":"user","shortName":"Replay","decls":{"methods":{"main":{"nowait":false},"onMouseDown":{"nowait":false},"show":{"nowait":true},"replay":{"nowait":false}}}});

Tonyu.klass.ensureNamespace(Tonyu.classes,'user');
Tonyu.classes.user.Tokuten=Tonyu.klass(Tonyu.classes.user.DxChar,[],{
...
Tonyu.klass.addMeta(Tonyu.classes.user.Tokuten,{"fullName":"user.Tokuten","namespace":"user","shortName":"Tokuten","decls":{"methods":{"main":{"nowait":false},"setValue":{"nowait":false}}}});
