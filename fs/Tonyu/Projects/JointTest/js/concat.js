...
Tonyu.klass.define({
  ...
  methods: {
    main :function _trc_SeeSaw_main() {
      ...
      //$LASTPOS=2000021;//user.SeeSaw:21
      _this.addRevoluteJoint({x: 300,y: 200,lowerAngle: - 30,upperAngle: 30});
      //$LASTPOS=2000082;//user.SeeSaw:82
      while (true) {
        //$LASTPOS=2000100;//user.SeeSaw:100
        if (_this.getkey(32)) {
          //$LASTPOS=2000115;//user.SeeSaw:115
          _this.applyImpulse(0,- 30);
        }
        //$LASTPOS=2000140;//user.SeeSaw:140
        _this.update();
