  ...
  methods: {
    ...
    initCanvasEvents :function _trc_InputDevice_initCanvasEvents(cvj) {
      ...
      Tonyu.globals.$handleTouch=(function anonymous_896(e) {
        ...
        Tonyu.globals.$a=("touce!"+e);
        //$LASTPOS=8000938;//kernel.InputDevice:938
        _this.touchEmu=false;
        //$LASTPOS=8000963;//kernel.InputDevice:963
        p = cvj.offset();
        //$LASTPOS=8000992;//kernel.InputDevice:992
        e.preventDefault();
        //$LASTPOS=8001021;//kernel.InputDevice:1021
        ts = e.originalEvent.changedTouches;
        //$LASTPOS=8001069;//kernel.InputDevice:1069
        //$LASTPOS=8001074;//kernel.InputDevice:1074
        i = 0;
        while(i<ts.length) {
          {
            //$LASTPOS=8001119;//kernel.InputDevice:1119
            src = ts[i];
            //$LASTPOS=8001147;//kernel.InputDevice:1147
            dst = Tonyu.globals.$touches.findById(src.identifier);
            //$LASTPOS=8001203;//kernel.InputDevice:1203
            if (! dst) {
              //$LASTPOS=8001232;//kernel.InputDevice:1232
              //$LASTPOS=8001237;//kernel.InputDevice:1237
              j = 0;
              while(j<Tonyu.globals.$touches.length) {
                {
                  //$LASTPOS=8001295;//kernel.InputDevice:1295
                  if (! Tonyu.globals.$touches[j].touched) {
                    //$LASTPOS=8001348;//kernel.InputDevice:1348
                    dst=Tonyu.globals.$touches[j];
                    //$LASTPOS=8001390;//kernel.InputDevice:1390
            ...
            //$LASTPOS=8001523;//kernel.InputDevice:1523
            if (dst) {
              //$LASTPOS=8001551;//kernel.InputDevice:1551
              _this.mp={x: src.pageX-p.left,y: src.pageY-p.top};
              //$LASTPOS=8001612;//kernel.InputDevice:1612
              _this.mp=Tonyu.globals.$Screen.canvas2buf(_this.mp);
              //$LASTPOS=8001656;//kernel.InputDevice:1656
              dst.x=_this.mp.x;
              //$LASTPOS=8001685;//kernel.InputDevice:1685
              dst.y=_this.mp.y;
              //$LASTPOS=8001714;//kernel.InputDevice:1714
              if (! dst.touched) {
                //$LASTPOS=8001731;//kernel.InputDevice:1731
                dst.touched=1;
              }
        ...
        //$LASTPOS=8001781;//kernel.InputDevice:1781
        Tonyu.globals.$mouseX=Tonyu.globals.$touches[0].x;
        //$LASTPOS=8001813;//kernel.InputDevice:1813
        Tonyu.globals.$mouseY=Tonyu.globals.$touches[0].y;
        //$LASTPOS=8001845;//kernel.InputDevice:1845
        _this.handleListeners();
      });
      //$LASTPOS=8001877;//kernel.InputDevice:1877
      Tonyu.globals.$handleTouchEnd=(function anonymous_1893(e) {
        var ts;
        var i;
        var src;
        var dst;
        
        //$LASTPOS=8001909;//kernel.InputDevice:1909
        ts = e.originalEvent.changedTouches;
        //$LASTPOS=8001957;//kernel.InputDevice:1957
        //$LASTPOS=8001962;//kernel.InputDevice:1962
        i = 0;
        while(i<ts.length) {
          {
            //$LASTPOS=8002007;//kernel.InputDevice:2007
            src = ts[i];
            //$LASTPOS=8002035;//kernel.InputDevice:2035
            dst = Tonyu.globals.$touches.findById(src.identifier);
            //$LASTPOS=8002091;//kernel.InputDevice:2091
            if (dst) {
              //$LASTPOS=8002119;//kernel.InputDevice:2119
              dst.touched=0;
              //$LASTPOS=8002151;//kernel.InputDevice:2151
              dst.identifier=- 1;
        ...
        //$LASTPOS=8002205;//kernel.InputDevice:2205
        _this.handleListeners();
      });
      //$LASTPOS=8002237;//kernel.InputDevice:2237
      handleMouse = (function anonymous_2253(e) {
        
        //$LASTPOS=8002258;//kernel.InputDevice:2258
        Tonyu.globals.$handleMouse(e);
      });
      //$LASTPOS=8002282;//kernel.InputDevice:2282
      handleTouch = (function anonymous_2298(e) {
        
        //$LASTPOS=8002303;//kernel.InputDevice:2303
        Tonyu.globals.$handleTouch(e);
      });
      //$LASTPOS=8002327;//kernel.InputDevice:2327
      handleTouchEnd = (function anonymous_2346(e) {
        
        //$LASTPOS=8002351;//kernel.InputDevice:2351
        Tonyu.globals.$handleTouchEnd(e);
      });
      //$LASTPOS=8002378;//kernel.InputDevice:2378
      d = $.data(cv,"events");
      //$LASTPOS=8002410;//kernel.InputDevice:2410
      if (! d) {
        //$LASTPOS=8002429;//kernel.InputDevice:2429
        $.data(cv,"events","true");
        //$LASTPOS=8002466;//kernel.InputDevice:2466
        cvj.mousedown(handleMouse);
        //$LASTPOS=8002503;//kernel.InputDevice:2503
        cvj.mousemove(handleMouse);
        //$LASTPOS=8002540;//kernel.InputDevice:2540
        cvj.on("touchstart",handleTouch);
        //$LASTPOS=8002583;//kernel.InputDevice:2583
        cvj.on("touchmove",handleTouch);
        //$LASTPOS=8002625;//kernel.InputDevice:2625
    ...
    update :function _trc_InputDevice_update() {
      ...
      //$LASTPOS=8002690;//kernel.InputDevice:2690
      _it_106=Tonyu.iterator(Tonyu.globals.$touches,1);
      while(_it_106.next()) {
        i=_it_106[0];
        
        //$LASTPOS=8002725;//kernel.InputDevice:2725
        if (i.touched>0) {
          //$LASTPOS=8002743;//kernel.InputDevice:2743
          i.touched++;
          
        }
        //$LASTPOS=8002766;//kernel.InputDevice:2766
        if (i.touched==- 1) {
          //$LASTPOS=8002785;//kernel.InputDevice:2785
          i.touched=1;
        }
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    loadFromProject :function _trc_T2MediaPlayer_loadFromProject(prj) {
      ...
      _it_205=Tonyu.iterator(r.sounds,1);
      while(_it_205.next()) {
        s=_it_205[0];
...
Tonyu.klass.define({
  ...
  methods: {
    main :function _trc_Main_main() {
      ...
      //$LASTPOS=37000001;//kernel.Main:1
      while (true) {
        //$LASTPOS=37000019;//kernel.Main:19
        _this.print(Tonyu.globals.$a);
        //$LASTPOS=37000029;//kernel.Main:29
        _this.update();
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    initSprites :function _trc_Boot_initSprites() {
      ...
      _it_236=Tonyu.iterator(r.names,2);
      while(_it_236.next()) {
        name=_it_236[0];
        val=_it_236[1];
