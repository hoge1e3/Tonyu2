...
Tonyu.classes.user.Test=Tonyu.klass(Tonyu.classes.kernel.Actor,[],{
  main :function _trc_Test_main() {
    ...
    //$LASTPOS=38000000;//user.Test:0
    Tonyu.globals.$map=new Tonyu.classes.kernel.Map({chipWidth: 32,chipHeight: 32});
    //$LASTPOS=38000043;//user.Test:43
    Tonyu.globals.$map.load("map.json");
    //$LASTPOS=38000066;//user.Test:66
    Tonyu.globals.$map.zOrder=1000;
    //$LASTPOS=38000084;//user.Test:84
    _this.x=20;
    //$LASTPOS=38000089;//user.Test:89
    _this.y=20;
    //$LASTPOS=38000096;//user.Test:96
    while (true) {
      //$LASTPOS=38000114;//user.Test:114
      _this.x++;
      //$LASTPOS=38000123;//user.Test:123
      _this.y++;
      //$LASTPOS=38000132;//user.Test:132
      Tonyu.globals.$Screen.scrollTo(_this.x-Tonyu.globals.$screenWidth/2,_this.y-Tonyu.globals.$screenHeight/2);
      //$LASTPOS=38000210;//user.Test:210
      _this.update();
      
    }
    //$LASTPOS=38000222;//user.Test:222
    _this.a=6601;
  },
