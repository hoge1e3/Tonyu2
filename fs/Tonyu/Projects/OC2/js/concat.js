...
Tonyu.klass.define({
  ...
  methods: {
    main :function _trc_Player_main() {
      ...
      //$LASTPOS=2000059;//user.Player:59
      while (true) {
        //$LASTPOS=2000077;//user.Player:77
        if (_this.getkey("right")>0) {
          //$LASTPOS=2000099;//user.Player:99
          _this.vx+=0.6;
        }
        //$LASTPOS=2000113;//user.Player:113
        if (_this.getkey("left")>0) {
          //$LASTPOS=2000135;//user.Player:135
          _this.vx-=0.6;
        }
        //$LASTPOS=2000149;//user.Player:149
        if (_this.getkey("space")==1&&_this.contactTo(Tonyu.classes.user.Block)) {
          //$LASTPOS=2000202;//user.Player:202
          _this.vy=- 10;
          
        }
        //$LASTPOS=2000228;//user.Player:228
        _this.update();
