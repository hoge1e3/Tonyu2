Tonyu.klass.define({
  ...
  methods: {
    main :function _trc_Floor_main() {
      ...
      //$LASTPOS=1000193;//user.Floor:193
      _this.parallel("roll");
      //$LASTPOS=1000211;//user.Floor:211
      //$LASTPOS=1000215;//user.Floor:215
      _this.i=0;
      while(_this.i<10) {
        {
          //$LASTPOS=1000235;//user.Floor:235
          _this.updateEx(10);
          //$LASTPOS=1000253;//user.Floor:253
    ...
    onAppear :function _trc_Floor_onAppear() {
      ...
      //$LASTPOS=1000038;//user.Floor:38
      _this.isStatic=true;
      //$LASTPOS=1000057;//user.Floor:57
      _this.x=250;
      //$LASTPOS=1000063;//user.Floor:63
      _this.y=300;
      //$LASTPOS=1000069;//user.Floor:69
      _this.scaleX=10;
      //$LASTPOS=1000079;//user.Floor:79
      _this.scaleY=1;
      //$LASTPOS=1000088;//user.Floor:88
      _this.p=5;
      //$LASTPOS=1000097;//user.Floor:97
    ...
    roll :function _trc_Floor_roll() {
      ...
      //$LASTPOS=1000295;//user.Floor:295
      t = 0;
      //$LASTPOS=1000308;//user.Floor:308
      while (true) {
        //$LASTPOS=1000330;//user.Floor:330
        _this.rotation=Tonyu.globals.$mouseX;
        //$LASTPOS=1000368;//user.Floor:368
        t++;
        //$LASTPOS=1000381;//user.Floor:381
        _this.update();
...
Tonyu.klass.define({
  ...
  methods: {
    main :function _trc_Neko_main() {
      ...
      //$LASTPOS=2000133;//user.Neko:133
      _this.a=0;
      //$LASTPOS=2000138;//user.Neko:138
      while (true) {
        //$LASTPOS=2000156;//user.Neko:156
        if (_this.abs(_this.x-_this.px)>1) {
          //$LASTPOS=2000183;//user.Neko:183
          _this.scaleY=1;
          //$LASTPOS=2000201;//user.Neko:201
          if (_this.x>_this.px) {
            //$LASTPOS=2000211;//user.Neko:211
            _this.scaleX=1;
          } else {
            //$LASTPOS=2000226;//user.Neko:226
            _this.scaleX=- 1;
          }
          //$LASTPOS=2000245;//user.Neko:245
          _this.p=_this.floor(Tonyu.globals.$pat_neko+3+_this.a);
          //$LASTPOS=2000277;//user.Neko:277
          _this.a+=_this.abs(_this.x-_this.px)*0.1;
          //$LASTPOS=2000303;//user.Neko:303
          if (_this.a>2) {
            //$LASTPOS=2000312;//user.Neko:312
            _this.a=0;
          }
          
        } else {
          //$LASTPOS=2000338;//user.Neko:338
          _this.p=Tonyu.globals.$pat_neko;
          
        }
        //$LASTPOS=2000361;//user.Neko:361
        if (_this.y>Tonyu.globals.$screenHeight) {
          //$LASTPOS=2000393;//user.Neko:393
          _this.applyForce(- 1,0);
          //$LASTPOS=2000419;//user.Neko:419
          _this.moveBy(200-_this.x,- Tonyu.globals.$screenHeight);
          
        }
        //$LASTPOS=2000459;//user.Neko:459
        if (_this.x<0) {
          //$LASTPOS=2000468;//user.Neko:468
          _this.applyImpulse(1,0);
        }
        //$LASTPOS=2000491;//user.Neko:491
        if (_this.x>Tonyu.globals.$screenWidth) {
          //$LASTPOS=2000511;//user.Neko:511
          _this.applyImpulse(- 1,0);
        }
        //$LASTPOS=2000535;//user.Neko:535
        _this.px=_this.x;
        //$LASTPOS=2000545;//user.Neko:545
        _this.update();
