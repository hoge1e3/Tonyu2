Tonyu.klass.define({
  ...
  methods: {
    ...
    releaseEventMod :function _trc_EventMod_releaseEventMod() {
      ...
      _it_550=Tonyu.iterator(_this._eventHandlers,2);
      while(_it_550.next()) {
        k=_it_550[0];
        v=_it_550[1];
  ...
  methods: {
    ...
    killThreadGroup :function _trc_ThreadGroupMod_killThreadGroup() {
      ...
      if (_this.threads) {
        ...
        _it_575=Tonyu.iterator(_this.threads,1);
        while(_it_575.next()) {
          thread=_it_575[0];
      ...
      if (_this.threadGroups) {
        ...
        _it_576=Tonyu.iterator(_this.threadGroups,1);
        while(_it_576.next()) {
          threadGroup=_it_576[0];
  ...
  methods: {
    ...
    attr :function _trc_TQuery_attr() {
      ...
      if (values) {
        ...
        _it_582=Tonyu.iterator(_this,1);
        while(_it_582.next()) {
          e=_it_582[0];
    ...
    maxs :function _trc_TQuery_maxs(key) {
      ...
      _it_588=Tonyu.iterator(_this,1);
      while(_it_588.next()) {
        o=_it_588[0];
    ...
    max :function _trc_TQuery_max(key) {
      ...
      _it_606=Tonyu.iterator(_this,1);
      while(_it_606.next()) {
        o=_it_606[0];
    ...
    min :function _trc_TQuery_min(key) {
      ...
      _it_612=Tonyu.iterator(_this,1);
      while(_it_612.next()) {
        o=_it_612[0];
    ...
    find :function _trc_TQuery_find(f) {
      ...
      _it_618=Tonyu.iterator(_this,1);
      while(_it_618.next()) {
        o=_it_618[0];
    ...
    apply :function _trc_TQuery_apply(name,args) {
      ...
      _it_622=Tonyu.iterator(_this,1);
      while(_it_622.next()) {
        o=_it_622[0];
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    update :function _trc_InputDevice_update() {
      ...
      _it_656=Tonyu.iterator(Tonyu.globals.$touches,1);
      while(_it_656.next()) {
        i=_it_656[0];
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    update :function _trc_Keys_update() {
      ...
      _it_664=Tonyu.iterator(_this.stats,1);
      while(_it_664.next()) {
        i=_it_664[0];
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    fire :function _trc_EventHandler_fire(args) {
      ...
      _it_691=Tonyu.iterator(_this.listeners,1);
      while(_it_691.next()) {
        h=_it_691[0];
  ...
  methods: {
    ...
    releaseMML :function _trc_PlayMod_releaseMML() {
      ...
      if (Tonyu.globals.$MMLS) {
        ...
        _it_696=Tonyu.iterator(Tonyu.globals.$MMLS,2);
        while(_it_696.next()) {
          k=_it_696[0];
          v=_it_696[1];
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    stepsAll :function _trc_Scheduler_stepsAll() {
      ...
      _it_711=Tonyu.iterator(_this.cur,1);
      while(_it_711.next()) {
        t=_it_711[0];
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    loadFromProject :function _trc_T2MediaPlayer_loadFromProject(prj) {
      ...
      _it_777=Tonyu.iterator(r.sounds,1);
      while(_it_777.next()) {
        s=_it_777[0];
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    initSprites :function _trc_Boot_initSprites() {
      ...
      _it_808=Tonyu.iterator(r.names,2);
      while(_it_808.next()) {
        name=_it_808[0];
        val=_it_808[1];
