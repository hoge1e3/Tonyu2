  ...
  methods: {
    ...
    initialize :function _trc_BaseActor_initialize(x,y,p) {
      ...
      if (Tonyu.runMode) {
        ...
        //$LASTPOS=11000474;//kernel.BaseActor:474
        _this.registerEventHandler("screenOut",new Tonyu.classes.kernel.ScreenOutHandler);
        
      }
      //$LASTPOS=11000542;//kernel.BaseActor:542
      if (typeof  x=="object") {
        //$LASTPOS=11000566;//kernel.BaseActor:566
        Tonyu.extend(_this,x);
      } else {
        //$LASTPOS=11000598;//kernel.BaseActor:598
        if (typeof  x=="number") {
          //$LASTPOS=11000633;//kernel.BaseActor:633
          _this.x=x;
          //$LASTPOS=11000652;//kernel.BaseActor:652
          _this.y=y;
          //$LASTPOS=11000671;//kernel.BaseActor:671
          _this.p=p;
          
        }
      }
      //$LASTPOS=11000693;//kernel.BaseActor:693
      if (_this.scaleX==null) {
        //$LASTPOS=11000711;//kernel.BaseActor:711
        _this.scaleX=1;
      }
      //$LASTPOS=11000726;//kernel.BaseActor:726
      if (_this.rotation==null) {
        //$LASTPOS=11000746;//kernel.BaseActor:746
        _this.rotation=0;
      }
      //$LASTPOS=11000763;//kernel.BaseActor:763
      if (_this.rotate==null) {
        //$LASTPOS=11000781;//kernel.BaseActor:781
        _this.rotate=0;
      }
      //$LASTPOS=11000796;//kernel.BaseActor:796
      if (_this.alpha==null) {
        //$LASTPOS=11000813;//kernel.BaseActor:813
        _this.alpha=255;
      }
      //$LASTPOS=11000829;//kernel.BaseActor:829
      if (_this.zOrder==null) {
        //$LASTPOS=11000847;//kernel.BaseActor:847
        _this.zOrder=0;
      }
      //$LASTPOS=11000862;//kernel.BaseActor:862
      if (_this.age==null) {
        //$LASTPOS=11000877;//kernel.BaseActor:877
        _this.age=0;
      }
      //$LASTPOS=11000889;//kernel.BaseActor:889
      if (_this.anim!=null&&typeof  _this.anim=="object") {
        //$LASTPOS=11000940;//kernel.BaseActor:940
        _this.animMode=true;
        //$LASTPOS=11000964;//kernel.BaseActor:964
        _this.animFrame=0;
        
      } else {
        //$LASTPOS=11000998;//kernel.BaseActor:998
        _this.animMode=false;
        
      }
      //$LASTPOS=11001026;//kernel.BaseActor:1026
      if (_this.animFps==null) {
        //$LASTPOS=11001045;//kernel.BaseActor:1045
        _this.animFps=1;
      }
    },
    ...
    print :function _trc_BaseActor_print(pt) {
      ...
      //$LASTPOS=11001149;//kernel.BaseActor:1149
      console.log.apply(console,arguments);
      //$LASTPOS=11001192;//kernel.BaseActor:1192
      mergedArg = "";
      //$LASTPOS=11001215;//kernel.BaseActor:1215
      if (Tonyu.globals.$consolePanel) {
        //$LASTPOS=11001243;//kernel.BaseActor:1243
        //$LASTPOS=11001247;//kernel.BaseActor:1247
        argCount = 0;
        while(argCount<arguments.length) {
          {
            //$LASTPOS=11001314;//kernel.BaseActor:1314
            mergedArg+=arguments[argCount];
          }
          argCount++;
        }
        //$LASTPOS=11001366;//kernel.BaseActor:1366
        _this.splits=mergedArg.split("\n");
        //$LASTPOS=11001405;//kernel.BaseActor:1405
        //$LASTPOS=11001409;//kernel.BaseActor:1409
        printCount = 0;
        while(printCount<_this.splits.length) {
          {
            //$LASTPOS=11001479;//kernel.BaseActor:1479
            Tonyu.globals.$consolePanel.scroll(0,20);
            //$LASTPOS=11001520;//kernel.BaseActor:1520
            Tonyu.globals.$consolePanel.setFillStyle("white");
            //$LASTPOS=11001570;//kernel.BaseActor:1570
    ...
    setAnimFps :function _trc_BaseActor_setAnimFps(f) {
      ...
      //$LASTPOS=11001693;//kernel.BaseActor:1693
      _this.animFps=f;
      //$LASTPOS=11001714;//kernel.BaseActor:1714
      _this.animFrame=0;
      //$LASTPOS=11001737;//kernel.BaseActor:1737
      _this.animMode=true;
    },
    startAnim :function _trc_BaseActor_startAnim() {
      var _this=this.isTonyuObject?this:Tonyu.not_a_tonyu_object(this);
      
      //$LASTPOS=11001787;//kernel.BaseActor:1787
      _this.animMode=true;
    },
    stopAnim :function _trc_BaseActor_stopAnim() {
      var _this=this.isTonyuObject?this:Tonyu.not_a_tonyu_object(this);
      
      //$LASTPOS=11001836;//kernel.BaseActor:1836
      _this.animMode=false;
    },
    update :function _trc_BaseActor_update() {
      var _this=this.isTonyuObject?this:Tonyu.not_a_tonyu_object(this);
      
      //$LASTPOS=11001878;//kernel.BaseActor:1878
      _this.onUpdate();
      //$LASTPOS=11001895;//kernel.BaseActor:1895
      if (null) {
        //$LASTPOS=11001918;//kernel.BaseActor:1918
        null.suspend();
        //$LASTPOS=11001946;//kernel.BaseActor:1946
        if (Tonyu.globals.$Scheduler) {
          //$LASTPOS=11001962;//kernel.BaseActor:1962
    ...
    updateEx :function _trc_BaseActor_updateEx(updateT) {
      ...
      //$LASTPOS=11002060;//kernel.BaseActor:2060
      updateCount = 0;
      while(updateCount<updateT) {
        {
          //$LASTPOS=11002123;//kernel.BaseActor:2123
          _this.update();
        }
        updateCount++;
      }
    ...
    all :function _trc_BaseActor_all(c) {
      ...
      //$LASTPOS=11002266;//kernel.BaseActor:2266
      res = new Tonyu.classes.kernel.TQuery;
      //$LASTPOS=11002291;//kernel.BaseActor:2291
      Tonyu.globals.$Sprites.sprites.forEach((function anonymous_2316(s) {
        
        //$LASTPOS=11002332;//kernel.BaseActor:2332
        if (s===_this) {
          return _this;
        }
        //$LASTPOS=11002363;//kernel.BaseActor:2363
        if (! c||s instanceof c) {
          //$LASTPOS=11002404;//kernel.BaseActor:2404
          res.push(s);
    ...
    allCrash :function _trc_BaseActor_allCrash(t) {
      ...
      //$LASTPOS=11002511;//kernel.BaseActor:2511
      res = new Tonyu.classes.kernel.TQuery;
      //$LASTPOS=11002536;//kernel.BaseActor:2536
      sp = _this;
      ...
      //$LASTPOS=11002627;//kernel.BaseActor:2627
      Tonyu.globals.$Sprites.sprites.forEach((function anonymous_2652(s) {
        var t2;
        
        //$LASTPOS=11002668;//kernel.BaseActor:2668
        t2;
        //$LASTPOS=11002685;//kernel.BaseActor:2685
        if (s!==_this&&! s.excludeFromAll&&s instanceof t&&(t2=s.getCrashRect())&&Math.abs(t1.x-t2.x)*2<t1.width+t2.width&&Math.abs(t1.y-t2.y)*2<t1.height+t2.height) {
          //$LASTPOS=11002911;//kernel.BaseActor:2911
          res.push(s);
    ...
    crashTo :function _trc_BaseActor_crashTo(t) {
      ...
      //$LASTPOS=11003018;//kernel.BaseActor:3018
    ...
    crashTo1 :function _trc_BaseActor_crashTo1(t) {
      ...
      //$LASTPOS=11003141;//kernel.BaseActor:3141
      if (! t||t._isDead) {
        return false;
      }
      //$LASTPOS=11003269;//kernel.BaseActor:3269
      t1 = _this.getCrashRect();
      //$LASTPOS=11003297;//kernel.BaseActor:3297
      t2 = t.getCrashRect();
    ...
    getCrashRect :function _trc_BaseActor_getCrashRect() {
      ...
      //$LASTPOS=11003609;//kernel.BaseActor:3609
      actWidth = _this.width*_this.scaleX;actHeight;
      //$LASTPOS=11003652;//kernel.BaseActor:3652
      if (typeof  _this.scaleY==="undefined") {
        //$LASTPOS=11003694;//kernel.BaseActor:3694
        actHeight=_this.height*_this.scaleX;
        
      } else {
        //$LASTPOS=11003740;//kernel.BaseActor:3740
    ...
    allWithin :function _trc_BaseActor_allWithin(t,distance) {
      ...
      //$LASTPOS=11003981;//kernel.BaseActor:3981
      res = new Tonyu.classes.kernel.TQuery;
      //$LASTPOS=11004006;//kernel.BaseActor:4006
      sp = _this;
      //$LASTPOS=11004043;//kernel.BaseActor:4043
      t1 = _this.getCrashRect();
      //$LASTPOS=11004071;//kernel.BaseActor:4071
      if (! t1) {
        return res;
      }
      //$LASTPOS=11004097;//kernel.BaseActor:4097
      Tonyu.globals.$Sprites.sprites.forEach((function anonymous_4122(s) {
        var t2;
        
        //$LASTPOS=11004138;//kernel.BaseActor:4138
        t2;
    ...
    within :function _trc_BaseActor_within(t,distance) {
      ...
      //$LASTPOS=11004431;//kernel.BaseActor:4431
      if (! t) {
        return false;
      }
      //$LASTPOS=11004457;//kernel.BaseActor:4457
      if (typeof  t=="function") {
    ...
    within1 :function _trc_BaseActor_within1(t,distance) {
      ...
      //$LASTPOS=11004603;//kernel.BaseActor:4603
      if (! t||t._isDead) {
        return false;
      }
      //$LASTPOS=11004642;//kernel.BaseActor:4642
    ...
    watchHit :function _trc_BaseActor_watchHit(typeA,typeB,onHit) {
      ...
      //$LASTPOS=11004827;//kernel.BaseActor:4827
      Tonyu.globals.$Sprites.watchHit(typeA,typeB,(function anonymous_4860(a,b) {
        
        //$LASTPOS=11004878;//kernel.BaseActor:4878
    ...
    die :function _trc_BaseActor_die() {
      ...
      //$LASTPOS=11005032;//kernel.BaseActor:5032
      _this.killThreadGroup();
      //$LASTPOS=11005104;//kernel.BaseActor:5104
      _this.hide();
      //$LASTPOS=11005117;//kernel.BaseActor:5117
      _this.fireEvent("die");
      //$LASTPOS=11005140;//kernel.BaseActor:5140
      _this._isDead=true;
    },
    hide :function _trc_BaseActor_hide() {
      var _this=this.isTonyuObject?this:Tonyu.not_a_tonyu_object(this);
      
      //$LASTPOS=11005319;//kernel.BaseActor:5319
      if (_this.layer&&typeof  _this.layer.remove=="function") {
        //$LASTPOS=11005374;//kernel.BaseActor:5374
        _this.layer.remove(_this);
        
      } else {
        //$LASTPOS=11005415;//kernel.BaseActor:5415
    ...
    show :function _trc_BaseActor_show(x,y,p) {
      ...
      //$LASTPOS=11005476;//kernel.BaseActor:5476
      if (_this.layer&&typeof  _this.layer.add=="function") {
        //$LASTPOS=11005528;//kernel.BaseActor:5528
        _this.layer.add(_this);
        
      } else {
        //$LASTPOS=11005566;//kernel.BaseActor:5566
        Tonyu.globals.$Sprites.add(_this);
        
      }
      //$LASTPOS=11005598;//kernel.BaseActor:5598
      if (x!=null) {
        //$LASTPOS=11005611;//kernel.BaseActor:5611
        _this.x=x;
      }
      //$LASTPOS=11005626;//kernel.BaseActor:5626
      if (y!=null) {
        //$LASTPOS=11005639;//kernel.BaseActor:5639
        _this.y=y;
      }
      //$LASTPOS=11005654;//kernel.BaseActor:5654
      if (p!=null) {
        //$LASTPOS=11005667;//kernel.BaseActor:5667
        _this.p=p;
      }
    },
    detectShape :function _trc_BaseActor_detectShape() {
      ...
      //$LASTPOS=11005712;//kernel.BaseActor:5712
      if (typeof  _this.p!="number") {
        //$LASTPOS=11005747;//kernel.BaseActor:5747
        if (_this.text!=null) {
          return _this;
        }
        //$LASTPOS=11005780;//kernel.BaseActor:5780
        _this.p=0;
        
      }
      //$LASTPOS=11005797;//kernel.BaseActor:5797
      _this.p=Math.floor(_this.p);
      //$LASTPOS=11005819;//kernel.BaseActor:5819
      _this.pImg=Tonyu.globals.$Sprites.getImageList()[_this.p];
      //$LASTPOS=11005857;//kernel.BaseActor:5857
      if (! _this.pImg) {
        return _this;
      }
      //$LASTPOS=11005881;//kernel.BaseActor:5881
    ...
    waitFor :function _trc_BaseActor_waitFor(f) {
      ...
      //$LASTPOS=11005947;//kernel.BaseActor:5947
      if (null) {
        //$LASTPOS=11005971;//kernel.BaseActor:5971
        null.waitFor(f);
    ...
    animation :function _trc_BaseActor_animation() {
      ...
      _this.age++;
      //$LASTPOS=11006103;//kernel.BaseActor:6103
      if (_this.animMode&&_this.age%_this.animFps==0) {
        //$LASTPOS=11006144;//kernel.BaseActor:6144
        _this.p=_this.anim[_this.animFrame%_this.anim.length];
        //$LASTPOS=11006184;//kernel.BaseActor:6184
        _this.animFrame++;
    ...
    draw :function _trc_BaseActor_draw(ctx) {
      ...
      //$LASTPOS=11006233;//kernel.BaseActor:6233
      if (_this.x==null||_this.y==null||_this._isInvisible) {
        return _this;
      }
      //$LASTPOS=11006286;//kernel.BaseActor:6286
      _this.detectShape();
      //$LASTPOS=11006306;//kernel.BaseActor:6306
      if (_this.pImg) {
        //$LASTPOS=11006327;//kernel.BaseActor:6327
        ctx.save();
        //$LASTPOS=11006348;//kernel.BaseActor:6348
        ctx.translate(_this.x,_this.y);
        //$LASTPOS=11006492;//kernel.BaseActor:6492
        _this.animation();
        //$LASTPOS=11006514;//kernel.BaseActor:6514
        if (_this.rotation!=0) {
          //$LASTPOS=11006549;//kernel.BaseActor:6549
        ...
        //$LASTPOS=11006674;//kernel.BaseActor:6674
        if (typeof  _this.scaleY==="undefined") {
          //$LASTPOS=11006726;//kernel.BaseActor:6726
          ctx.scale(_this.scaleX,_this.scaleX);
          
        } else {
          //$LASTPOS=11006791;//kernel.BaseActor:6791
          ctx.scale(_this.scaleX,_this.scaleY);
          
        }
        //$LASTPOS=11006847;//kernel.BaseActor:6847
        ctx.globalAlpha=_this.alpha/255;
        //$LASTPOS=11006888;//kernel.BaseActor:6888
        ctx.drawImage(_this.pImg.image,_this.pImg.x,_this.pImg.y,_this.pImg.width,_this.pImg.height,- _this.width/2,- _this.height/2,_this.width,_this.height);
        //$LASTPOS=11007020;//kernel.BaseActor:7020
        ctx.restore();
        
      } else {
        //$LASTPOS=11007047;//kernel.BaseActor:7047
        if (_this.text!==null&&_this.text!==undefined) {
          //$LASTPOS=11007095;//kernel.BaseActor:7095
          splitsText = _this.text.split("\n");
          //$LASTPOS=11007137;//kernel.BaseActor:7137
          _this.drawY=_this.y;
          //$LASTPOS=11007155;//kernel.BaseActor:7155
          if (! _this.size) {
            //$LASTPOS=11007166;//kernel.BaseActor:7166
            _this.size=15;
          }
          //$LASTPOS=11007184;//kernel.BaseActor:7184
          if (! _this.align) {
            //$LASTPOS=11007196;//kernel.BaseActor:7196
            _this.align="center";
          }
          //$LASTPOS=11007221;//kernel.BaseActor:7221
          if (! _this.fillStyle) {
            //$LASTPOS=11007237;//kernel.BaseActor:7237
            _this.fillStyle="white";
          }
          //$LASTPOS=11007265;//kernel.BaseActor:7265
          ctx.fillStyle=_this.fillStyle;
          //$LASTPOS=11007299;//kernel.BaseActor:7299
          ctx.globalAlpha=_this.alpha/255;
          //$LASTPOS=11007340;//kernel.BaseActor:7340
          //$LASTPOS=11007344;//kernel.BaseActor:7344
          textCount = 0;
          while(textCount<splitsText.length) {
            {
              //$LASTPOS=11007415;//kernel.BaseActor:7415
              rect = _this.drawTextRect(ctx,splitsText[textCount],_this.x,_this.drawY,_this.size,_this.align,"fill");
              //$LASTPOS=11007511;//kernel.BaseActor:7511
              if (_this.width<rect.w) {
                //$LASTPOS=11007528;//kernel.BaseActor:7528
                _this.width=rect.w;
              }
              //$LASTPOS=11007555;//kernel.BaseActor:7555
              _this.height+=rect.h;
              //$LASTPOS=11007584;//kernel.BaseActor:7584
      ...
      //$LASTPOS=11007620;//kernel.BaseActor:7620
      if (_this._fukidashi) {
        //$LASTPOS=11007647;//kernel.BaseActor:7647
        if (_this._fukidashi.c>0) {
          //$LASTPOS=11007682;//kernel.BaseActor:7682
          _this._fukidashi.c--;
          //$LASTPOS=11007711;//kernel.BaseActor:7711
          ctx.fillStyle="white";
          //$LASTPOS=11007747;//kernel.BaseActor:7747
          ctx.strokeStyle="black";
          //$LASTPOS=11007785;//kernel.BaseActor:7785
    ...
    runAsync :function _trc_BaseActor_runAsync(f) {
      ...
      //$LASTPOS=11007988;//kernel.BaseActor:7988
      if (! null) {
    ...
    screenOut :function _trc_BaseActor_screenOut(a) {
      ...
      if (! a) {
        //$LASTPOS=11008150;//kernel.BaseActor:8150
        a=0;
      }
      //$LASTPOS=11008160;//kernel.BaseActor:8160
      r = 0;
      //$LASTPOS=11008174;//kernel.BaseActor:8174
      viewX = Tonyu.globals.$Sprites.sx;viewY = Tonyu.globals.$Sprites.sy;
      //$LASTPOS=11008220;//kernel.BaseActor:8220
      if (_this.x<viewX+a) {
        //$LASTPOS=11008249;//kernel.BaseActor:8249
        r+=viewX+a-_this.x;
      }
      //$LASTPOS=11008268;//kernel.BaseActor:8268
      if (_this.y<viewY+a) {
        //$LASTPOS=11008297;//kernel.BaseActor:8297
        r+=viewY+a-_this.y;
      }
      //$LASTPOS=11008316;//kernel.BaseActor:8316
      if (_this.x>Tonyu.globals.$screenWidth+viewX-a) {
        //$LASTPOS=11008345;//kernel.BaseActor:8345
        r+=_this.x-(Tonyu.globals.$screenWidth+viewX-a);
      }
      //$LASTPOS=11008380;//kernel.BaseActor:8380
      if (_this.y>Tonyu.globals.$screenHeight+viewY-a) {
        //$LASTPOS=11008409;//kernel.BaseActor:8409
    ...
    screenOutChecker :function _trc_BaseActor_screenOutChecker(d,f) {
      ...
      //$LASTPOS=11008539;//kernel.BaseActor:8539
      while (true) {
        //$LASTPOS=11008561;//kernel.BaseActor:8561
        while (true) {
          //$LASTPOS=11008587;//kernel.BaseActor:8587
          if (_this.screenOut()>d) {
            //$LASTPOS=11008623;//kernel.BaseActor:8623
            f();
            break;
            
            
          }
          //$LASTPOS=11008680;//kernel.BaseActor:8680
          _this.update();
          
        }
        //$LASTPOS=11008710;//kernel.BaseActor:8710
        while (true) {
          //$LASTPOS=11008736;//kernel.BaseActor:8736
          if (_this.screenOut()<=d) {
            break;
            
            
          }
          //$LASTPOS=11008808;//kernel.BaseActor:8808
          _this.update();
          
        }
        //$LASTPOS=11008838;//kernel.BaseActor:8838
        _this.update();
    ...
    file :function _trc_BaseActor_file(path) {
      ...
      //$LASTPOS=11008878;//kernel.BaseActor:8878
      d = Tonyu.currentProject.getDir();
      //$LASTPOS=11008920;//kernel.BaseActor:8920
      files = d.rel("files/");
    ...
    waitInputDevice :function _trc_BaseActor_waitInputDevice(fl) {
      ...
      if (fl!==false) {
        //$LASTPOS=11009054;//kernel.BaseActor:9054
        if (! _this.origTG) {
          
          
        }
        //$LASTPOS=11009206;//kernel.BaseActor:9206
        _this.a=_this.asyncResult();
        //$LASTPOS=11009232;//kernel.BaseActor:9232
        Tonyu.globals.$InputDevice.addOnetimeListener(_this.a.receiver);
        //$LASTPOS=11009286;//kernel.BaseActor:9286
        _this.waitFor(_this.a);
        
      } else {
        //$LASTPOS=11009321;//kernel.BaseActor:9321
        if (_this.origTG) {
      ...
      _thread.enter(function _trc_BaseActor_ent_waitInputDevice(_thread) {
        ...
        for(var __cnt=100 ; __cnt--;) {
          ...
          case 0:
            ...
            {
              //$LASTPOS=11009108;//kernel.BaseActor:9108
              _this.origTG=_thread.group;
              //$LASTPOS=11009147;//kernel.BaseActor:9147
          ...
          case 3:
            ...
            {
              //$LASTPOS=11009374;//kernel.BaseActor:9374
              _thread.setGroup(_this.origTG);
              //$LASTPOS=11009417;//kernel.BaseActor:9417
              _this.origTG=null;
            }
          case 4:
    ...
    redrawScreen :function _trc_BaseActor_redrawScreen() {
      ...
      //$LASTPOS=11009490;//kernel.BaseActor:9490
      Tonyu.globals.$Sprites.draw(Tonyu.globals.$Screen.buf[0]);
      //$LASTPOS=11009526;//kernel.BaseActor:9526
    ...
    loadPage :function _trc_BaseActor_loadPage(page,arg) {
      ...
      //$LASTPOS=11010235;//kernel.BaseActor:10235
      _this.all().die();
      //$LASTPOS=11010253;//kernel.BaseActor:10253
      new page(arg);
      //$LASTPOS=11010273;//kernel.BaseActor:10273
      _this.die();
    },
    ...
    setVisible :function _trc_BaseActor_setVisible(v) {
      ...
      //$LASTPOS=11010308;//kernel.BaseActor:10308
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    initialize :function _trc_Actor_initialize(x,y,p) {
      ...
      //$LASTPOS=20000124;//kernel.Actor:124
      if (Tonyu.runMode) {
        //$LASTPOS=20000143;//kernel.Actor:143
        _this.initSprite();
      }
    },
    initSprite :function _trc_Actor_initSprite() {
      ...
      //$LASTPOS=20000182;//kernel.Actor:182
      if (_this.layer&&typeof  _this.layer.add=="function") {
        //$LASTPOS=20000234;//kernel.Actor:234
        _this.layer.add(_this);
        
      } else {
        //$LASTPOS=20000272;//kernel.Actor:272
        Tonyu.globals.$Sprites.add(_this);
        
      }
      //$LASTPOS=20000304;//kernel.Actor:304
      _this.onAppear();
    },
