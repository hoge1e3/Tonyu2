...
WebSite.devMode||WebSite.disableROM["ROM_s.js"]||WebSite.isNW?n.base="/ROM"+n.base:FS.mountROM(n)}(),requireSimulator.setName("Util"),Util=function(){function n(n,t){null==t&&(t=""),n=n.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var a=new RegExp("[\\?&]"+n+"=([^&#]*)"),i=a.exec(window.location.href);return null==i?t:e(i[1])}function e(n){return decodeURIComponent(n.replace(/\+/g,"%20"))}function t(n,e){return n.substring(n.length-e.length)===e}function a(n,e){return n.substring(0,e.length)===e}return{getQueryString:n,endsWith:t,startsWith:a}}(),requireSimulator.setName("Tonyu"),"function"!=typeof define&&(define=require("requirejs").define),define([],function(){return Tonyu=function(){function n(){function n(){return null!=g&&m}function e(){return b}function t(){v=0}function a(n){g={prev:g,func:n}}function r(n,e,t){t||(t=[]),t=[y].concat(t);var i=0;a(function(){switch(i){case 0:n["fiber$"+e].apply(n,t),i=1;break;case 1:c(),i=2}})}function o(){if(g)try{g.func(y)}catch(n){s(n)}}function s(n){if(0==y.tryStack.length)throw n;y.lastEx=n;for(var e=y.tryStack.pop();g;){if(e.frame===g){y.catchPC=e.catchPC;break}g=g.prev}}function l(){var n=y.lastEx;return y.lastEx=null,n}function c(n){g=g.prev,y.retVal=n}function u(n){y.tryStack.push({frame:g,catchPC:n})}function p(){y.tryStack.pop()}function f(e){b=!0,e&&e.addTerminatedListener&&e.addTerminatedListener(function(){if(b=!1,y.group)y.group.notifyResume();else if(n())try{y.steps()}catch(e){i(e)}})}function d(n){y.group=n,n&&n.add(y)}function h(){var n=Tonyu.currentThread;for(Tonyu.currentThread=y,v=R;v-->0;)o();Tonyu.currentThread=n}function x(){m=!1}var y={enter:a,apply:r,exit:c,steps:h,step:o,isAlive:n,isWaiting:e,suspend:t,retVal:0,tryStack:[],kill:x,waitFor:f,setGroup:d,enterTry:u,exitTry:p,startCatch:l},g=null,m=!0,v=0,b=!1;return y}function e(n){var e={},t=[];return e.addTerminatedListener=function(n){t.push(n)},setTimeout(function(){t.forEach(function(n){n()})},n),e}function t(){var n=[],e=[],t=!1;return n.addTerminatedListener=function(n){t?setTimeout(n,0):e.push(n)},n.receiver=function(){t=!0;for(var e=0;e<arguments.length;e++)n[e]=arguments[e];n.notify()},n.notify=function(){e.forEach(function(n){n()})},n}function a(){function e(n){n.group=l,f?f.push(n):c.push(n)}function t(t,a,i){a||(a="main");var r=n();return r.apply(t,a,i),e(r),r}function a(){try{r()}catch(n){i(n)}}function r(){function n(n){n.isWaiting()||(p=!1,n.steps())}for(var e=c.length-1;e>=0;e--){var t=c[e];t.isAlive()&&t.group===l||c.splice(e,1)}for(p=!0,f=[],c.forEach(n);f.length>0;)w=f,f=[],w.forEach(function(e){c.push(e),n(e)});f=null}function o(){u=!1}function s(){}var l,c=[],u=!0,p=!1,f=null;return l={add:e,addObj:t,steps:a,kill:o,notifyResume:s,threads:c}}function i(n){if(!Tonyu.onRuntimeError)throw alert("エラー! at "+$LASTPOS+" メッセージ  : "+n),n;Tonyu.onRuntimeError(n)}function r(n){if(n===Function)return null;if("function"==typeof n)n.constructor=null;else if("object"==typeof n)for(var e in n)n[e]=r(n[e]);return n}function o(){var n,e,t=[];if(1==arguments.length)e=arguments[0];else if(2==arguments.length&&"function"==typeof arguments[0])n=arguments[0],e=arguments[1];else if(2==arguments.length&&arguments[0]instanceof Array)t=arguments[0],e=arguments[1];else{if(3!=arguments.length)throw console.log(arguments),"Invalid argument spec";if(n=arguments[0],!n)throw"No parent class";t=arguments[1],e=arguments[2]}e=r(e);var a=e.initialize?e.initialize:n?function(){n.apply(this,arguments)}:function(){};return delete e.initialize,t.forEach(function(n){if(!n.methods)throw n+" Does not have methods";for(var t in n.methods)t in e||(e[t]=n.methods[t])}),a.methods=e,a.prototype=l(n,e),a.prototype.isTonyuObject=!0,s(a,{superClass:n?n.meta:null,includes:t.map(function(n){return n.meta})}),a}function s(n,e){n.meta=n.meta||{},c(n.meta,e)}function l(n,e){return n?c(new n,e):e}function c(n,e){if(e&&"object"==typeof e)for(var t in e)n[t]=e[t];return n}function u(n,e){b[n]=e}function p(n){return b[n]}function f(n){var e=n.split("."),t=A;if(e.forEach(function(n){t&&(t=t[n])}),!t&&1==e.length){var a;for(var i in A){var r=A[i][n];if(r){if(t)throw new Error("曖昧なクラス名： "+i+"."+n+", "+a);t=r,a=i+"."+n}}}return t}function d(n,e){return function(){return e.apply(n,arguments)}}function h(n,e,t,a){if(!n)throw new Error(a+"(="+n+")のメソッド "+e+"を呼び出せません");var i=n[e];if("function"!=typeof i)throw new Error(("this"==a?"":a+".")+e+"(="+i+")はメソッドではありません");return i.apply(n,t)}function x(n,e,t){if("function"!=typeof n)throw new Error(t+"は関数ではありません");return n.apply({},e)}function y(n,e){if(n!=n||null==n)throw new Error(e+"(="+n+")は初期化されていません");return n}function g(n){for(var e=[],t=1;t<n.length;t++)e[t-1]=n[t];return e}function m(n){throw console.log("Not a tonyu object: ",n),n+" is not a tonyu object"}function v(n,e){return n in e}var R=60;o.addMeta=s,o.ensureNamespace=function(n,e){var t,a=e.split("."),i=n;for(t=0;t<a.length;t++){var r=a[t];i[r]||(i[r]={}),i=i[r]}};var b={},A={};return Tonyu={thread:n,threadGroup:a,klass:o,bless:l,extend:c,globals:b,classes:A,setGlobal:u,getGlobal:p,getClass:f,timeout:e,asyncResult:t,bindFunc:d,not_a_tonyu_object:m,hasKey:v,invokeMethod:h,callFunc:x,checkNonNull:y,A:g}}()}),requireSimulator.setName("FileList"),requireSimulator.setName("exceptionCatcher"),define([],function(){var n={};return n.f=function(e){if("function"==typeof e){if(e.isTrcf)return e;var t=function(){if(!n.handleException||n.enter)return e.apply(this,arguments);try{return n.enter=!0,e.apply(this,arguments)}catch(t){n.handleException(t)}finally{n.enter=!1}};return t.isTrcf=!0,t}if("object"==typeof e){for(var a in e)e[a]=n.f(e[a]);return e}},n}),requireSimulator.setName("UI"),define(["Util","exceptionCatcher"],function(n,e){var t={},a=e.f;return t=function(){function e(){u.forEach(function(n){n()}),setTimeout(a(e),10)}function i(n){return n instanceof Array?r(n):"string"==typeof n?s(n):n}function r(n){var e=n[0],t=1,a=$("<"+e+">");for("object"!=typeof n[t]||n[t]instanceof Array||n[t]instanceof $||(o(a,n[t],e),t++);t<n.length;)a.append(i(n[t])),t++;return a}function o(e,i){function r(n,t){if("enterkey"==n)e.on("keypress",a(function(n){13==n.which&&t.apply(e,arguments)}));else if("realtimechange"==n){var r,o=!0;u.push(function(){var n;n="checkbox"==i.type?!!e.prop("checked"):e.val(),(o||r!=n)&&(t.apply(e,[n,r]),r=n),o=!1})}else e.on(n,a(t))}i.$var&&(p[i.$var]=e),i.$edit&&("string"==typeof i.$edit&&(i.$edit={name:i.$edit,type:t.types.String}),i.on||(i.on={}),i.on.realtimechange=a(function(n){f.writeToModel(i.$edit,n,e)}),p[i.$edit.name]||(p[i.$edit.name]=e),f.push({jq:e,params:i}));for(var o in i)if("on"==o)for(var s in i.on)r(s,i.on[s]);else"css"==o?e.css(i[o]):n.startsWith(o,"$")||e.attr(o,i[o])}function s(n){return $("<span>").text(n)}for(var l=[],c=0;c<arguments.length;c++)l[c]=arguments[c];var u=[],p={},f=[],d=i(l);return d.$edits=f,d.$vars=p,f.load=function(n){f.model=n,f.forEach(function(n){f.writeToJq(n.params.$edit,n.jq)})},f.writeToJq=function(n,e){var t=f.model;if(t){for(var a=n.name,i=a.split("."),r=0;r<i.length;r++)t=t[i[r]];t=n.type.toVal(t),"checkbox"==e.attr("type")?e.prop("checked",!!t):e.val(t)}},f.validator={errors:{},show:function(){if(p.validationMessage){p.validationMessage.empty();for(var n in this.errors)p.validationMessage.append(t("div",this.errors[n].mesg))}if(p.OKButton){var e=!0;for(var n in this.errors)e=!1;p.OKButton.attr("disabled",!e)}},on:{validate:function(){}},addError:function(n,e,t){this.errors[n]={mesg:e,jq:t},this.show()},removeError:function(n){delete this.errors[n],this.show()},allOK:function(){for(var n in this.errors)delete this.errors[n];this.show()},isValid:function(){var n=!0;for(var e in this.errors)n=!1;return n}},f.writeToModel=function(n,e,t){var a=f.model;if(a){var i=n.name;try{e=n.type.fromVal(e)}catch(r){return void f.validator.addError(i,r,t)}f.validator.removeError(i);for(var o=i.split("."),s=0;s<o.length;s++)s==o.length-1?f.on.writeToModel(i,e)||(a[o[s]]=e):a=a[o[s]];f.validator.on.validate.call(f.validator,f.model)}},f.on={},f.on.writeToModel=function(){},u.length>0&&setTimeout(a(e),10),d},t.types={String:{toVal:function(n){return n},fromVal:function(n){return n}},Number:{toVal:function(n){return n+""},fromVal:function(n){return parseFloat(n)}}},t}),requireSimulator.setName("FileMenu"),define(["UI","FS"],function(n){var e=function(){var e={on:{}};return e.on.validateName=function(n){if(!n)return{ok:!1,reason:"ファイル名を入力してください"};var t=e.on.getCurDir(),a=t.rel(n);return{ok:!0,file:a}},e.on.displayName=function(n){return n.name()},e.on.close=function(){},e.on.open=function(n){"object"==typeof e.fileList&&e.fileList.select(n)},e.on.ls=function(){"object"==typeof e.fileList&&e.fileList.ls()},e.on.getCurFile=function(){if("object"==typeof e.fileList)return e.fileList.curFile();throw"on.getCurFile is missing"},e.on.getCurDir=function(){if("object"==typeof e.fileList)return e.fileList.curDir();throw"on.getCurDir is missing"},e.on.createContent=function(n){return n.text("")},e.onMenuStart=function(){},e.dialog=function(n,t,a){return e.dialogOpt({title:n,name:t,onend:a})},e.dialogOpt=function(t){var a=t.title,i=t.name||"",r=t.onend||function(){};e.d||(e.d=n(["div"],{title:a},"ファイル名を入力してください",["br"],["input",{$var:"name",on:{enterkey:function(){e.d.$vars.done()},realtimechange:function(n){e.d.$vars.chg(n)}}}],["br"],["div",{$var:"extra"}],["div",{$var:"msg"}],["button",{$var:"b",on:{click:function(){e.d.$vars.done()}}},"OK"])),e.d.attr({title:a});var o=e.d.$vars;o.name.val(i),e.d.dialog({title:a});var s=null;o.done=function(){s&&s.ok&&(r(s.file),e.d.dialog("close"))},o.chg=function(n){s=e.on.validateName(n,t),s.ok&&s.file.exists()&&(s={ok:!1,reason:n+"は存在します"}),s.ok?(o.msg.css({color:"blue"}),o.msg.text(s.note||""),o.b.removeAttr("disabled")):(o.msg.css({color:"red"}),o.msg.text(s.reason),o.b.attr("disabled",!0))},o.extra.empty(),t.extraUI&&t.extraUI(o.extra)},e.create=function(){e.onMenuStart("create"),e.dialogOpt({title:"新規作成",action:"create",onend:function(n){n.exists()||(e.on.createContent(n),e.on.ls(),e.on.open(n))}})},e.mv=function(){e.onMenuStart("mv");var n=e.on.getCurFile();if(n){var t=e.on.displayName(n);e.dialogOpt({title:"名前変更",name:t,action:"mv",extraUI:e.on.mvExtraUI,onend:function(t){if(t&&(!e.on.mv||e.on.mv(n,t)!==!1)){var a=n.text();n.rm(),e.on.close(n),n=t,t.text(a),e.on.ls(),e.on.open(n)}}})}},e.rm=function(){e.onMenuStart("rm");var n=e.on.getCurFile();n&&confirm(n.name()+"を削除しますか？")&&(n.rm(),e.on.ls(),e.on.close(n))},e};return e}),requireSimulator.setName("Log"),define(["FS","WebSite"],function(n,e){function t(n){return n.replace(/\n/g,"\n|")}var a={};return a.curFile=function(){var n=new Date,e=n.getFullYear(),t=n.getMonth()+1,a=n.getDate();return FS.get("/var/log/").rel(e+"/").rel(t+"/").rel(e+"-"+t+"-"+a+".log")},a.append=function(n){if(!e.isNW){var t=a.curFile(),i=t.exists()?t.text():"";t.text(i+n+"\n")}},a.d=function(n,e){a.append(new Date+": ["+n+"]"+t(e))},a.e=function(n,e){a.append(new Date+": ERROR["+n+"]"+t(e))},a}),requireSimulator.setName("showErrorPos"),define(["WebSite","Log"],function(n,e){return function(t,a){function i(){t.empty()}var r,o,s;if(!a)return void i();var l,c;a.isTError?(r=a.mesg,o=a.src,s=a.pos,l=a.row+1,c=a.col+1):(o={name:function(){return"不明"},text:function(){return null}},s=0,r=a),"object"==typeof s&&(l=s.row,c=s.col),i();var u=$("<div>").text(r+" 場所："+o.name()+("number"==typeof l?":"+l+":"+c:""));t.append(u),t.append($("<div>").attr("class","quickFix")),console.log("src=",o);var p=o.text();if(p&&"object"==typeof s){for(var f=0,d=p.split(/\n/),h=0;h<d.length&&h+1<s.row;h++)f+=d[h].length;f+=s.col,s=f}var x=$("<pre>");x.append($("<span>").text(p.substring(0,s))),x.append($("<img>").attr("src",n.top+"/images/ecl.png")),x.append($("<span>").text(p.substring(s))),t.append(x),t.attr("title","エラー");var y=t.dialog({width:600,height:400});return e.d("error",r+"\nat "+o+":"+a.pos+"\n"+p.substring(0,a.pos)+"!!HERE!!"+p.substring(a.pos)),y}}),requireSimulator.setName("IndentBuffer"),"function"!=typeof define&&(define=require("requirejs").define),define([],function(){return IndentBuffer=function(){var n=function(){function e(){i++;var n=t[i];if(null==n)throw console.log(t),new Error(i+"th null param: fmt="+a);return n}for(var t=arguments,a=t[0],i=0;;){var r=a.indexOf("%");if(0>r){n.buf+=a;break}n.buf+=a.substring(0,r),r++;var o=a.charAt(r);if("s"==o){var s=e();"string"==typeof s||"number"==typeof s||(null==s?s="null":s.text&&(s=s.text)),n.buf+=s,r++}else if("d"==o){var l=e();if("number"!=typeof l)throw new Error(l+" is not a number: fmt="+a);n.buf+=l,r++}else if("n"==o)n.ln(),r++;else if("{"==o)n.indent(),r++;else if("}"==o)n.dedent(),r++;else if("%"==o)n.buf+="%";else if("f"==o)e()(n),r++;else if("l"==o){var c=e();n.buf+=n.toLiteral(c),r++}else if("v"==o){var u=e();if(!u)throw new Error("Null %v");if("object"!=typeof u)throw new Error("nonobject %v:"+u);n.visitor.visit(u),r++}else if("z"==o){var p=e();if("val"in p)return void(n.buf+=p.val);p.gen||n.lazy(p),n.buf+=p.gen,r++}else if("j"==o){var f=e(),d=f[0],h=f[1],x=!1;if(!h||!h.forEach)throw console.log(h),new Error(h+" is not array. cannot join fmt:"+a);h.forEach(function(e){x&&n.printf(d),x=!0,n.visitor.visit(e)}),r++}else"D"==o?(e(),r++):r+=2;a=a.substring(r)}};return n.print=function(e){n.buf+=e},n.printf=n,n.buf="",n.lazy=function(e){return e||(e={}),e.gen=("GENERETID"+Math.random()+"DITERENEG").replace(/\W/g,""),e.reg=new RegExp(e.gen,"g"),e.put=function(e){return this.val=e,n.buf=n.buf.replace(this.reg,e),e},e},n.ln=function(){n.buf+="\n"+n.indentBuf},n.indent=function(){n.indentBuf+=n.indentStr,n.buf+="\n"+n.indentBuf},n.dedent=function(){var e=n.indentStr.length;if(!n.buf.substring(n.buf.length-e).match(/^\s*$/))throw console.log(n.buf),new Error("Non-space truncated ");n.buf=n.buf.substring(0,n.buf.length-e),n.indentBuf=n.indentBuf.substring(0,n.indentBuf.length-e)},n.toLiteral=function(n,e){return e||(e="'"),n=n.replace(/\\/g,"\\\\"),n=n.replace(/\r/g,"\\r"),n=n.replace(/\n/g,"\\n"),n="'"==e?n.replace(/'/g,"\\'"):n.replace(/"/g,'\\"'),e+n+e},n.indentBuf="",n.indentStr="  ",n}}),requireSimulator.setName("disp"),"function"!=typeof define&&(define=require("requirejs").define),define(["IndentBuffer"],function(n){return disp=function(e){function t(n){if(null==n)return a("null%n");if("string"==typeof n)return a("'%s'%n",n);if("number"==typeof n)return a("%s%n",n);if("function"==typeof n)return a("func%n");a(n instanceof Array?"[%{":"{%{");var e="";for(var i in n)a(e+i+":"),t(n[i]);a(n instanceof Array?"%}]%n":"%}}%n")}var a=n();return t(e),a.buf}}),requireSimulator.setName("Parser"),"function"!=typeof define&&(define=require("requirejs").define),define(["disp"],function(){return Parser=function(){function n(n,e){var t;for(t in e)n[t]=e[t];return n}function e(n){this.parse=i.options.traceTap?function(e){console.log("tap: name="+this.name+"  pos="+(e?e.pos:"?"));var t=n.apply(this,[e]),a="NOIMG";return t.src&&t.src.str&&(a=t.src.str.substring(t.pos-3,t.pos)+"^"+t.src.str.substring(t.pos,t.pos+3)),t.src&&t.src.tokens&&(a=t.src.tokens[t.pos-1]+"["+t.src.tokens[t.pos]+"]"+t.src.tokens[t.pos+1]),console.log("/tap: name="+this.name+" pos="+(e?e.pos:"?")+"->"+(t?t.pos:"?")+" "+a+" res="+(t?t.success:"?")),t}:n}function t(n,e){if(null==n)throw e+" is null!";return n}function a(n,e){null!=n&&(this.src={maxPos:0,global:e},"string"==typeof n&&(this.src.str=n),n instanceof Array&&(this.src.tokens=n),this.pos=0,this.result=[],this.success=!0)}var i={consoleBuffer:"",options:{traceTap:!1,optimizeFirst:!0,profile:!1,verboseFirst:!1,traceFirstTbl:!1},Parser:e,StringParser:r,nc:t};i.dispTbl=function(n){var e="",t={};if(!n)return e;for(var a in n){var i=n[a].name;t[i]||(t[i]=""),t[i]+=a}for(var i in t)e+=t[i]+"->"+i+",";return e},e.create=function(n){return new e(n)},i.create=e.create,n(e.prototype,{except:function(n){var t=this;return this.ret(e.create(function(e){return n.apply({},e.result)&&(e.success=!1),e}).setName("(except "+t.name+")"))},noFollow:function(n){var a=this;return t(n,"p"),this.ret(e.create(function(e){var t=n.parse(e);return e.success=!t.success,e}).setName("("+a.name+" noFollow "+n.name+")"))},andNoUnify:function(n){t(n,"next");var a=this,i=e.create(function(e){var t=a.parse(e);if(!t.success)return t;var i=n.parse(t);return i.success&&(i.result=t.result.concat(i.result)),i});return i.setName("("+this.name+" "+n.name+")")},and:function(n){var t=this.andNoUnify(n);if(!this._first)return t;var a=this._first.tbl,r={};for(var o in a)r[o]=a[o].andNoUnify(n);return t=e.fromFirst(this._first.space,r),t.setName("("+this.name+" >> "+n.name+")"),i.options.verboseFirst&&console.log("Created aunify name="+t.name+" tbl="+i.dispTbl(r)),t},retNoUnify:function(n){var t,a=this;t="function"==typeof n?e.create(function(e){var t=e.clone();return t.result=[n.apply({},e.result)],t}).setName("retfunc"):n;var i=e.create(function(n){var e=a.parse(n);return e.success?t.parse(e):e}).setName("("+this.name+" >= "+t.name+")");return i},ret:function(n){if(!this._first)return this.retNoUnify(n);var t=this._first.tbl,a={};for(var r in t)a[r]=t[r].retNoUnify(n);return res=e.fromFirst(this._first.space,a),res.setName("("+this.name+" >>= "+n.name+")"),i.options.verboseFirst&&console.log("Created runify name="+res.name+" tbl="+i.dispTbl(a)),res},first:function(n,t){if(!i.options.optimizeFirst)return this;if(null==n)throw"Space is null2!";if("string"==typeof t){for(var a={},r=0;r<t.length;r++)a[t.substring(r,r+1)]=this;return e.fromFirst(n,a).setName("(fst "+this.name+")")}if(null==t)return e.fromFirst(n,{ALL:this}).setName("(fst "+this.name+")");if("object"==typeof t)throw"this._first={space: space, tbl:ct}";return this},firstTokens:function(n){if(!i.options.optimizeFirst)return this;"string"==typeof n&&(n=[n]);var t={};if(n){var a=this;n.forEach(function(n){t[n]=a})}else t.ALL=this;return e.fromFirstTokens(t).setName("(fstT "+this.name+")")},unifyFirst:function(t){function a(n,e){return n?e?n.orNoUnify(e).checkTbl():n:e}function r(){var n=t._first.tbl,e={};for(var i in o)e[i]=1;for(var i in n)e[i]=1;delete e.ALL,(o.ALL||n.ALL)&&(o.ALL=a(o.ALL,n.ALL));for(var i in e)o[i]&&n[i]?o[i]=a(o[i],n[i]):o[i]&&!n[i]?o[i]=a(o[i],n.ALL):!o[i]&&n[i]&&(o[i]=a(o.ALL,n[i]))}var o={};this.checkTbl(),t.checkTbl(),n(o,this._first.tbl),r();var s=e.fromFirst(this._first.space,o).setName("("+this.name+")U("+t.name+")");return i.options.verboseFirst&&console.log("Created unify name="+s.name+" tbl="+i.dispTbl(o)),s},or:function(n){return t(n,"other"),this._first&&n._first&&this._first.space&&this._first.space===n._first.space?this.unifyFirst(n):(i.options.verboseFirst&&console.log("Cannot unify"+this.name+" || "+n.name+" "+this._first+" - "+n._first),this.orNoUnify(n))},orNoUnify:function(n){var t=this,a=e.create(function(e){var a=t.parse(e);if(a.success)return a;var i=n.parse(e);return i});return a.name="("+this.name+")|("+n.name+")",a},setName:function(n){return this.name=n,this._first,this},profile:function(n){return i.options.profile&&(this.parse=this.parse.profile(n||this.name)),this},repN:function(n){var t=this;n||(n=0);var a=e.create(function(e){for(var a=e,i=[];;){var r=t.parse(a);if(!r.success){var o;return i.length>=n?(o=a.clone(),o.result=[i],o.success=!0,o):(o=e.clone(),o.success=!1,o)}i.push(r.result[0]),a=r}});return a.setName("("+t.name+" * "+n+")")},rep0:function(){return this.repN(0)},rep1:function(){return this.repN(1)},opt:function(){var n=this;return e.create(function(e){var t=n.parse(e);return t.success?t:(e=e.clone(),e.success=!0,e.result=[null],e)}).setName("("+n.name+")?")},sep1:function(n,e){var a=this;t(a,"value"),t(n,"sep");var i=n.and(a).ret(function(n,t){return e?t:{sep:n,value:t}});return a.and(i.rep0()).ret(function(n,t){var a;if(e){var i=[n];for(a in t)i.push(t[a]);return i}return{head:n,tails:t}}).setName("(sep1 "+a.name+"~~"+n.name+")")},sep0:function(n){return this.sep1(n,!0).opt().ret(function(n){return n?n:[]})},tap:function(n){return this},retN:function(n){return this.ret(function(){return arguments[n]})},parseStr:function(n,e){var t=new a(n,e);return this.parse(t)},checkTbl:function(){if(!this._first)return this;var n=this._first.tbl;for(var e in n)if(!n[e].parse)throw this.name+": tbl."+e+" is not a parser :"+n[e];return this}}),n(a.prototype,{clone:function(){var n=new a;return n.src=this.src,n.pos=this.pos,n.result=this.result.slice(),n.success=this.success,n},updateMaxPos:function(n){n>this.src.maxPos&&(this.src.maxPos=n)},isSuccess:function(){return this.success},getGlobal:function(){return this.src.global||(this.src.global={}),this.src.global}}),e.fromFirst=function(n,t){if("TOKEN"==n)return e.fromFirstTokens(t);var a=e.create(function(e){var a=n.parse(e),r=a.src.str.substring(a.pos,a.pos+1);return i.options.traceFirstTbl&&console.log(this.name+": first="+r+" tbl="+(t[r]?t[r].name:"-")),t[r]?t[r].parse(a):t.ALL?t.ALL.parse(a):(a.success=!1,a)});return a._first={space:n,tbl:t},a.checkTbl(),a},e.fromFirstTokens=function(n){var t=e.create(function(e){var t=e.src.tokens[e.pos],a=t?t.type:null;return i.options.traceFirstTbl&&console.log(this.name+": firstT="+a+" tbl="+(n[a]?n[a].name:"-")),null!=a&&n[a]?n[a].parse(e):n.ALL?n.ALL.parse(e):(e.success=!1,e)});return t._first={space:"TOKEN",tbl:n},t.checkTbl(),t};var r={empty:e.create(function(n){var e=n.clone();return e.success=!0,e.result=[null],e}).setName("E"),fail:e.create(function(n){return n.success=!1,n}).setName("F"),str:function(n){return this.strLike(function(e,t){return e.substring(t,t+n.length)===n?{len:n.length}:null}).setName(n)},reg:function(n){return(n+"").match(/^\/\^/)||console.log("Waring regex should have ^ at the head:"+(n+"")),this.strLike(function(e,t){var a=n.exec(e.substring(t));return a?(a.len=a[0].length,a):null}).setName(n+"")},strLike:function(t){return e.create(function(e){var a=e.src.str;if(null==a)throw"strLike: str is null!";var r=e.pos,o=t(a,r,e);if(i.options.traceToken&&console.log("pos="+r+" r="+o),o){i.options.traceToken&&console.log("str:succ"),o.pos=r,o.src=e.src;var s=e.clone();return n(s,{pos:r+o.len,success:!0,result:[o]}),e.updateMaxPos(s.pos),s}return i.options.traceToken&&console.log("str:fail"),e.success=!1,e}).setName("STRLIKE")},parse:function(n,e,t){var i=new a(e,t);return n.parse(i)}};r.eof=r.strLike(function(n,e){return e==n.length?{len:0}:null}).setName("EOF"),i.StringParser=r;var o={token:function(n){return e.create(function(e){var t=e.src.tokens[e.pos];return e.success=!1,t?(t.type==n&&(e=e.clone(),e.updateMaxPos(e.pos),e.pos++,e.success=!0,e.result=[t]),e):e}).setName(n).firstTokens(n)},parse:function(n,e,t){var i=new a(e,t);return n.parse(i)},eof:e.create(function(n){var e=n.pos>=n.src.tokens.length;return n.success=e,e&&(n=n.clone(),n.result=[{type:"EOF"}]),n}).setName("EOT")};return i.TokensParser=o,i.lazy=function(n){var t=null;return e.create(function(e){if(t||(t=n()),!t)throw n+" returned null!";return this.name=n.name,t.parse(e)}).setName("LZ")},i.addRange=function(n,e){if(null==e)return n;if("number"!=typeof n.pos)return n.pos=e.pos,n.len=e.len,n;var t=e.pos+e.len,a=n.pos+n.len;return e.pos<n.pos&&(n.pos=e.pos),t>a&&(n.len=t-n.pos),n},i.setRange=function(n){if(null!=n&&"string"!=typeof n&&"number"!=typeof n&&"boolean"!=typeof n){var e=i.getRange(n);if(null!=e)return n;for(var t in n)if(n.hasOwnProperty(t)){var a=i.setRange(n[t]);i.addRange(n,a)}return n}},i.getRange=function(n){return null==n?null:"number"!=typeof n.pos?null:"number"==typeof n.len?n:null},i}()}),requireSimulator.setName("Grammar"),"function"!=typeof define&&(define=require("requirejs").define),define(["Parser"],function(n){return Grammar=function(){function e(n){return"string"==typeof n?a.get(n):n}var t=n,a=null;return a=function(t){var i={};return i.ands=function(){for(var i=e(arguments[0]),r=1;r<arguments.length;r++)i=i.and(e(arguments[r]));i=i.tap(t),a.defs[t]=i;var o={};return o.autoNode=function(){var e=i.ret(function(){for(var e={type:t},a=0;a<arguments.length;a++){var i=arguments[a],r=n.setRange(i);n.addRange(e,r),e["-element"+a]=i}e.toString=function(){return"("+this.type+")"}}).setName(t);return a.defs[t]=e},o.ret=function(e){if(0==arguments.length)return i;if("function"==typeof e)return a.defs[t]=i.ret(e);for(var r=[],o=function(n){return n},s=0;s<arguments.length;s++){if("function"==typeof arguments[s]){o=arguments[s];break}r[s]=arguments[s]}var l=i.ret(function(){var e={type:t};e[Grammar.SUBELEMENTS]=[];for(var a=0;a<arguments.length;a++){var i=arguments[a],s=n.setRange(i);n.addRange(e,s),r[a]&&(e[r[a]]=i),e[Grammar.SUBELEMENTS].push(i)}return e.toString=function(){return"("+this.type+")"},o(e)}).setName(t);return a.defs[t]=l},o},i.ors=function(){for(var n=e(arguments[0]),i=1;i<arguments.length;i++)n=n.or(e(arguments[i]));return a.defs[t]=n.setName(t)},i},a.defs={},a.get=function(n){return a.defs[n]?a.defs[n]:t.lazy(function(){var e=a.defs[n];if(!e)throw"grammar named '"+n+"' is undefined";return e}).setName("(Lazy of "+n+")")},a},Grammar.SUBELEMENTS="[SUBELEMENTS]",Grammar}),requireSimulator.setName("XMLBuffer"),"function"!=typeof define&&(define=require("requirejs").define),define(["Parser"],function(n){return XMLBuffer=function(e){var t;return t=function(a,i){if(null!=a&&"string"!=typeof a&&"number"!=typeof a){var r=n.getRange(a);if(r)for(;t.srcLen<r.pos;)t.src(e.substring(t.srcLen,r.pos));if(null!=a){if(i&&t.tag("<attr_"+i+">"),a.type&&t.tag("<"+a.type+">"),a.text)t.src(r.text);else{var o=t.orderByPos(a);o.forEach(function(n){n.name&&n.name.match(/^-/)?t(n.value):t(n.value,n.name)})}if(r)for(;t.srcLen<r.pos+r.len;)t.src(e.substring(t.srcLen,r.pos+r.len));a.type&&t.tag("</"+a.type+">"),i&&t.tag("</attr_"+i+">")}}},t.orderByPos=XMLBuffer.orderByPos,t.src=function(n){t.buf+=n.replace(/&/g,"&amp;").replace(/>/g,"&gt;").replace(/</g,"&lt;"),t.srcLen+=n.length},t.tag=function(n){t.buf+=n},t.buf="",t.srcLen=0,t},XMLBuffer.orderByPos=function(n){var e=[];if(n[XMLBuffer.SUBELEMENTS])n[XMLBuffer.SUBELEMENTS].forEach(function(n){e.push(n)});else for(var t in n)n.hasOwnProperty(t)&&null!=n[t]&&"string"!=typeof n[t]&&"number"!=typeof n[t]&&"number"==typeof n[t].pos&&e.push(isNaN(parseInt(t))&&!(t+"").match(/-/)?{name:t,value:n[t]}:{value:n[t]});return e=e.sort(function(n,e){return n.value.pos-e.value.pos})},XMLBuffer.SUBELEMENTS="[SUBELEMENTS]",XMLBuffer}),requireSimulator.setName("TError"),"function"!=typeof define&&(define=require("requirejs").define),define([],function(){return TError=function(n,e,t){if("string"==typeof e)return{isTError:!0,mesg:n,src:{name:function(){return e},text:function(){return e}},pos:t,toString:function(){return this.mesg+" at "+e+":"+this.pos},raise:function(){throw this}};var a=null;if(e&&e.src&&(a=e,e=a.src.tonyu),"function"!=typeof e.name)throw"src="+e+" should be file object";var i;if("function"==typeof e.text){var r=e.text();"string"==typeof r&&(i=TError.calcRowCol(r,t))}return{isTError:!0,mesg:n,src:e,pos:t,row:i.row,col:i.col,klass:a,toString:function(){return this.mesg+" at "+this.src.name()+":"+this.row+":"+this.col},raise:function(){throw this}}},TError.calcRowCol=function(n,e){var t,a,i=n.split("\n"),r=0;for(t=0;t<i.length;t++)if(r+=i[t].length+1,r>e){a=e-(r-i[t].length);break}return{row:t,col:a}},TError}),requireSimulator.setName("TT"),"function"!=typeof define&&(define=require("requirejs").define),define(["Grammar","XMLBuffer","IndentBuffer","disp","Parser","TError"],function(n,e,t,a,i){return TT=function(){function n(n,e){var t,i;"string"==typeof n?(t=s.str(n),n.length>0&&(i=n.substring(0,1)),e||(e=n)):(t=s.reg(n),e||(e=n+""));var r=p.and(t).ret(function(n,t){var i={};if(i.pos=t.pos,"number"!=typeof i.pos)throw"no pos for "+e+" "+a(t);if(i.len=t.len,i.text=t.src.str.substring(i.pos,i.pos+i.len),"string"!=typeof i.text)throw"no text("+i.text+") for "+e+" "+a(t);return i.toString=function(){return this.text},i});return i&&(r=r.first(p,i)),r.setName(e)}function e(e,t,a){"string"==typeof a&&(a=n(a)),f[e]=r(f[e],a.ret(function(n){return n.type=t,n}).setName(t))}function t(n,t,a,i){t==l&&(t=a);for(var r=1;n>=r;r*=2)0!=(n&r)&&e(n&r,t,a,i);d[t]=i}function r(n,e){return n?n.or(e):e}function o(n){var e=((new Date).getTime(),i.StringParser.parse(h,n));return e.success||console.log("Stopped at "+n.substring(e.src.maxPos-5,e.src.maxPos+5)),"object"==typeof WebSite&&WebSite.devMode&&(window.tokenStat=window.tokenStat||{},e.result[0].forEach(function(n){window.tokenStat[n.text]=window.tokenStat[n.text]||0,window.tokenStat[n.text]++})),e}var s=i.StringParser,l="SAMENAME",c=1,u=2,p=s.reg(/^(\s*(\/\*([^\/]|[^*]\/|\r|\n)*\*\/)*(\/\/.*\r?\n)*)*/).setName("space"),f={},d={},h=i.create(function(n){for(var e=u,t=[];;){if(n=f[e].parse(n),!n.success)break;var a=n.result[0];e=d[a.type],t.push(a)}return n=p.parse(n),n.success=n.src.maxPos==n.src.str.length,n.result[0]=t,n}),x={"function":!0,"var":!0,"return":!0,"typeof":!0,"if":!0,"for":!0,"else":!0,"super":!0,"while":!0,"break":!0,"do":!0,"switch":!0,"try":!0,"catch":!0,"finally":!0,"throw":!0,"in":!0,fiber:!0,"native":!0,"instanceof":!0,"new":!0,is:!0,"true":!0,"false":!0,"null":!0,"this":!0,undefined:!0,usethread:!0,constructor:!0,ifwait:!0,nowait:!0,_thread:!0,arguments:!0,"delete":!0,"extends":!0,includes:!0},y=n(/^[0-9\.]+/).ret(function(n){return n.type="number",n.value=parseInt(n.text),n}).first(p,"0123456789"),g=n({exec:function(n){var e=n.substring(0,1);if('"'!==e&&"'"!==e)return!1;for(var t=1;t<n.length;t++){var a=n.substring(t,t+1);if(a===e)return[n.substring(0,t+1)];"\\"===a&&t++}return!1},toString:function(){return"literal"}}).first(p,"\"'"),m=n({exec:function(n){if("/"!==n.substring(0,1))return!1;for(var e=1;e<n.length;e++){var t=n.substring(e,e+1);if("/"===t){var a=/^[ig]*/.exec(n.substring(e+1));return[n.substring(0,e+1+a[0].length)]}if("\n"==t)return!1;"\\"===t&&e++}return!1},toString:function(){return"regex"}}).first(p,"/");t(u|c,"number",y,c),t(u,"regex",m,c),t(u|c,"literal",g,c),t(u|c,l,"++",c),t(u|c,l,"--",c),t(u|c,l,"!==",u),t(u|c,l,"===",u),t(u|c,l,"+=",u),t(u|c,l,"-=",u),t(u|c,l,"*=",u),t(u|c,l,"/=",u),t(u|c,l,"%=",u),t(u|c,l,">=",u),t(u|c,l,"<=",u),t(u|c,l,"!=",u),t(u|c,l,"==",u),t(u|c,l,">>",u),t(u|c,l,"<<",u),t(u|c,l,"&&",u),t(u|c,l,"||",u),t(u|c,l,"(",u),t(u|c,l,")",c),t(u|c,l,"[",u),t(u|c,l,"]",c),t(u|c,l,"{",u),t(u|c,l,"}",c),t(u|c,l,">",u),t(u|c,l,"<",u),t(u|c,l,"+",u),t(u|c,l,"-",u),t(u|c,l,".",u),t(u|c,l,"?",u),t(u|c,l,"=",u),t(u|c,l,"*",u),t(u|c,l,"%",u),t(c,l,"/",u),t(c|u,l,"^",u),t(c|u,l,"~",u),t(c|u,l,"\\",u),t(c|u,l,":",u),t(c|u,l,";",u),t(c|u,l,",",u),t(u|c,l,"!",u),t(u|c,l,"&",u),t(u|c,l,"|",u);var v=n(/^[a-zA-Z_$][a-zA-Z0-9_$]*/,"symresv_reg").ret(function(n){return n.type="constructor"==n.text?"tk_constructor":x.hasOwnProperty(n.text)?n.text:"symbol",n}).first(p);for(var R in x)d[R]=u;return d.tk_constructor=u,d.symbol=c,f[u]=r(f[u],v),f[c]=r(f[c],v),{parse:o,extension:"js"}}()}),requireSimulator.setName("ExpressionParser"),"function"!=typeof define&&(define=require("requirejs").define),define(["Parser"],function(n){return ExpressionParser=function(){function e(n,e){var t={};return t.eq=function(t){return n==t.type()&&e==t.prio()},t.type=function(e){return e?e==n:n},t.prio=function(){return e},t.toString=function(){return"["+n+":"+e+"]"},t}function t(n){var e={},t=n;return e.add=function(n){t=t?t.or(n):n},e.get=function(){return t},e}function a(){var a=t(),i={};return i.reg=function(t,i,r){var o=e(t,i);a.add(r.ret(n.create(function(n){return n.opType=o,n})).setName("(opType "+o+" "+r.name+")"))},i.get=function(){return a.get()},i.parse=function(n){return i.get().parse(n)},i}function i(n,e){return}function r(n,e){var t,a=e;if(i(e," start minprio= "+n),e=s.parse(e),i(e," prefixorelem "+n),!e.isSuccess())return e;if(t=e.opType,t.type("prefix")){if(pre=e.result[0],e=r(t.prio(),e),!e.isSuccess())return e;var c=o.mkPrefix.def(pre,e.result[0]);if(a=e.clone(),a.result=[c],!e.nextPostfixOrInfix)return a;e=e.nextPostfixOrInfix}else if(a=e.clone(),e=l.parse(e),!e.isSuccess())return a;for(;;){if(i(e,"st:pi"),i(a,"res:ex"),t=e.opType,t.prio()<n)return a.nextPostfixOrInfix=e,a;if(t.type("postfix")){var c=o.mkPostfix.def(a.result[0],e.result[0]);
if(a=e.clone(),a.result=[c],i(e,"185"),e=l.parse(e),!e.isSuccess())return a}else if(t.type("infixl")){var p=e.result[0];if(e=r(t.prio()+1,e),!e.isSuccess())return a;var c=o.mkInfixl.def(a.result[0],p,e.result[0]);if(a=e.clone(),a.result=[c],!e.nextPostfixOrInfix)return a;e=e.nextPostfixOrInfix}else if(t.type("infixr")){var p=e.result[0];if(e=r(t.prio(),e),!e.isSuccess())return a;var c=o.mkInfixr.def(a.result[0],p,e.result[0]);if(a=e.clone(),a.result=[c],!e.nextPostfixOrInfix)return a;e=e.nextPostfixOrInfix}else if(t.type("trifixr")){var f=a.result[0],d=e.result[0];if(e=r(t.prio()+1,e),!e.isSuccess())return a;var h=e.result[0],e=u[t.prio()].parse(e);if(!e.isSuccess())return a;var x=e.result[0];if(e=r(t.prio(),e),!e.isSuccess())return a;var y=e.result[0],c=o.mkTrifixr.def(f,d,h,x,y);if(a=e.clone(),a.result=[c],!e.nextPostfixOrInfix)return a;e=e.nextPostfixOrInfix}else{var p=e.result[0];if(e=r(t.prio()+1,e),!e.isSuccess())return a;var c=o.mkInfix.def(a.result[0],p,e.result[0]);if(a=e.clone(),a.result=[c],!e.nextPostfixOrInfix)return a;if(e=e.nextPostfixOrInfix,t.prio()==e.opType.prio())return a.success=!1,a}}}var o={},s=a(),l=a(),c=t(),u=[];return o.element=function(n){s.reg("element",-1,n),c.add(n)},o.getElement=function(){return c.get()},o.prefix=function(n,e){s.reg("prefix",n,e)},o.postfix=function(n,e){l.reg("postfix",n,e)},o.infixl=function(n,e){l.reg("infixl",n,e)},o.infixr=function(n,e){l.reg("infixr",n,e)},o.infix=function(n,e){l.reg("infix",n,e)},o.trifixr=function(n,e,t){l.reg("trifixr",n,e),u[n]=t},o.custom=function(){},o.mkInfix=function(n){o.mkInfix.def=n},o.mkInfix.def=function(e,t,a){return n.setRange({type:"infix",op:t,left:e,right:a})},o.mkInfixl=function(n){o.mkInfixl.def=n},o.mkInfixl.def=function(e,t,a){return n.setRange({type:"infixl",op:t,left:e,right:a})},o.mkInfixr=function(n){o.mkInfixr.def=n},o.mkInfixr.def=function(e,t,a){return n.setRange({type:"infixr",op:t,left:e,right:a})},o.mkPrefix=function(n){o.mkPrefix.def=n},o.mkPrefix.def=function(e,t){return n.setRange({type:"prefix",op:e,right:t})},o.mkPostfix=function(n){o.mkPostfix.def=n},o.mkPostfix.def=function(e,t){return n.setRange({type:"postfix",left:e,op:t})},o.mkTrifixr=function(n){o.mkTrifixr.def=n},o.mkTrifixr.def=function(e,t,a,i,r){return n.setRange({type:"trifixr",left:e,op1:t,mid:a,op2:i,right:r})},o.build=function(){return o.built=n.create(function(n){return r(0,n)}).setName("ExpBuilt"),o.built},o.lazy=function(){return n.create(function(n){return o.built.parse(n)})},o}}),requireSimulator.setName("TonyuLang"),"function"!=typeof define&&(define=require("requirejs").define),define(["Grammar","XMLBuffer","IndentBuffer","TT","disp","Parser","ExpressionParser","TError"],function(n,e,t,a,i,r,o,s){return TonyuLang=function(){function t(n){return function(){return arguments[n]}}function l(n,e){var t=[];if(n&&!n.args)throw i(n);if(n){var a=r.getRange(n);r.addRange(t,a),n.args.forEach(function(n){t.push(n)})}return e.forEach(function(n){var e=r.getRange(n);r.addRange(t,e),t.push(n.obj)}),t}function c(n,e,t){var a={type:"infix",left:n,op:e,right:t};return r.setRange(a),a.toString=function(){return"("+n+e+t+")"},a}var u=r,p={},f=n(),d=f.get,h=(u.StringParser,u.TokensParser.token),x=h("number").ret(function(n){if(n.type="number","string"!=typeof n.text)throw"No text for "+i(n);if(n.value=parseFloat(n.text),isNaN(n.value))throw"No value for "+i(n);return n}),y=h("symbol"),g=h("==="),m=h("!=="),v=h("=="),R=h("!="),b=h(">="),A=h("<="),I=h(">"),w=h("<"),E=h("&&"),U=h("||"),T=h("-"),k=h("+"),F=h("*"),C=h("/"),S=h("%"),P=h("="),Q=h("literal"),X=h("regex"),N=o(),j=f("arrayElem").ands(h("["),N.lazy(),h("]")).ret(null,"subscript"),W=f("argList").ands(h("("),N.lazy().sep0(h(","),!0),h(")")).ret(null,"args"),L=f("member").ands(h("."),y).ret(null,"name"),H=f("parenExpr").ands(h("("),N.lazy(),h(")")).ret(null,"expr"),K=f("varAccess").ands(y).ret("name"),O=d("funcExpr").firstTokens(["function","\\"]),z=f("funcExprArg").ands(O).ret("obj"),M=d("objlit").firstTokens("{"),G=f("objlitArg").ands(M).ret("obj"),D=G.or(z),q=W.and(D.rep0()).ret(function(n,e){return l(n,e)}).or(D.rep1().ret(function(n){return l(null,n)})),Y=(W.or(G),f("call").ands(q).ret("args")),B=f("scall").ands(q).ret("args"),V=f("newExpr").ands(h("new"),K,Y.opt()).ret(null,"klass","params"),J=f("superExpr").ands(h("super"),h(".").and(y).ret(t(1)).opt(),B).ret(null,"name","params"),Z=h("true").or(h("false")).or(h("null")).or(h("undefined")).or(h("_thread")).or(h("this")).or(h("arguments")).ret(function(n){return n.type="reservedConst",n});N.element(x),N.element(Z),N.element(X),N.element(Q),N.element(H),N.element(V),N.element(J),N.element(O),N.element(M),N.element(d("arylit").firstTokens("[")),N.element(K);var $=0;N.infixr($,P),N.infixr($,h("+=")),N.infixr($,h("-=")),N.infixr($,h("*=")),N.infixr($,h("/=")),N.infixr($,h("%=")),N.infixr($,h("|=")),N.infixr($,h("&=")),$++,N.trifixr($,h("?"),h(":")),$++,N.infixl($,U),$++,N.infixl($,E),$++,N.infix($,h("instanceof")),N.infix($,h("is")),N.infix($,g),N.infix($,m),N.infix($,v),N.infix($,R),N.infix($,b),N.infix($,A),N.infix($,I),N.infix($,w),$++,N.postfix($+3,h("++")),N.postfix($+3,h("--")),N.infixl($,T),N.infixl($,k),$++,N.infixl($,F),N.infixl($,C),N.infixl($,S),$++,N.prefix($,h("typeof")),N.prefix($,h("delete")),N.prefix($,h("++")),N.prefix($,h("--")),N.prefix($,h("+")),N.prefix($,h("-")),N.prefix($,h("!")),$++,$++,N.postfix($,Y),N.postfix($,L),N.postfix($,j),N.mkInfixl(c),N.mkInfixr(c);{var _=N.build().setName("expr").profile(),t=function(n){return function(){return arguments[n]}},ne=d("stmt").firstTokens();f("exprstmt").ands(_,h(";")).ret("expr")}f("compound").ands(h("{"),ne.rep0(),h("}")).ret(null,"stmts");{var ee=h("else").and(ne).ret(t(1)),te=(f("return").ands(h("return"),_.opt(),h(";")).ret(null,"value"),f("if").ands(h("if"),h("("),_,h(")"),ne,ee.opt()).ret(null,null,"cond",null,"then","_else"),f("forin").ands(h("var").opt(),y.sep1(h(","),!0),h("in"),_).ret("isVar","vars",null,"set")),ae=f("normalFor").ands(ne,_.opt(),h(";"),_.opt()).ret("init","cond",null,"next"),ie=ae.or(te),re=(f("for").ands(h("for"),h("("),ie,h(")"),"stmt").ret(null,null,"inFor",null,"loop"),f("while").ands(h("while"),h("("),_,h(")"),"stmt").ret(null,null,"cond",null,"loop"),f("break").ands(h("break"),h(";")).ret("brk"),f("finally").ands(h("finally"),"stmt").ret(null,"stmt"),f("catch").ands(h("catch"),h("("),y,h(")"),"stmt").ret(null,null,"name",null,"stmt"),f("catches").ors("catch","finally")),oe=(f("try").ands(h("try"),"stmt",re.rep1()).ret(null,"stmt","catches"),f("throw").ands(h("throw"),_,h(";")).ret(null,"ex"),f("varDecl").ands(y,h("=").and(_).ret(t(1)).opt()).ret("name","value"));f("varsDecl").ands(h("var"),oe.sep1(h(","),!0),h(";")).ret(null,"decls")}f("funcDeclHead").ands(h("nowait").opt(),h("function").or(h("fiber")).or(h("tk_constructor")).or(h("\\")).opt(),y.or(h("new")),"paramDecls").ret("nowait","ftype","name","params");f("funcDecl").ands("funcDeclHead","compound").ret("head","body"),f("nativeDecl").ands(h("native"),y,h(";")).ret(null,"name"),f("ifWait").ands(h("ifwait"),"stmt",ee.opt()).ret(null,"then","_else");ne=f("stmt").ors("return","if","for","while","break","ifWait","try","throw","nativeDecl","funcDecl","compound","exprstmt","varsDecl");var se=f("paramDecl").ands(y).ret("name"),le=f("paramDecls").ands(h("("),se.sep0(h(","),!0),h(")")).ret(null,"params");f("funcExprHead").ands(h("function").or(h("\\")),y.opt(),le.opt()).ret(null,"name","params");var ce=(f("funcExpr").ands("funcExprHead","compound").ret("head","body"),f("jsonElem").ands(y.or(Q),h(":").and(_).ret(function(n,e){return e}).opt()).ret("key","value")),ue=(f("objlit").ands(h("{"),ce.sep0(h(","),!0),h("}")).ret(null,"elems"),f("arylit").ands(h("["),_.sep0(h(","),!0),h("]")).ret(null,"elems"),f("extends").ands(h("extends"),y.or(h("null")),h(";")).ret(null,"superClassName")),pe=f("includes").ands(h("includes"),y.sep1(h(","),!0),h(";")).ret(null,"includeClassNames"),fe=f("program").ands(ue.opt(),pe.opt(),ne.rep0(),r.TokensParser.eof).ret("ext","incl","stmts");for(var de in f.defs)f.defs[de].profile();return p.parse=function(n){str="string"==typeof n?n:n.text(),str+="\n";var e=a.parse(str);if(!e.isSuccess())throw s("文法エラー(Token)",n,e.src.maxPos);var t=e.result[0],i=u.TokensParser.parse(fe,t);if(i.isSuccess()){var r=i.result[0];return r}var o=t[i.src.maxPos],l=o?o.pos+o.len:str.length;throw s("文法エラー",n,l)},p.genXML=function(n,t){var a=e(n);return a(t),a.buf},p.extension="tonyu",p}()}),requireSimulator.setName("Visitor"),"function"!=typeof define&&(define=require("requirejs").define),define([],function(){return Visitor=function(n){var e={funcs:n,path:[]};return e.visit=function(t){try{e.path.push(t),e.debug&&console.log("visit ",t.type,t.pos);var a=t?n[t.type]:null;if(a)return a.call(e,t);if(e.def)return e.def.call(e,t)}finally{e.path.pop()}},e.replace=function(n){return e.def||(e.def=function(n){if("object"==typeof n)for(var t in n)n[t]&&"object"==typeof n[t]&&(n[t]=e.visit(n[t]));return n}),e.visit(n)},e}}),requireSimulator.setName("fixIndent"),requireSimulator.setName("HttpHelper"),requireSimulator.setName("Arrow"),Arrow=function(){var n={};return n.show=function(n){function e(){n.addClass("tutorial-highlight"),setTimeout(t,200)}function t(){n.removeClass("tutorial-highlight"),r-->0?setTimeout(e,200):a()}function a(){r=0,$.data(n[0],"blinking","f")}if("string"==typeof n&&(n=$(n)),0==n.length)return!1;var i=$.data(n[0],"blinking");if("t"!=i){$.data(n[0],"blinking","t");var r=3;e(),n.click(function(){a()})}},n.showOld=function(n){function e(){a&&(a.attr({src:"images/arrow"+i+".png"}),i=(i+1)%4)}if("string"==typeof n&&(n=$(n)),0==n.length)return!1;var t=n.offset(),a=$("<img>").attr({src:"images/arrow0.png"}).css({font:"40px",position:"absolute",left:t.left,top:t.top+n.height(),color:"red",zIndex:1e3,"z-index":1e3}).appendTo("body"),i=0;return setInterval(e,250),n.click(function(){a&&(a.remove(),a=null)}),!0},n}(),requireSimulator.setName("Wiki"),define(["HttpHelper","Arrow","Util","WebSite","Log","UI","FS"],function(n,e,t,a,i,r,o){return Wiki=function(t,s,l){function c(n){function e(n){n.stopPropagation(),n.preventDefault()}function t(n){if(l.editMode){var e=n.originalEvent,t=e.dataTransfer.files[0];if(!t.type.match(/image\/(png|gif|jpg)/)[1])return n.stopPropagation(),n.preventDefault(),!1;var a=new FileReader;return a.onload=function(){var n=a.result;s.text(n),i.empty().append(r("img",{src:n}))},a.readAsDataURL(t),n.stopPropagation(),n.preventDefault(),!1}}var i,s;if(p.builtinImages[n])return $("<div>").append($("<img>").attr("src",a.top+"/doc/images/"+n));i=r("div",{style:"margin:10px; padding:10px; border:solid black 1px;",on:{dragover:e,dragenter:e,drop:t}},"ここに画像ファイル(png/gif/jpg)をドラッグ＆ドロップして追加");var c=o.get(a.tonyuHome);return s=c.rel("doc/images/").rel(n),s.exists()&&i.empty().append(r("img",{src:s.text()})),i}function u(n,e,t){function a(){for(var o=[];;){var s=n.indexOf(e,r),l=n.indexOf(t,r);if(l>=0&&(0>s||s>l)){o.push(n.substring(r,l)),r=l;break}if(0>s){o.push(n.substring(r)),r=n.length;break}o.push(n.substring(r,s)),r=s+e.length;var c=a();c.hasBrace=!0,r<n.length&&(r+=t.length),o.push(c)}return i(o),o}function i(n){return n.split=function(n,e){if(1==e)return this;var t=[],a=i([]);return this.forEach(function(r){if("string"==typeof r){var o=r.indexOf(n);if(t.length>=e&&(o=-1),o>=0){if(o>0){var s=r.substring(0,o);a.push(s)}if(o+=n.length,t.push(1!=a.length?a:a[0]),a=i([]),o<r.length){var s=r.substring(o);a.push(s)}}else a.push(r)}else a.push(r)}),t.push(1!=a.length?a:a[0]),t},n.text=function(n){var a=this.hasBrace&&n?e:"";return this.forEach(function(n){a+="string"==typeof n?n:n.text(!0)}),a+=this.hasBrace&&n?t:""},n.toString=function(){return this.text(!0)},n}var r=0;return a(0)}var p={},f={figures:"図",plists:"リスト"},d="marker_"+Math.floor(1e5*Math.random()),h={},x=[],y=".txt";if(l||(l={}),s&&!s.isDir())throw s+": not a dir";var g,m;p.on=h,p.cd=function(n){g=n,m=g.rel("toc.json")},s&&p.cd(s),p.parse=function(t,i,r){function o(n){x[n]={};var e=1,t=function(t,a){var i=x[n][t];return i||(i={refs:[]},x[n][t]=i),a&&(i.no=e++,i.name=f[n]+i.no,i.refs.forEach(function(n){n.text(i.name)})),i};return t}function s(n){function e(n){for(null==n&&(n=0);x.ul>n;)x.ul--,y.exit()}y.lineNo=x.lineNo;var t=0;if(n.match(/^-+/)&&(t=RegExp.lastMatch.length),t>x.ul)for(;t>x.ul;)x.ul++,y.enter("<ul>");else e(t);if(n=n.substring(t),t>0&&y.enter("<li>"),n.match(/^\*+/)){var a=RegExp.rightContext,i="h"+RegExp.lastMatch.length;y.enter("<"+i+">"),h(a),y.exit()}else if(n.match(/^$/))e(),y.p($("<p>"));else if(n.match(/^<<toc(.*)/))x.toc=[x.name],x.blocks.push({name:"toc",exit:function(){m&&!m.isReadOnly()&&m.obj(x.toc),x.toc=null}});else if(n.match(/^<<code(.*)/)){var r=RegExp.$1;if(r=r.replace(/^ */,""),r.length>0){var o,s,l=r.split(/ /,2);if(2==l.length){s=l[0],o=l[1];var c=v(o,!0);y.p($("<div>").addClass("plist").text(c.name+" "+s))}else y.p($("<div>").addClass("plist").text(l))}y.enter("<pre>"),x.blocks.push({name:"code",exit:function(){y.exit()}})}else if(n.match(/^>>/)){var u=x.blocks.pop();u&&u.exit&&u.exit(x)}else if(n.match(/^@@@@(.*)/)){if(x.pclose)y.exit();else{if(RegExp.$1.length>0){var c=v(RegExp.$1,!0);y.p($("<div>").addClass("plist").text(c.name))}y.enter("<pre>")}x.pclose=!x.pclose}else h(n),y.p("\n");t>0&&y.exit(),x.lineNo++}function h(n){function t(n){var t,i=n.text();if(i.match(/^@blink ([^>]+)>([^\s]+)/)){caption=RegExp.$1;var o=RegExp.$2;t=$("<span>").addClass("clickable").text(caption).hover(function(){var n;parent&&parent.Arrow&&(n=parent.Arrow),e&&(n=e),n&&n.show(o)})}else if(i.match(/^@plistref (.*)/)){var s=RegExp.$1,u=v(s);t=$("<strong>").text(u.name),u.refs.push(t)}else if(i.match(/^@editadd/))y.p($("<img>").attr("src",a.top+"/images/editAdd.png"));else if(i.match(/^@figref (.*)/)){var u=g(RegExp.$1);t=$("<strong>").text(u.name),u.refs.push(t)}else if(i.match(/^@cfrag (.*)/)){var d=RegExp.$1;t=$("<code>"),y.enter(t),h(d),y.exit()}else if(i.match(/^@arg (.*)/)){var m=RegExp.$1;t=$("<i>"),y.enter(t),h(m),y.exit()}else{var R=n.split(">",2);if(2==R.length?(i=R[1]+"",caption=R[0]):caption=i,x.toc&&x.toc.push(i),i.match(/\.(png|jpg|gif)$/)&&!i.match(/^http/)){var u=g(i,!0);t=$("<div>").addClass("figure").append(c(i)),y.enter(t),y.enter($("<div>")),y.p(f.figures+u.no+"."),h(caption),y.exit(),y.exit()}else if(i.match(/^https?:\/\//))t=$("<a>").attr({href:i,target:"ext"}).text(caption);else{var b=p.resolveFile(i);if(b.exists()||!b.isReadOnly()&&l.editMode){if(l.useAnchor){var A=b.relPath(r.up()).replace(/\.txt$/,".html");A=encodeURI(A).replace(/%/g,"_"),t=$("<a>").attr({href:A}).text(caption)}else t=$("<span>").addClass("clickable").text(caption).click(function(){p.show(b)});b.exists()||t.addClass("notexist")}else t=$("<span>").text(caption)}}y.p(t)}var i="string"==typeof n?u(n,x.beginMark,x.endMark):n;i.forEach(function(n){"string"==typeof n?y.p(n):t(n)})}var x={},y=n({lineMark:d});x.out=y,x.name=i,x.lines=t.split(/\r?\n/),x.lineNo=0,x.ul=0,x.beginMark="[[",x.endMark="]]",x.blocks=[];var g=o("figures"),v=o("plists"),R=[];m&&m.exists()&&(R=m.obj());var b=R.indexOf(i);if(b>=0){var A="",I=R[b-1];I&&(A+="[[前へ>"+I+"]]");var w=R[b+1];w&&(A+=" - [[次へ>"+w+"]]");var E=R[0];0!=b&&(A+=" - [[目次>"+E+"]]"),x.lines.unshift(A),x.lines.push(A)}return x.lines.forEach(s),y.buf},p.resolveFile=function(n){var e;return e=n.isDir?n:g&&"/"!=n.substring(0,1)?g.rel(n+y):o.get(n)},p.show=function(n){var e=p.resolveFile(n);l.editMode||i.d("wiki","show "+e),p.cd(e.up());var a=e.truncExt(y);if(!e.exists()&&!e.isReadOnly()&&l.editMode){var r=x[x.length-1];e.text(r?"[["+r.truncExt(y)+"]]\n":"")}if(e.exists()){var o=p.parse(e.text(),a,e);t.empty(),t.scrollTop(0),t.append(o),t.append($("<div>").css({height:"100px"}).text("")),h.show&&h.show.apply(p,[e,a]),x.push(e)}else alert(n+" というページはありません")},p.back=function(){var n=x.pop();n&&show(n)};var v;return p.highlightLine=function(n){var e=$("#"+d+"-"+n);if(0!=e.length){v&&v.removeClass("wiki-cur-line"),v=e.next(),v.addClass("wiki-cur-line");var a=e.position().top,i=t;0>a&&i.scrollTop(i.scrollTop()+(a-10)/2);var r=i.height()-100;a>r&&i.scrollTop(i.scrollTop()+(a-r+10)/2)}},p.builtinImages={"50_100.png":1,"50_160.png":1,"50_300.png":1,"apple1apple2.png":1,"coords.png":1,"copy60_100.png":1,"firstRunRes.png":1,"firstVarRes.png":1,"itadaki.png":1,"noWaitCat.png":1,"runtimeError.png":1,"sample.png":1,"sayonara.png":1,"syntaxError.png":1},p}}),requireSimulator.setName("Tonyu.TraceTbl"),define(["Tonyu","FS","TError"],function(n,e,t){return n.TraceTbl=function(){var n={},a=1e6,i=1,r=1e4,o={},s=[],l={};return n.add=function(n,e){var t=n.src.tonyu,c=t.path(),u=o[c];void 0==u&&(u=i++,i>r&&(i=0),o[c]=u,s[u]=c),l[c]=n,e>=a&&(e=a-1);var p=u*a+e;return p},n.decode=function(n){var i=n%a,r=(n-i)/a,o=s[r];if(o){var c=e.get(o),u=l[o];return t("Trace info",u||c,i)}return null},n}}),requireSimulator.setName("PatternParser"),define(["Tonyu"],function(n){return n.klass({initialize:function(n,e){this.options=e||{},this.img=n,this.height=n.height,this.width=n.width;var t=this.newImage(n.width,n.height),a=t.getContext("2d");a.drawImage(n,0,0),this.ctx=a,this.pixels=this.ctx.getImageData(0,0,n.width,n.height).data,this.base=this.getPixel(0,0)},newImage:function(n,e){var t=document.createElement("canvas");return t.width=n,t.height=e,t},getPixel:function(n,e){var t=this.pixels,a=4*(n+e*this.width),i=t[0+a],r=t[1+a],o=t[2+a],s=t[3+a];return 256*(256*(256*s+o)+r)+i},setPixel:function(n,e,t){var a=4*(n+e*this.width);this.pixels[0+a]=255&t,t=(t-(255&t))/256,this.pixels[1+a]=255&t,t=(t-(255&t))/256,this.pixels[2+a]=255&t,t=(t-(255&t))/256,this.pixels[3+a]=255&t},parse:function(){try{for(var n=[],e=0;e<this.height;e++)for(var t=0;t<this.width;t++){var a=this.getPixel(t,e);a!=this.base&&n.push(this.parse1Pattern(t,e))}return n}catch(i){if(i.isParseError)return console.log("parse error! "+i),{image:this.img,x:0,y:0,width:this.width,height:this.height};throw i}},parse1Pattern:function(n,e){function t(n){return n}function a(n,e,t){return{toString:function(){return"at ("+n+","+e+") :"+t},isParseError:!0}}for(var i=this.getPixel(n,e),r=n,o=e,s=this.base,l=this.width,c=this.height;l>r;){var u=this.getPixel(r,o);if(u!=i)break;r++}if(r>=l||this.getPixel(r,o)!=s)throw a(r,o,t(this.getPixel(r,o))+"!="+t(s));for(r--;c>o&&this.getPixel(r,o)==i;)o++;if(o>=c||this.getPixel(r,o)!=s)throw a(r,o,t(this.getPixel(r,o))+"!="+t(s));o--;var p=n+1,f=e+1,d=r-p,h=o-f;if(console.log("PP",p,f,d,h,r,o),d*h==0)throw a(r,o,"w*h==0");for(var x=this.newImage(d,h),y=x.getContext("2d"),g=y.getImageData(0,0,d,h),m=g.data,v=0,R=f;o>R;R++)for(var b=p;r>b;b++){var A=this.getPixel(b,R);A==i?(m[v++]=0,m[v++]=0,m[v++]=0,m[v++]=0):(m[v++]=255&A,A=(A-(255&A))/256,m[v++]=255&A,A=(A-(255&A))/256,m[v++]=255&A,A=(A-(255&A))/256,m[v++]=255&A)}y.putImageData(g,0,0);for(var I=f-1;o>=I;I++)for(var w=p-1;r>=w;w++)this.setPixel(w,I,s);return this.options.boundsInSrc?{x:p,y:f,width:d,height:h}:{image:x,x:0,y:0,width:d,height:h}}})}),requireSimulator.setName("ImageList"),define(["PatternParser","Util","WebSite"],function(n,e,t){function a(n){var e=[];return n.forEach(function(n){n&&""!=n.url&&e.push(n)}),e}var i,r={};return i=function(e,t,o){o||(o={}),e=a(e);var s=[],l=e.length;e.forEach(function(e,a){function c(){var i,r;if((i=e.pwidth)&&(r=e.pheight)){for(var o=0,c=0,u=this.width,p=this.height,f=[];;){var d=i,h=r;if(o+i>u&&(d=u-o),c+r>p&&(h=p-c),f.push({image:this,x:o,y:c,width:d,height:h}),o+=i,o+i>u&&(o=0,c+=r,c+r>p))break}s[a]=f}else{var x=new n(this);s[a]=x.parse()}if(s[a].name=e.name,l--,0==l){var y=[],g={};s.forEach(function(n){g[n.name]=y.length,y=y.concat(n)}),y.names=g,t(y)}}console.log("loading",e,a);var u=e.url,p=u;if(r[p])return void c.apply(r[p],[]);u=i.convURL(u,o.baseDir);var f=$("<img>");f.load(function(){r[p]=this,c.apply(this,[])}),f.attr("src",u)})},i.load=i,i.parse1=function(e,t,a){var i,r,o;if((i=e.pwidth)&&(r=e.pheight)){for(var s=0,l=0,c=t.width,u=t.height,p=[];;)if(p.push({image:this,x:s,y:l,width:i,height:r}),s+=i,s+i>c&&(s=0,l+=r,l+r>u))break;o=p}else{var f=new n(t,a);o=f.parse()}return o.name=e.name,o},i.convURL=function(n,a){if(null==n&&(n=""),n=n.replace(/\$\{([a-zA-Z0-9_]+)\}/g,function(n,e){return t[e]}),t.urlAliases[n]&&(n=t.urlAliases[n]),e.startsWith(n,"ls:")){var i=n.substring("ls:".length);if(!a)throw new Error("Basedir not specified");var r=a.rel(i);if(!r.exists())throw"ImageList file not found: "+r;n=r.text()}return n},window.ImageList=i,i}),requireSimulator.setName("StackTrace"),define([],function(){var trc={},pat=/_trc_func_([0-9]+)_.*[^0-9]([0-9]+):([0-9]+)[\s\)]*\r?$/;return trc.isAvailable=function(){var scr="({\n    main :function _trc_func_17000000_0() {\n      var a=(this.t.x);\n    }\n}).main();\n",s;try{eval(scr)}catch(e){if(s=e.stack,"string"!=typeof s)return!1;for(var lines=s.split(/\n/),i=0;i<lines.length;i++){var p=pat.exec(lines[i]);if(p)return!0}}return!1},trc.get=function(n,e){var t=n.stack;if("string"!=typeof t)return!1;for(var a=t.split(/\n/),i=[],r=0;r<a.length;r++){var o=pat.exec(a[r]);if(o){var s=o[1],l=o[2],c=(o[3],e.decode(s));if(c&&c.klass){for(var u=c.klass.src.js,p=u.split(/\n/),f=null,d=0;d<p.length&&l>d+1;d++){var h=/\$LASTPOS=([0-9]+)/.exec(p[d]);h&&(f=parseInt(h[1]))}if(f){var x=e.decode(f);x&&i.push(x)}}}}return i},trc}),requireSimulator.setName("typeCheck"),"function"!=typeof define&&(define=require("requirejs").define),define(["Visitor"],function(){return TypeCheck=function(){}}),requireSimulator.setName("Auth"),define(["WebSite"],function(n){var e={};return e.currentUser=function(e){$.ajax({type:"get",url:n.serverTop+"/currentUser",data:{withCsrfToken:!0},success:function(n){console.log("auth.currentUser",n),n=JSON.parse(n);var t=n.user;"null"==t&&(t=null),console.log("user",t,"csrfToken",n.csrfToken),e(t,n.csrfToken)}})},e.assertLogin=function(t){e.currentUser(function(e,a){return e?t.success(e,a):(window.onLoggedIn=t.success,void t.showLoginLink(n.serverTop+"/login"))})},window.Auth=e,e}),requireSimulator.setName("Blob"),define(["Auth","WebSite","Util"],function(n,e,t){var a={},i="${blobPath}";return a.BLOB_PATH_EXPR=i,a.upload=function(n,t,a,i){var r=new FormData(document.getElementById("fileinfo"));i.error&&(i.error=function(n){alert(n)}),r.append("theFile",a),r.append("user",n),r.append("project",t),r.append("fileName",a.name),$.ajax({type:"get",url:e.serverTop+"/blobURL",success:function(n){$.ajax({url:n,type:"POST",data:r,processData:!1,contentType:!1,success:function(n){console.log("Res = "+n),i.success.apply({},arguments)},error:i.error})}})},a.isBlobURL=function(n){if(t.startsWith(n,i)){var e=n.split("/");return{user:e[1],project:e[2],fileName:e[3]}}},a.url=function(n,t,a){return e.blobPath+n+"/"+t+"/"+a},a.uploadToExe=function(n,t){var a=n.getBlobInfos(),i=a.length;return console.log("uploadBlobToExe cnt=",i),0==i?t.success():(t.progress||(t.progress=function(n){console.log("uploadBlobToExe cnt=",n)}),void a.forEach(function(n){var a={csrfToken:t.csrfToken};for(var r in n)a[r]=n[r];$.ajax({type:"get",url:e.serverTop+"/uploadBlobToExe",data:a,success:function(){return i--,0==i?t.success():void t.progress(i)},error:t.error})}))},a}),requireSimulator.setName("ImageRect"),define([],function(){function n(e,t){if("string"==typeof e){var a=new Image,i=null,r=null,o=function(n){n&&(r=n),r&&i&&r(i)};return a.onload=function(){i=n(a,t),o()},a.src=e,o}var s=t.width,l=t.height,c=t.getContext("2d"),u=e.width,p=e.height,f=l/p*u,d=s/u*p;d>l&&(d=l),f>s&&(f=s),c.clearRect(0,0,s,l);var h=Math.floor((s-f)/2),x=Math.floor((l-d)/2);return c.drawImage(e,0,0,u,p,h,x,f,d),{left:h,top:x,width:f,height:d,src:e}}return n}),requireSimulator.setName("thumbnail"),define(["ImageRect"],function(n){function e(e){try{var i=Tonyu.globals.$Screen.buf[0],r=$("<canvas>").attr({width:100,height:100});n(i,r[0]);var o=r[0].toDataURL(),s=e.getResource(),l=e.getDir(),c=t.file(e);c.text(o);for(var u={name:a,pwidth:100,pheight:100,url:"ls:"+c.relPath(l)},p=s.images,f=!1,d=0;d<p.length;d++)p[d].name==a&&(p[d]=u,f=!0);f||p.push(u),e.setResource(s),console.log("setRSRC",s)}catch(h){console.log("Create thumbnail failed",h)}}var t={},a="$icon_thumbnail";return t.set=function(n,t){setTimeout(function(){e(n)},t)},t.get=function(n){var e=t.file(n);return e.exists()?e.text():null},t.file=function(n){var e=n.getDir(),t=e.rel("images/").rel("icon_thumbnail.png");return t},t}),requireSimulator.setName("plugins"),define(["WebSite"],function(n){function e(n){return"function"==typeof n&&(n={onload:n}),n||(n={}),n.onload||(n.onload=function(){}),n}var t={},a={box2d:{src:"Box2dWeb-2.1.a.3.min.js",detection:/T2Body/,symbol:"Box2D"},timbre:{src:"timbre.js",detection:/\bplay(SE)?\b/,symbol:"T"}};return t.detectNeeded=function(n,e){for(var t in a){var i=a[t].detection.exec(n);i&&(e[t]=1)}return e},t.loaded=function(n){var e=a[n];if(!e)throw new Error("plugin not found: "+n);return window[e.symbol]},t.loadAll=function(n,i){function r(){l>=o.length?i.onload():t.load(o[l++],r)}i=e(i);var o=[];for(var s in n)a[s]&&!t.loaded(s)&&o.push(s);var l=0;console.log("loading plugins",o),r()},t.load=function(t,i){var r=a[t];if(!r)throw new Error("plugin not found: "+t);i=e(i);var o=n.pluginTop+"/"+r.src;$.getScript(o,i.onload)},t.request=function(n){if(!t.loaded(n)){var e=new Error("Plugin "+n+" required");e.pluginName=n}},t}),requireSimulator.setName("Tonyu.Iterator"),define(["Tonyu"],function(){function n(n,e){var t={};if(n.tonyuIterator)return n.tonyuIterator(e);if(n instanceof Array)t.i=0,t.next=1==e?function(){return t.i>=n.length?!1:(this[0]=n[t.i],t.i++,!0)}:function(){return t.i>=n.length?!1:(this[0]=t.i,this[1]=n[t.i],t.i++,!0)};else{if(!(n instanceof Object))throw console.log(n),"Cannot iterable";t.i=0;var a=[];if(1==e){for(var i in n)a.push(i);t.next=function(){return t.i>=a.length?!1:(this[0]=a[t.i],t.i++,!0)}}else{for(var i in n)a.push([i,n[i]]);t.next=function(){return t.i>=a.length?!1:(this[0]=a[t.i][0],this[1]=a[t.i][1],t.i++,!0)}}}return t}return Tonyu.iterator=n,n}),requireSimulator.setName("ObjectMatcher"),"function"!=typeof define&&(define=require("requirejs").define),define([],function(){return ObjectMatcher=function(){function n(n,e){var t={};return t[i]=n,e&&(t[r]=e),t}function e(n){return n&&n[i]}function t(n,e,a){if(n===e)return!0;if(null==n)return!1;if("string"==typeof n&&e instanceof RegExp)return n.match(e);if("function"==typeof e)return e(n,a);if("object"==typeof e){for(var o in e)if(o!=i){var s=o==r?n:n[o],l=e[o];if(!t(s,l,a))return!1}return e[i]&&(a[e[i]]=n),!0}return!1}var a={},i="$var",r="$this";a.v=n,a.isVar=e;for(var o="ABCDEFGHIJKLMNOPQRSTUVWXYZ",s=0;s<o.length;s++){var l=o.substring(s,s+1);a[l]=n(l)}return a.match=function(n,e){var a={};return t(n,e,a)?a:null},a}()}),requireSimulator.setName("context"),"function"!=typeof define&&(define=require("requirejs").define),define([],function(){return context=function(){function n(n,t){var a={};for(var i in n)i.match(/^\$/)?(i=RegExp.rightContext,a[i]=e[i],e[i]=e.ovrFunc(e[i],n[i])):(a[i]=e[i],e[i]=n[i]);t(e);for(var i in a)e[i]=a[i]}var e={};return e.ovrFunc=function(n,e){return e.parent=n,e},e.enter=n,e}}),requireSimulator.setName("Tonyu.Compiler"),define(["Tonyu","ObjectMatcher","TError"],function(n){function e(n,e){var t={type:n};if(e)for(var a in e)t[a]=e[a];return t.name||(t.name=r("_"+n+"_")),t}function t(n){return n?n.type:null}function a(n){var e=function(){};return e.prototype=n,new e}function i(n,e){if(!n)throw e+" is null";return n}function r(n){return n+(d++ +"").replace(/\./g,"")}function o(n,e,t){e._id||(n._idseq||(n._idseq=0),e._id=++n._idseq);var a=n[e._id];if(a||(a=n[e._id]={node:e}),t)for(var i in t)a[i]=t[i];return a}function s(n){return srcCont.substring(n.pos,n.pos+n.len)}function l(n,e){var t=null;return c(n).forEach(function(n){t||(t=n.decls.methods[e])}),t}function c(n){for(var e={},t=[],a=[],i=n;i;i=i.superClass)t=t.concat(i.includes),e[i.fullName]=!0,a.push(i);for(;t.length>0;){var i=t.shift();e[i.fullName]||(e[i.fullName]=!0,a.push(i),t=t.concat(i.includes))}return a}function u(n){if(!n.head)return[];var e=n.head.params.params;if(!e.forEach)throw n+" is not array ";return e}var p={};n.Compiler=p;var f={FIELD:"field",METHOD:"method",NATIVE:"native",LOCAL:"local",THVAR:"threadvar",PARAM:"param",GLOBAL:"global",CLASS:"class"};p.ScopeTypes=f;var d=1;return p.newScopeType=e,p.getScopeType=t,p.newScope=a,p.nullCheck=i,p.genSym=r,p.annotation=o,p.getSource=s,p.getMethod=l,p.getDependingClasses=c,p.getParams=u,p}),requireSimulator.setName("Tonyu.Compiler.Semantics"),"function"!=typeof define&&(define=require("requirejs").define),define(["Tonyu","Tonyu.Iterator","TonyuLang","ObjectMatcher","TError","IndentBuffer","context","Visitor","Tonyu.Compiler"],function(n,e,t,a,i,r,o,s,l){return l.Semantics=function(){function n(n,e){function r(t){var a,r=e.options.compiler.defaultSuperClass,s=0;if((a=f.match(t,{ext:{superClassName:{text:f.N,pos:f.P}}}))&&(r=a.N,s=a.P,"null"==r&&(r=null)),n.includes=[],(a=f.match(t,{incl:{includeClassNames:f.C}}))&&a.C.forEach(function(t){var a=t.text,r=t.pos,s=e.classes[e.aliases[a]||a];if(!s)throw i("クラス "+a+"は定義されていません",o,r);n.includes.push(s)}),"Array"==r)n.superClass={name:"Array",fullName:"Array",builtin:!0};else if(r){var c=e.classes[e.aliases[r]||r];if(!c)throw i("親クラス "+r+"は定義されていません",o,s);n.superClass=c}t.stmts.forEach(function(n){if("funcDecl"==n.type){var e=n.head,t="function";e.ftype&&(t=e.ftype.text),u[e.name.text]={nowait:!!e.nowait,ftype:t,name:e.name.text,head:e,pos:e.pos,stmts:n.body.stmts}}else"nativeDecl"==n.type?p[n.name.text]=n:l.stmts.push(n)})}var o=n.src.tonyu,s=t.parse(o),l={name:"main",stmts:[],pos:0},c={},u={main:l},p={};n.decls={fields:c,methods:u,natives:p},n.node=s;var f=a;r(s)}function e(n,e){function t(e,t){return d(n.annotation,e,t)}function l(n){if(!n.builtin){var e=K,t=n.decls;for(var a in t.fields)e[a]=c(H.FIELD,{klass:n.name,name:a});for(var a in t.methods)e[a]=c(H.METHOD,{klass:n.name,name:a})}}function v(){var t=K;y(n).forEach(l);var a=n.decls;for(var i in a.natives)t[i]=c(H.NATIVE,{name:"native::"+i});for(var i in m)t[i]=c(H.NATIVE,{name:"native::"+i});for(var i in e.aliases)t[i]=c(H.CLASS,{name:i})}function R(){var e=y(n);for(var t in n.decls.methods){var a=n.decls.methods[t];e.forEach(function(n){var e=n.decls.methods[t];e&&e.nowait&&(a.nowait=!0)})}}function b(e){return x(n,e)}function A(n){if("varAccess"==n.type||"postfix"==n.type&&("member"==n.op.type||"arrayElem"==n.op.type))return"varAccess"==n.type&&t(n,{noBind:!0}),!0;throw console.log("LVal",n),i("'"+h(n)+"'は左辺には書けません．",N,n.pos)}function I(e){var t=O.scope[e],a=u(t);if(!a){var i=e.match(/^\$/);a=i?H.GLOBAL:H.FIELD;var r={name:e};i||(r.klass=n.name),t=K[e]=c(a,r)}return t}function w(n){var e=this;if(n&&"object"==typeof n){var t;if(t=n instanceof Array?n:n[Grammar.SUBELEMENTS],!t){t=[];for(var a in n)t.push(n[a])}t.forEach(function(n){e.visit(n)})}}function E(n){var e={varDecls:{},subFuncDecls:{}};return O.enter({locals:e},function(){J.visit(n)}),e}function U(n,e){n.forEach(function(n){t(n,e)})}function T(n){O.method&&(O.method.fiberCallRequired=!0),U(n,{fiberCallRequired:!0})}function k(n,e){O.enter({scope:e},function(){Z.visit(n)})}function F(n,e){for(var t in n.varDecls)e[t]=c(H.LOCAL);for(var t in n.subFuncDecls)e[t]=c(H.LOCAL)}function C(n){n.locals=E(n.stmts),n.params=g(n)}function S(e){var t=p(O.scope);return e.params.forEach(function(a,i){t[a.name.text]=c(H.PARAM,{klass:n.name,name:e.name,no:i})}),F(e.locals,t),O.enter({method:e,finfo:e,noWait:!1},function(){k(e.stmts,t)}),e.scope=t,X(e.locals,t),t}function P(){O.enter({scope:K},function(){for(var n in L){z&&console.log("anon method1",n);var e=L[n];C(e),S(e)}})}function Q(n){var e,a,i=n.body,r=n.head.name?n.head.name.text:"anonymous";a=(e=j.match(n,{head:{params:{params:j.P}}}))?e.P:[];var o=p(O.scope);a.forEach(function(n){o[n.name.text]=c(H.PARAM)});var s=E(i,o);F(s,o);var l=t(n);O.enter({finfo:l},function(){k(i,o)});var u={scope:o,locals:s,name:r,params:a};return t(n,u),t(n,l),X(s,o),u}function X(n,e){O.enter({scope:e},function(){for(var e in n.subFuncDecls)Q(n.subFuncDecls[e])
})}var N=n.src.tonyu,j=(N.text(),a),W=(e.traceTbl,n.decls),L=(W.fields,W.methods),H=(W.natives,r),K={},O=o(),z=!1,M={type:"postfix",left:{type:"postfix",left:j.T,op:{type:"member",name:{text:j.N}}},op:{type:"call",args:j.A}},G={type:"postfix",left:j.T,op:{type:"member",name:{text:j.N}}},D=fiberCallTmpl={type:"postfix",left:{type:"varAccess",name:{text:j.N}},op:{type:"call",args:j.A}},q={expr:fiberCallTmpl},Y={expr:{type:"infix",op:j.O,left:j.L,right:fiberCallTmpl}},B={expr:{type:"superExpr",params:{args:j.A},$var:"S"}},V={expr:{type:"infix",op:j.O,left:j.L,right:{type:"superExpr",params:{args:j.A},$var:"S"}}};n.annotation={};var J=s({varDecl:function(n){O.locals.varDecls[n.name.text]=n},funcDecl:function(n){O.locals.subFuncDecls[n.head.name.text]=n},funcExpr:function(){},"catch":function(n){O.locals.varDecls[n.name.text]=n},exprstmt:function(){},forin:function(n){n.isVar;n.vars.forEach(function(e){O.locals.varDecls[e.text]=n});var e=f("_it_");t(n,{iterName:e}),O.locals.varDecls[e]=n}});J.def=w;var Z=s({varAccess:function(n){var e=I(n.name.text);t(n,{scopeInfo:e})},funcDecl:function(){},funcExpr:function(n){Q(n)},jsonElem:function(n){if(n.value)this.visit(n.value);else{var e=I(n.key.text);t(n,{scopeInfo:e})}},"do":function(n){var e=this;O.enter({jumpable:!0},function(){e.def(n)})},"switch":function(n){var e=this;O.enter({jumpable:!0},function(){e.def(n)})},"while":function(n){var e=this;O.enter({jumpable:!0},function(){e.def(n)})},"for":function(n){var e=this;O.enter({jumpable:!0},function(){e.def(n)})},forin:function(n){n.vars.forEach(function(n){var e=I(n.text);t(n,{scopeInfo:e})}),this.visit(n.set)},ifWait:function(n){var e="_thread",t=this,a=p(O.scope);a[e]=c(H.THVAR),O.enter({scope:a},function(){t.visit(n.then)}),n._else&&t.visit(n._else),T(this.path)},"try":function(n){O.finfo.useTry=!0,this.def(n)},"return":function(n){O.noWait||U(this.path,{hasReturn:!0}),this.visit(n.value)},"break":function(n){if(!O.jumpable)throw i("break； は繰り返しの中で使います.",N,n.pos);O.noWait||U(this.path,{hasJump:!0})},"continue":function(n){if(!O.jumpable)throw i("continue； は繰り返しの中で使います.",N,n.pos);O.noWait||U(this.path,{hasJump:!0})},reservedConst:function(n){"arguments"==n.text&&(O.finfo.useArgs=!0)},postfix:function(n){var e;if(this.visit(n.left),this.visit(n.op),e=j.match(n,D)){var a=t(n.left).scopeInfo;t(n,{myMethodCall:{name:e.N,args:e.A,scopeInfo:a}})}else(e=j.match(n,M))?t(n,{othersMethodCall:{target:e.T,name:e.N,args:e.A}}):(e=j.match(n,G))&&t(n,{memberAccess:{target:e.T,name:e.N}})},infix:function(n){var e=n.op.text;("="==e||"+="==e||"-="==e||"*="==e||"/="==e||"%="==e)&&A(n.left),this.def(n)},exprstmt:function(e){var a,i;if(O.noWait||!(a=j.match(e,q))||u(O.scope[a.N])!=H.METHOD||b(a.N).nowait)if(O.noWait||!(a=j.match(e,Y))||u(O.scope[a.N])!=H.METHOD||b(a.N).nowait){if(!O.noWait&&(a=j.match(e,B))&&a.S.name){if(i=b(a.S.name.text),!i)throw new Error("メソッド"+a.S.name.text+" はありません。");i.nowait||(a.type="noRetSuper",a.superClass=n.superClass,t(e,{fiberCall:a}),T(this.path))}else if(!O.noWait&&(a=j.match(e,V))&&a.S.name){if(i=b(a.S.name.text),!i)throw new Error("メソッド"+a.S.name.text+" はありません。");i.nowait||(a.type="retSuper",a.superClass=n.superClass,t(e,{fiberCall:a}),T(this.path))}}else a.type="ret",t(e,{fiberCall:a}),T(this.path);else a.type="noRet",t(e,{fiberCall:a}),T(this.path);this.visit(e.expr)}});Z.def=w,v(),R(),P()}var r=l.ScopeTypes,c=l.newScopeType,u=l.getScopeType,p=l.newScope,f=l.genSym,d=l.annotation,h=l.getSource,x=l.getMethod,y=l.getDependingClasses,g=l.getParams,m={Array:1,String:1,Boolean:1,Number:1,Void:1,Object:1,RegExp:1,Error:1};return{initClassDecls:n,annotate:e}}()}),requireSimulator.setName("Tonyu.Compiler.JSGenerator"),"function"!=typeof define&&(define=require("requirejs").define),define(["Tonyu","Tonyu.Iterator","TonyuLang","ObjectMatcher","TError","IndentBuffer","context","Visitor","Tonyu.Compiler"],function(n,e,t,a,i,r,o,s,l){return l.JSGenerator=function(){function n(n,l){function k(e,t){return U(n.annotation,e,t)}function F(n){return"string"==typeof n?R+(l.aliases[n]||n):n.builtin?n.fullName:R+n.fullName}function C(n){var e=[];return n.forEach(function(n){e.push(F(n))}),e}function S(n,e){return function(){B.enter(n,function(){v.visit(e)})}}function P(n,a,i){var r=E(a);if(r==ne.THVAR)q.printf("%s",e);else if(r==ne.FIELD)q.printf("%s.%s",t,n);else if(r==ne.METHOD)i&&i.noBind?q.printf("%s.%s",t,n):q.printf("%s(%s,%s.%s)",x,t,t,n);else if(r==ne.CLASS)q.printf("%s",F(n));else if(r==ne.GLOBAL)q.printf("%s%s",b,n);else{if(r!=ne.PARAM&&r!=ne.LOCAL&&r!=ne.NATIVE)throw console.log("Unknown scope type: ",r),new Error("Unknown scope type: "+r);q.printf("%s",n)}return a}function Q(n){return function(){X.apply(this,[n])}}function X(n){"compound"==n.type?B.enter({noWait:!0},function(){q.printf("%j%n",["%n",n.stmts])}):v.visit(n)}function N(e){return function(){q.printf("%s%s=%s;%n",l.options.compiler.commentLastPos?"//":"",f,Z.add(n,e.pos))}}function j(){B.enter({},function(){R+n.namespace;Y("Tonyu.klass.ensureNamespace(%s,%l);%n",R.replace(/\.$/,""),n.namespace),n.superClass?Y("%s=Tonyu.klass(%s,[%s],{%{",F(n),F(n.superClass),C(n.includes).join(",")):Y("%s=Tonyu.klass([%s],{%{",F(n),C(n.includes).join(","));for(var e in _){V&&console.log("method1",e);var t=_[e];B.enter({noWait:!0,threadAvail:!1},function(){H(t)}),V&&console.log("method2",e),t.nowait||B.enter({noWait:!1,threadAvail:!0},function(){L(t)}),V&&console.log("method3",e)}Y("__dummy: false%n"),Y("%}});%n")}),Y("Tonyu.klass.addMeta(%s,%s);%n",F(n),JSON.stringify(W(n)))}function W(n){var e={fullName:n.fullName,namespace:n.namespace,shortName:n.shortName,decls:{methods:{}}};for(var t in n.decls.methods)e.decls.methods[t]={nowait:!!n.decls.methods[t].nowait};return e}function L(n){function a(){B.enter({method:n,noWait:!0,threadAvail:!0},function(){o.forEach(function(n){Y("%v%n",n)})})}function i(){B.enter({method:n,finfo:n,pc:1},function(){s.forEach(function(n){Y("%v%n",n)})})}if(!G(n)){var r=n.stmts,o=[],s=[],l=o,f=!0;f?r.forEach(function(n){k(n).fiberCallRequired&&(l=s),l.push(n)}):s=r,Y("%s%s :function %s(%j) {%{var %s=%s;%n%svar %s=%s;%nvar %s=0;%n%f%n%f%n",u,n.name,O(n.pos),[",",[ae].concat(n.params)],t,A,n.useArgs?"":"//",c,"Tonyu.A(arguments)",p,M(n),a),s.length>0?Y("%s.enter(function %s(%s) {%{if (%s.lastEx) %s=%s.catchPC;%nfor(var %s=%d ; %s--;) {%{switch (%s) {%{%}case 0:%{%f%s.exit(%s);return;%n%}}%n%}}%n%}});%n",e,O(n.pos),e,e,p,e,d,h,d,p,i,e,t):Y("%s.retVal=%s;return;%n",e,t),Y("%}},%n")}}function H(n){function e(){B.enter({method:n,finfo:n},function(){n.stmts.forEach(function(n){Y("%v%n",n)})})}var a=G(n)?"initialize":n.name;Y("%s :function %s(%j) {%{var %s=%s;%n%f%n%f%}},%n",a,O(n.pos),[",",n.params],t,A,M(n),e)}function K(n){function e(){B.enter({noWait:!0,threadAvail:!1,finfo:t},function(){n.body.stmts.forEach(function(n){Y("%v%n",n)})})}var t=k(n);q.printf("function (%j) {%{%f%n%f%}}",[",",t.params],M(t),e)}function O(e){return"_trc_func_"+Z.add(n,e)+"_"+ee++}function z(n){function e(){B.enter({noWait:!0,threadAvail:!1,finfo:t},function(){n.body.stmts.forEach(function(n){Y("%v%n",n)})})}var t=k(n);q.printf("function %s(%j) {%{%f%n%f%}}",t.name,[",",t.params],M(t),e)}function M(n){function e(){B.enter({},function(){for(var e in n.locals.varDecls)q.printf("var %s;%n",e);for(var e in n.locals.subFuncDecls)z(n.locals.subFuncDecls[e])})}return e}function G(n){return J.match(n,{ftype:"constructor"})||J.match(n,{name:"new"})}var D=n.src.tonyu,q=r(),Y=q.printf,B=o(),V=!1,J=a,Z=l.traceTbl,$=n.decls,_=($.fields,$.methods),ne=($.natives,w),ee=0,te=l.options.compiler.diagnose,ae={type:"THNode"};v=q.visitor=s({THNode:function(){q.printf(e)},dummy:function(n){q.printf("",n)},literal:function(n){q.printf("%s",n.text)},paramDecl:function(n){q.printf("%v",n.name)},paramDecls:function(n){q.printf("(%j)",[", ",n.params])},funcDeclHead:function(n){q.printf("function %v %v",n.name,n.params)},funcDecl:function(){},"return":function(n){if(B.inTry)throw i("現実装では、tryの中にreturnは書けません",D,n.pos);B.noWait?B.threadAvail?n.value?q.printf("%s.retVal=%v;return;%n",e,n.value):q.printf("%s.retVal=%s;return;%n",e,t):n.value?q.printf("return %v;",n.value):q.printf("return %s;",t):n.value?q.printf("%s.exit(%v);return;",e,n.value):q.printf("%s.exit(%s);return;",e,t)},program:function(n){genClass(n.stmts)},number:function(n){q.printf("%s",n.value)},reservedConst:function(n){"this"==n.text?q.printf("%s",t):"arguments"==n.text&&B.threadAvail?q.printf("%s",c):n.text==e?q.printf("%s",B.threadAvail?e:"null"):q.printf("%s",n.text)},varDecl:function(n){n.value?q.printf("%v = %v",n.name,n.value):q.printf("%v",n.name)},varsDecl:function(n){N(n)(),q.printf("%j;",[";",n.decls])},jsonElem:function(n){n.value?q.printf("%v: %v",n.key,n.value):q.printf("%v: %f",n.key,function(){P(n.key.text,k(n).scopeInfo,k(n))})},objlit:function(n){q.printf("{%j}",[",",n.elems])},arylit:function(n){q.printf("[%j]",[",",n.elems])},funcExpr:function(n){K(n)},parenExpr:function(n){q.printf("(%v)",n.expr)},varAccess:function(n){{var e=n.name.text;P(e,k(n).scopeInfo,k(n))}},exprstmt:function(a){var i={};if(N(a)(),B.noWait||(i=k(a).fiberCall||{}),"noRet"==i.type)q.printf("%s.%s%s(%j);%n%s=%s;return;%n%}case %d:%{",t,u,i.N,[", ",[ae].concat(i.A)],p,B.pc,B.pc++);else if("ret"==i.type)q.printf("%s.%s%s(%j);%n%s=%s;return;%n%}case %d:%{%v%v%s.retVal;%n",t,u,i.N,[", ",[ae].concat(i.A)],p,B.pc,B.pc++,i.L,i.O,e);else if("noRetSuper"==i.type){var r=F(n.superClass);q.printf("%s.prototype.%s%s.apply( %s, [%j]);%n%s=%s;return;%n%}case %d:%{",r,u,i.S.name.text,t,[", ",[ae].concat(i.A)],p,B.pc,B.pc++)}else"retSuper"==i.type?q.printf("%s.prototype.%s%s.apply( %s, [%j]);%n%s=%s;return;%n%}case %d:%{%v%v%s.retVal;%n",r,u,i.S.name.text,t,[", ",[ae].concat(i.A)],p,B.pc,B.pc++,i.L,i.O,e):q.printf("%v;",a.expr)},infix:function(n){var e=n.op.text;if(te){if("+"==e||"-"==e||"*"==e||"/"==e||"%"==e)return void q.printf("%s(%v,%l)%v%s(%v,%l)",m,n.left,T(n.left),n.op,m,n.right,T(n.right));if("+="==e||"-="==e||"*="==e||"/="==e||"%="==e)return void q.printf("%v%v%s(%v,%l)",n.left,n.op,m,n.right,T(n.right))}q.printf("%v%v%v",n.left,n.op,n.right)},trifixr:function(n){q.printf("%v%v%v%v%v",n.left,n.op1,n.mid,n.op2,n.right)},prefix:function(n){q.printf("%v %v",n.op,n.right)},postfix:function(n){var e=k(n);if(te){if(e.myMethodCall){var a=e.myMethodCall,i=a.scopeInfo,r=E(i);return void(r==ne.FIELD||r==ne.METHOD?q.printf("%s(%s, %l, [%j], %l )",y,t,a.name,[",",a.args],"this"):q.printf("%s(%v, [%j], %l)",g,n.left,[",",a.args],T(n.left)))}if(e.othersMethodCall){var o=e.othersMethodCall;return void q.printf("%s(%v, %l, [%j], %l )",y,o.target,o.name,[",",o.args],T(o.target))}if(e.memberAccess){var s=e.memberAccess;return void q.printf("%s(%v,%l).%s",m,s.target,T(s.target),s.name)}}else if(e.myMethodCall){var a=e.myMethodCall,i=a.scopeInfo,r=E(i);if(r==ne.METHOD)return void q.printf("%s.%s(%j)",t,a.name,[",",a.args])}q.printf("%v%v",n.left,n.op)},"break":function(n){if(B.noWait)q.printf("break;%n");else{if(B.inTry&&B.exitTryOnJump)throw i("現実装では、tryの中にbreak;は書けません",D,n.pos);if(!B.closestBrk)throw i("break； は繰り返しの中で使います",D,n.pos);q.printf("%s=%z; break;%n",p,B.closestBrk)}},"try":function(n){var t=k(n);if(!B.noWait&&(t.fiberCallRequired||t.hasJump||t.hasReturn)){if(1!=n.catches.length||"catch"!=n.catches[0].type)throw i("現実装では、catch節1個のみをサポートしています",D,n.pos);var a=n.catches[0],r={},o={};q.printf("%s.enterTry(%z);%n",e,r),q.printf("%f",S({inTry:!0,exitTryOnJump:!0},n.stmt)),q.printf("%s.exitTry();%n",e),q.printf("%s=%z;break;%n",p,o),q.printf("%}case %f:%{",function(){q.print(r.put(B.pc++))}),q.printf("%s=%s.startCatch();%n",a.name.text,e),q.printf("%s.exitTry();%n",e),q.printf("%v%n",a.stmt),q.printf("%}case %f:%{",function(){q.print(o.put(B.pc++))})}else B.enter({noWait:!0},function(){q.printf("try {%{%f%n%}} ",Q(n.stmt)),n.catches.forEach(v.visit)})},"catch":function(n){q.printf("catch (%s) {%{%f%n%}}",n.name.text,Q(n.stmt))},"throw":function(n){q.printf("throw %v;%n",n.ex)},"while":function(n){N(n)();var e=k(n);if(B.noWait||!e.fiberCallRequired&&!e.hasReturn)B.enter({noWait:!0},function(){q.printf("while (%v) {%{%f%n%}}",n.cond,Q(n.loop))});else{var t=q.lazy(),a=B.pc++,i="reservedConst"==n.cond.type&&"true"==n.cond.text;q.printf("%}case %d:%{"+(i?"%D%D%D":"if (!(%v)) { %s=%z; break; }%n")+"%f%n%s=%s;break;%n%}case %f:%{",a,n.cond,p,t,S({closestBrk:t,exitTryOnJump:!1},n.loop),p,a,function(){q.print(t.put(B.pc++))})}},"for":function(n){function e(n,e,t){return function(){t.forEach(function(e,t){q.printf("%s=%s[%s];%n",e.text,n,t)})}}N(n)();var t=k(n);if("forin"==n.inFor.type){var a=k(n.inFor).iterName;if(B.noWait||!t.fiberCallRequired&&!t.hasReturn)B.enter({noWait:!0},function(){q.printf("%s=%s(%v,%s);%nwhile(%s.next()) {%{%f%n%f%n%}}",a,I,n.inFor.set,n.inFor.vars.length,a,e(a,n.inFor.isVar,n.inFor.vars),Q(n.loop))});else{var i=q.lazy(),r=B.pc++;q.printf("%s=%s(%v,%s);%n%}case %d:%{if (!(%s.next())) { %s=%z; break; }%n%f%n%f%n%s=%s;break;%n%}case %f:%{",a,I,n.inFor.set,n.inFor.vars.length,r,a,p,i,e(a,n.inFor.isVar,n.inFor.vars),S({closestBrk:i,exitTryOnJump:!1},n.loop),p,r,function(n){n.print(i.put(B.pc++))})}}else if(B.noWait||!t.fiberCallRequired&&!t.hasReturn)B.enter({noWait:!0},function(){q.printf("%v%nwhile(%v) {%{%v%n%v;%n%}}",n.inFor.init,n.inFor.cond,n.loop,n.inFor.next)});else{var i=q.lazy(),r=B.pc++;q.printf("%v;%n%}case %d:%{if (!(%v)) { %s=%z; break; }%n%f%n%v;%n%s=%s;break;%n%}case %f:%{",n.inFor.init,r,n.inFor.cond,p,i,S({closestBrk:i,exitTryOnJump:!1},n.loop),n.inFor.next,p,r,function(n){n.print(i.put(B.pc++))})}},"if":function(n){N(n)();var e=k(n);if(!B.noWait&&(e.fiberCallRequired||e.hasJump||e.hasReturn)){var t={},a={};n._else?q.printf("if (!(%v)) { %s=%z; break; }%n%v%n%s=%z;break;%n%}case %f:%{%v%n%}case %f:%{",n.cond,p,a,n.then,p,t,function(){q.print(a.put(B.pc++))},n._else,function(){q.print(t.put(B.pc++))}):q.printf("if (!(%v)) { %s=%z; break; }%n%v%n%}case %f:%{",n.cond,p,t,n.then,function(){q.print(t.put(B.pc++))})}else B.enter({noWait:!0},function(){n._else?q.printf("if (%v) {%{%f%n%}} else {%{%f%n%}}",n.cond,Q(n.then),Q(n._else)):q.printf("if (%v) {%{%f%n%}}",n.cond,Q(n.then))})},ifWait:function(n){B.noWait?n._else&&q.printf("%v",n._else):q.printf("%v",n.then)},call:function(n){q.printf("(%j)",[",",n.args])},objlitArg:function(n){q.printf("%v",n.obj)},argList:function(n){q.printf("%j",[",",n.args])},newExpr:function(n){var e=n.params;e?q.printf("new %v%v",n.klass,e):q.printf("new %v",n.klass)},scall:function(n){q.printf("[%j]",[",",n.args])},superExpr:function(e){var a;e.name?(a=e.name.text,q.printf("%s.prototype.%s.apply( %s, %v)",F(n.superClass),a,t,e.params)):q.printf("%s.apply( %s, %v)",F(n.superClass),t,e.params)},arrayElem:function(n){q.printf("[%v]",n.subscript)},member:function(n){q.printf(".%v",n.name)},symbol:function(n){q.print(n.text)},normalFor:function(n){q.printf("%v; %v; %v",n.init,n.cond,n.next)},compound:function(n){var e=k(n);!B.noWait&&(e.fiberCallRequired||e.hasJump||e.hasReturn)?q.printf("%j",["%n",n.stmts]):B.enter({noWait:!0},function(){q.printf("{%{%j%n%}}",["%n",n.stmts])})},"typeof":function(){q.printf("typeof ")},"instanceof":function(){q.printf(" instanceof ")},is:function(){q.printf(" instanceof ")},regex:function(n){q.printf("%s",n.text)}});var ie=["++","--","!==","===","+=","-=","*=","/=","%=",">=","<=","!=","==",">>","<<","&&","||",">","<","+","?","=","*","%","/","^","~","\\",":",";",",","!","&","|","-","delete"];return ie.forEach(function(n){v.funcs[n]=function(){q.printf("%s",n)}}),v.def=function(n){throw console.log("Err node="),console.log(n),n.type+" is not defined in visitor:compiler2"},v.cnt=0,j(),n.src.js=q.buf,V&&console.log("method4",q.buf),q.buf}{var e="_thread",t="_this",c="_arguments",u="fiber$",p="__pc",f="$LASTPOS",d="__cnt",h=100,x="Tonyu.bindFunc",y="Tonyu.invokeMethod",g="Tonyu.callFunc",m="Tonyu.checkNonNull",R="Tonyu.classes.",b="Tonyu.globals.",A="this.isTonyuObject?this:Tonyu.not_a_tonyu_object(this)",I="Tonyu.iterator",w=l.ScopeTypes,E=l.getScopeType,U=l.annotation,T=l.getSource;l.getMethod,l.getDependingClasses,l.getParams}return{genJS:n}}()}),requireSimulator.setName("Tonyu.Project"),define(["Tonyu","TError","FS","Tonyu.TraceTbl","ImageList","StackTrace","typeCheck","Blob","thumbnail","WebSite","plugins","Tonyu.Compiler.Semantics","Tonyu.Compiler.JSGenerator"],function(Tonyu,TError,FS,Tonyu_TraceTbl,ImageList,StackTrace,tc,Blob,thumbnail,WebSite,plugins,Semantics,JSGenerator){return Tonyu.Project=function(dir,kernelDir){function orderByInheritance(n){var e={},t=[],a=0;for(var i in n)e[i]=!1,a++;for(;t.length<a;){var r=t.length;for(var i in n)if(!e[i]){var o=n[i],s=o.superClass,l=[s],c=!0;o.includes&&(l=l.concat(o.includes)),l.forEach(function(n){c=c&&(!n||n.builtin||e[n.fullName])}),c&&(t.push(o),e[i]=!0)}if(t.length==r)throw TError("クラスの循環参照があります","不明",0)}return t}var TPR={},home=FS.get(WebSite.tonyuHome);kernelDir||(kernelDir=home.rel("Kernel/"));var traceTbl=Tonyu.TraceTbl(),env={classes:{},traceTbl:traceTbl,options:{compiler:{}}};return TPR.EXT=".tonyu",TPR.NSP_KER="kernel",TPR.NSP_USR="user",TPR.env=env,TPR.dumpJS=function(n){function e(n){console.log("Class "+n+":\n"+env.classes[n].src.js)}if(n)e(n);else for(var n in env.classes)e(n)},TPR.stop=function(){var n=TPR.runningThread;n&&n.kill();var e=TPR.runningObj;e&&e.stop&&e.stop()},TPR.rawRun=function(n){TPR.compile(),TPR.runScriptMode||thumbnail.set(TPR,2e3),TPR.rawBoot(n)},TPR.compile=function(){console.log("Kernel editable",TPR.isKernelEditable()),TPR.isKernelEditable()?TPR.compileDir(TPR.NSP_KER,[dir,kernelDir]):(env.kernelClasses||TPR.compileKernel(),TPR.compileUser())},TPR.compileKernel=function(){TPR.compileDir(TPR.NSP_KER,[kernelDir]),env.kernelClasses=env.classes},TPR.compileUser=function(){TPR.compileDir(TPR.NSP_USR,[dir],env.kernelClasses)},TPR.compileDir=function(nsp,dirs,baseClasses){function collect(n){if(n.endsWith(TPR.EXT)){var e=n.truncExt(TPR.EXT),t=nsp+"."+e;env.classes[t]={name:e,fullName:t,shortName:e,namespace:nsp,src:{tonyu:n}},env.aliases[e]=t,delete skip[t]}}TPR.getOptions(),Tonyu.runMode=!1,env.classes=Tonyu.extend({},baseClasses||{}),env.aliases={};for(var n in env.classes){var cl=env.classes[n];env.aliases[cl.shortName]=cl.fullName}var skip=Tonyu.extend({},baseClasses||{});Tonyu.currentProject=TPR,Tonyu.globals.$currentProject=TPR;for(var i=dirs.length-1;i>=0;i--)dirs[i].each(collect);for(var n in env.classes)skip[n]||(console.log("initClassDecl: "+n),Semantics.initClassDecls(env.classes[n],env));var ord=orderByInheritance(env.classes);ord.forEach(function(n){skip[n.fullName]||(console.log("annotate :"+n.fullName),Semantics.annotate(n,env))}),ord.forEach(function(c){if(!skip[c.fullName]){console.log("genJS :"+c.fullName),JSGenerator.genJS(c,env);try{eval(c.src.js)}catch(e){throw console.log(c.src.js),e}}})},TPR.getResource=function(){var n=dir.rel("res.json");return n.exists()?n.obj():Tonyu.defaultResource},TPR.setResource=function(n){var e=dir.rel("res.json");e.obj(n)},TPR.getThumbnail=function(){return thumbnail.get(TPR)},TPR.convertBlobInfos=function(n){function e(t){if("object"==typeof t)for(var i in t)if(t.hasOwnProperty(i)){var r=t[i];if("url"==i){var o;(o=Blob.isBlobURL(r))&&(t[i]=[Blob.BLOB_PATH_EXPR,n,a,o.fileName].join("/"))}e(r)}}var t=TPR.getResource(),a=TPR.getName();e(t),TPR.setResource(t)},TPR.getBlobInfos=function(){function n(e){if("object"==typeof e)for(var a in e)if(e.hasOwnProperty(a)){var i=e[a];if("url"==a){var r;(r=Blob.isBlobURL(i))&&t.push(r)}n(i)}}var e=TPR.getResource(),t=[];return n(e),t},TPR.loadResource=function(n){var e=TPR.getResource();ImageList(e.images,function(e){var t=Tonyu.getGlobal("$Sprites");t&&t.setImageList(e);for(var a in e.names)Tonyu.setGlobal(a,e.names[a]);n&&n()})},TPR.getOptions=function(){env.options=null;var n=dir.rel("options.json");return n.exists()&&(env.options=n.obj()),env.options&&!env.options.run&&(env.options=null),env.options||(env.options=Tonyu.defaultOptions),TPR.fixOptions(env.options),env.options},TPR.fixOptions=function(n){n.compiler||(n.compiler={}),n.compiler.commentLastPos=TPR.runScriptMode||StackTrace.isAvailable(),n.run.mainClass=TPR.fixClassName(n.run.mainClass),n.run.bootClass=TPR.fixClassName(n.run.bootClass),n.plugins||(n.plugins={},dir.each(function(e){e.endsWith(TPR.EXT)&&plugins.detectNeeded(e.text(),n.plugins)}))},TPR.requestPlugin=function(n){if(!plugins.loaded(n)){var e=TPR.getOptions();e.plugins[n]=1,TPR.setOptions(e);var t=new Error("必要なプラグイン"+n+"を追加しました。もう一度実行してください");throw t.pluginName=n,t}},TPR.loadPlugins=function(n){var e=TPR.getOptions();plugins.loadAll(e.plugins,n)},TPR.fixClassName=function(n){if(TPR.classExists(n))return n;var e,t=n.split("."),a=t.pop();return e=TPR.NSP_USR+"."+a,TPR.classExists(e)?e:(e=TPR.NSP_KER+"."+a,TPR.classExists(e)?e:n)},TPR.classExists=function(n){var e=n.split(".");if(1==e.length)return!1;var t=e[0],a=e[1];if(TPR.isKernelEditable()){if(t==TPR.NSP_KER){if(dir.rel(a+TPR.EXT).exists())return!0;if(kernelDir.rel(a+TPR.EXT).exists())return!0}}else{if(t==TPR.NSP_KER&&kernelDir.rel(a+TPR.EXT).exists())return!0;if(t==TPR.NSP_USR&&dir.rel(a+TPR.EXT).exists())return!0}return!1},TPR.setOptions=function(n){n&&(env.options=n);var e=dir.rel("options.json");e.obj(env.options)},TPR.rawBoot=function(n){var e=Tonyu.getClass(n);if(!e)throw TError(n+" というクラスはありません","不明",0);var t=new e,a=Tonyu.thread();a.apply(t,"main"),TPR.runningThread=a,TPR.runningObj=t,$LASTPOS=0,a.steps()},TPR.isKernel=function(n){var e=kernelDir.rel(n+TPR.EXT);return e.exists()?e:null},TPR.isKernelEditable=function(){return env.options.kernelEditable},TPR.getDir=function(){return dir},TPR.getName=function(){return dir.name().replace(/\/$/,"")},TPR.renameClassName=function(n,e){TPR.compile();var t=TPR.env.classes;for(var a in t){var i=t[a],r=i.src.tonyu,o=i.annotation,s=[];if(o&&r){for(var l in o)try{var c=o[l],u=c.scopeInfo;if(u&&"class"==u.type&&u.name==n){var p=c.node.pos,f=c.node.len,d=r.text().substring(p,p+f);d==n&&(s.push({pos:p,len:f}),console.log(r.path(),p,f,r.text().substring(p-5,p+f+5),"->",e))}}catch(h){console.log(h)}s=s.sort(function(n,e){return e.pos-n.pos}),console.log(r.path(),s);var x=r.text(),y=x;s.forEach(function(n){x=x.substring(0,n.pos)+e+x.substring(n.pos+n.len)}),y==x||r.isReadOnly()||(console.log("Refact:",r.path(),x),r.text(x))}}},TPR}}),requireSimulator.setName("Shell"),define(["FS","Util","WebSite"],function(n,e,t){function a(n,e){var t=i(n);if(e&&!t.exists())throw t+": no such file or directory";return t}function i(t){if("string"!=typeof t)return t;if(e.startsWith(t,"/"))return n.get(t);var a=r.cwd;return a.rel(t)}var r={cwd:n.get("/")};return r.cd=function(n){return r.cwd=a(n,!0),r.pwd()},r.resolve=a,r.pwd=function(){return r.cwd+""},r.ls=function(n){return n=n?a(n,!0):r.cwd,n.ls()},r.cp=function(n,e,t){t||(t={}),t.v&&r.echo("cp",n,e);var i=a(n,!0),o=a(e);if(i.isDir()&&o.isDir()){var s=0;return i.recursive(function(n){var e=n.relPath(i),a=o.rel(e);(t.test||t.v)&&r.echo((a.exists()?"[ovr]":"[new]")+a+"<-"+n),t.test||a.copyFrom(n,t),s++}),s}if(i.isDir()||o.isDir()){if(!i.isDir()&&o.isDir())return o.rel(i.name()).text(i.text()),1;throw"Cannot copy directory "+i+" to file "+o}return o.text(i.text()),1},r.rm=function(n,e){if(e||(e={}),e.notrash)return n=a(n,!1),n.removeWithoutTrash(),1;if(n=a(n,!0),n.isDir()&&e.r){var t=n,i=0;return t.each(function(n){n.exists()&&(i+=r.rm(n,e))}),t.rm(),i+1}return n.rm(),1},r.cat=function(n){n=a(n,!0),r.echo(n.text())},r.resolve=function(n){return n||(n="."),n=a(n)},r.grep=function(n,e,t){function i(n,e,a){t.res&&t.res.push({file:n,lineNo:e,line:a}),r.echo(n+"("+e+"): "+a)}return e=a(e,!0),t||(t={}),t.res||(t.res=[]),e.isDir()?e.each(function(e){r.grep(n,e,t)}):"string"==typeof n&&e.lines().forEach(function(t,a){t.indexOf(n)>=0&&i(e,a+1,t)}),t.res},r.touch=function(n){return n=a(n),n.text(n.exists()?n.text():""),1},r.setout=function(n){r.outUI=n},r.echo=function(){console.log.apply(console,arguments),r.outUI&&r.outUI.log&&r.outUI.log.apply(r.outUI,arguments)},r.err=function(){console.log.apply(console,arguments),r.outUI&&r.outUI.err&&r.outUI.err.apply(r.outUI,arguments)},r.prompt=function(){},r.ASYNC={r:"SH_ASYNC"},r.help=function(){for(var n in r){var e=r[n];"function"==typeof e&&r.echo(n+(e.description?" - "+e.description:""))}},sh=r,t.isNW&&(sh.devtool=function(){require("nw.gui").Window.get().showDevTools()}),r}),requireSimulator.setName("copySample"),define(["Shell","FS","WebSite"],function(n,e,t){function a(){s.exists()&&s.ls().forEach(r)}function i(n){var e=n.name();return s.rel(e).exists()&&l.equals(n.up())}function r(e){if(!e)return a();var t=s.rel(e),i=l.rel(e);t.exists()&&!i.exists()&&n.cp(t,i)}var o=FS.get(t.tonyuHome),s=o.rel("SampleROM/"),l=o.rel("Projects/");return r.available=i,r.all=a,r}),requireSimulator.setName("Shell2"),define(["Shell","UI","FS","Util"],function(n,e,t,a){var i={};return i.show=function(n){var e=i.embed(n);e.dialog({width:600,height:500})},i.embed=function(){i.d||(i.d=e("div",{title:"Shell"},["div",{$var:"inner"},"Type 'help' to show commands.",["br"]]),i.inner=i.d.$vars.inner,n.prompt());var t=i.d;return t},n.cls=function(){i.d.$vars.inner.empty()},n.prompt=function(){function t(n){return 9==n.which?(n.stopPropagation(),n.preventDefault(),o(),!1):void(13==n.which&&(u.empty(),r(l.val())))}function r(){var t=l.val().replace(/^ */,"").replace(/ *$/,"");if(0!=t.length){var a=t.split(/ +/),i=a.shift(),r=n[i];if("function"!=typeof r)return c.append(i+": command not found.");try{var o=[],s=null;a.forEach(function(n){var e=/^-([A-Za-z_0-9]+)(=(.*))?/.exec(n);e?(s||(s={}),s[e[1]]=null!=e[3]?e[3]:1):o.push(n)}),s&&o.push(s);var u=r.apply(n,o);if(u===n.ASYNC)return;if("object"==typeof u)if(u instanceof Array){var p=e("table"),f=null,d=0;u.forEach(function(n){f||(f=e("tr").appendTo(p)),f.append(e("td",n)),d++,d%3==0&&(f=null)}),p.appendTo(c)}else c.append(JSON.stringify(u));else c.append(u);n.prompt()}catch(h){n.err(h),n.prompt()}}}function o(){var e=l.val(),t=e.split(" "),i=t.pop(),r=[];if(0==t.length)for(var o in n)"function"==typeof n[o]&&a.startsWith(o,i)&&r.push(o);else{var s=n.resolve(i,!1);if(!s)return;var c=s.isDir()?s:s.up();c.each(function(n){a.startsWith(n.path(),s.path())&&r.push(n.name())})}if(1==r.length){var p=i.split("/");p.pop(),p.push(r[0]),t.push(p.join("/")),l.val(t.join(" ")),u.empty()}else u.text(r.join(", "))}var s=e("div",["input",{$var:"cmd",size:40,on:{keydown:t}}],["pre",{$var:"out","class":"shell out"},["div",{$var:"cand","class":"shell cand"}]]),l=s.$vars.cmd,c=s.$vars.out,u=s.$vars.cand;return n.setout({log:function(){for(var n=[],e=0;e<arguments.length;e++)n.push(arguments[e]);c.append(n.join(" ")+"\n")},err:function(n){c.append(e("div",{"class":"shell error"},n,["br"],["pre",n.stack]))}}),s.appendTo(i.inner),l.focus(),i.inner.closest(".ui-dialog-content").scrollTop(i.inner.height()),n.ASYNC},n.window=function(){i.show(n.cwd)},n.atest=function(n,e,t){console.log(n,e,t)},i}),requireSimulator.setName("ImageDetailEditor"),define(["UI","ImageList","ImageRect","PatternParser"],function(n,e,t){function a(e){return n("input",{type:"radio",name:"type",value:e})}function i(){E&&(E.url=P.url.val())}function r(){P.theForm[0].type.value="rc"}function o(){P.theForm[0].type.value="wh"}function s(){var n=P.cv[0].getContext("2d"),e=k;e&&U&&(n.clearRect(e.left,e.top,e.width,e.height),n.drawImage(U,0,0,b,A,e.left,e.top,e.width,e.height),l())}function l(){var n=e.parse1(E,U,{boundsInSrc:!0});console.log("drawFrame",n);var t=P.cv[0].getContext("2d");n.forEach(function(n){d(t,u(n))}),F=n}function c(n,e){return e.left<=n.x&&n.x<=e.left+e.width&&e.top<=n.y&&n.y<=e.top+e.height}function u(n){var e={},t=k.width/b,a=k.height/A;return e.left=k.left+n.x*t,e.top=k.top+n.y*a,e.width=n.width*t,e.height=n.height*a,e}function p(n){var e=P.cv[0].getContext("2d"),t=P.cv.offset(),a={x:n.pageX-t.left,y:n.pageY-t.top};return F?void F.forEach(function(n,t){var i=u(n);if(c(a,i)){var r=F[X];if(r){var o=u(r);d(e,o)}X=t,d(e,i,"#ff0")}}):void console.log("cvMouse")}function f(){var n=F[X];n&&P.patName.val(C+"+"+X)}function d(n,e,t){n.strokeStyle=t||"#f0f",n.beginPath(),n.moveTo(e.left,e.top),n.lineTo(e.left+e.width,e.top),n.lineTo(e.left+e.width,e.top+e.height),n.lineTo(e.left,e.top+e.height),n.closePath(),n.stroke()}function h(n,e){return n===n?n:e}function x(){return"rc"!=P.theForm[0].type.value?!1:E?(w=h(parseInt(P.cols.val()),w),I=h(parseInt(P.rows.val()),I),y(),s(),!1):!1}function y(){return E?(E.pwidth=h(Math.floor(b/w),E.pwidth),E.pheight=h(Math.floor(A/I),E.pheight),P.pwidth.val(E.pwidth),void P.pheight.val(E.pheight)):!1}function g(){return"wh"!=P.theForm[0].type.value?!1:E?(E.pwidth=h(parseInt(P.pwidth.val()),E.pwidth),E.pheight=h(parseInt(P.pheight.val()),E.pheight),m(),s(),!1):!1}function m(){return E?(w=h(Math.floor(b/E.pwidth),w),I=h(Math.floor(A/E.pheight),I),P.rows.val(I),void P.cols.val(w)):!1}function v(){if(!E)return!1;delete E.pwidth,delete E.pheight,P.theForm[0].type.value="t1";try{s()}catch(n){alert(n)}return!1}function R(){return S.dialog("close"),T&&T(),!1}var b,A,I,w,E,U,T,k,F,C,S=n("div",{title:"画像詳細"},["div",["div","URL:",["input",{$var:"url",size:40,on:{change:i}}],["a",{$var:"openImg",target:"img"},"画像を確認..."]],["canvas",{$edit:"cv",width:500,height:250,on:{mousemove:p,mousedown:f}}]],["form",{$var:"theForm"},["div",a("rc"),"分割数指定：",["input",{$var:"cols",size:5,on:{realtimechange:x,focus:r}}],"x",["input",{$var:"rows",size:5,on:{realtimechange:x,focus:r}}]],["div",a("wh"),"1パターンの大きさ指定：",["input",{$var:"pwidth",size:5,on:{realtimechange:g,focus:o}}],"x",["input",{$var:"pheight",size:5,on:{realtimechange:g,focus:o}}]],["div",a("t1"),"Tonyu1互換",["button",{on:{click:v}},"解析"]],["div","パターン番号:",["input",{$var:"patName"}]],["button",{on:{click:R}},"OK"]]),P=S.$vars,Q={},X=-1;return Q.show=function(n,a,i,r){r||(r={}),T=r.onclose,E=n,C=i,S.dialog({width:600,height:520}),P.url.val(E.url);var o=e.convURL(E.url,a);P.openImg.attr("href",o),t(o,P.cv[0])(function(n){k=n,console.log(n),U=n.src,b=U.width,A=U.height,E.pwidth&&E.pheight?(P.pwidth.val(E.pwidth),P.pheight.val(E.pheight),m(),P.theForm[0].type.value="wh"):P.theForm[0].type.value="t1",l()})},Q}),requireSimulator.setName("ImageResEditor"),define(["FS","Tonyu","UI","ImageList","Blob","Auth","WebSite","ImageDetailEditor"],function(n,e,t,a,i,r,o,s){var l=function(n){function e(e){try{return a.convURL(e,n.getDir())}catch(t){return o.urlAliases["images/ecl.png"]}}function l(n){return"number"==typeof n.pwidth&&"number"==typeof n.pheight?n.pwidth==n.pheight?""+n.pwidth:n.pwidth+"x"+n.pheight:""}function c(n,e){e&&""!=e?e.match(/([0-9]+)x([0-9]+)/)?(n.pwidth=parseInt(RegExp.$1),n.pheight=parseInt(RegExp.$2)):e.match(/([0-9]+)/)?(n.pwidth=parseInt(RegExp.$1),n.pheight=n.pwidth):(delete n.pwidth,delete n.pheight):(delete n.pwidth,delete n.pheight)}function u(){function a(e){eo=e.originalEvent;var a=eo.dataTransfer.files[0],s="GAE"==o.serverType&&a.size>3e5;if(!a.type.match(/image\/(png|gif|jpe?g)/)[1])return e.stopPropagation(),e.preventDefault(),!1;var l=a.name.replace(/\.(png|gif|jpe?g)$/,"").replace(/\W/g,"_"),c="";a.name.match(/\.(png|gif|jpe?g)$/)&&(c=RegExp.lastMatch);var u={pwidth:32,pheight:32,name:"$pat_"+l};if(s)r.assertLogin({showLoginLink:function(n){v.css("border","solid red 2px").empty().append(t("div","大きいイメージを追加するには，ログインが必要です：",["a",{href:n,target:"login",style:"color: blue;"},"ログインする"]))},success:function(e){v.text("アップロード中...");var t=n.getName();i.upload(e,t,a,{success:function(){v.text(m),u.url="${blobPath}/"+e+"/"+t+"/"+a.name,g(u)}})}});else{var p=new FileReader;p.onload=function(){var e=p.result,t=x.rel(l+c);t.text(e),u.url="ls:"+t.relPath(n.getDir()),g(u)},p.readAsDataURL(a)}return e.stopPropagation(),e.preventDefault(),!1}function c(n){n.stopPropagation(),n.preventDefault()}function f(a){function i(){var n=$(this).position();y.show().css({left:n.left+16,top:n.top})}function r(){y.hide()}function o(){s.show(a,n.getDir(),a.name,{onclose:function(){n.setResource(h),u()}})}function c(){var n=$(this).val();"t1"==n&&g.size.val(""),"full"==n&&(i.apply(this,[]),setTimeout(function(){var n=y.width(),e=y.height();
n&&e&&g.size.val(n+"x"+e),r()},100))}function f(){for(var n=R.length-1;n>=0;n--)if(R[n]===a){R.splice(n,1);break}p()}var d=!(!a.pwidth||!a.pheight),x=t("tr",["td",["img",{src:e(a.url),width:16,height:16,on:{click:o,mouseenter:i,mouseout:r}}]],["td",["input",{$var:"name",size:12,value:a.name}]],["td",["input",{$var:"url",size:20,value:a.url}]],["td",["select",{$var:"ptype",on:{change:c}},["option",{value:"fix",selected:d},"固定サイズ分割"],["option",{value:"t1",selected:!d},"Tonyu1互換"],["option",{value:"full",selected:!1},"分割なし"]],["input",{$var:"size",size:6,value:l(a)}]],["td",["button",{on:{click:f}},"削除"]]),y=t("div",{style:"position:absolute; background: rgba(255,255,200,1);"},"画像をクリックして詳細設定...").hide().appendTo(x),g=x.$vars;return g.mag=y,g.data=a,x}function g(n){R.push(n||{pwidth:32,pheight:32}),p()}d.empty();var m="ここに画像ファイル(png/gif/jpg)をドラッグ＆ドロップして追加",v=t("div",{style:"margin:10px; padding:10px; border:solid blue 2px;",on:{dragover:c,dragenter:c,drop:a}},m).appendTo(d);h=n.getResource();var R=h.images;y=[];var b=t("table",["tr",["th"],["th","名前"],["th","URL"],["th","1個の大きさ"],["th",""]]).appendTo(d);R.forEach(function(n){var e=f(n);y.push(e),e.appendTo(b)}),d.append(t("button",{on:{click:function(){g()}}},"追加")),d.append(t("button",{on:{click:function(){d.dialog("close")}}},"完了"))}function p(){y.forEach(function(n){var e=n.$vars,t=e.data;t.name=e.name.val(),t.url=e.url.val(),"t1"==e.ptype.val()?c(t,""):c(t,e.size.val())}),console.log(h),n.setResource(h),u()}function f(){var e=h.images;r.currentUser(function(t,a){if(t){var r=[];e.forEach(function(n){var e;(e=i.isBlobURL(n.url))&&r.push(e.fileName)}),$.ajax({url:o.serverTop+"/retainBlobs",type:"get",data:{user:t,project:n.getName(),csrfToken:a,retainFileNames:JSON.stringify(r)}})}});var t={};x.each(function(e){t["ls:"+e.relPath(n.getDir())]=e}),h=n.getResource(),e.forEach(function(n){delete t[n.url]}),console.log(t);for(var a in t){var s=t[a];console.log(s+" is removed"),s.rm()}}var d=t("div",{title:"画像リスト"});d.css({height:"200px","overflow-v":"scroll"});var h=n.getResource(),x=n.getDir().rel("images/"),y=[];h||n.setResource(),u(),d.dialog({modal:!0,width:700,height:400,close:function(){p(),f()}})};return l}),requireSimulator.setName("ProjectOptionsEditor"),define(["UI"],function(n){return function(e){var t=e.getOptions();e.odiag||(e.odiag=n("div",{title:"プロジェクト オプション"},["h5","コンパイラ"],["div",["input",{type:"checkbox",$edit:"compiler.diagnose"}],"診断モード(速度が落ちますが，プログラムの不具合を見つけやすくします)"],["div","デフォルトの親クラス",["input",{$edit:"compiler.defaultSuperClass"}]],["h5","実行"],["div","Main クラス",["input",{$edit:"run.mainClass"}]],["div","Boot クラス",["input",{$edit:"run.bootClass"}]],["h5","開発"],["div",["input",{type:"checkbox",$edit:"kernelEditable"}],"Kernelの開発を行う"],["div",{$var:"validationMessage",css:{color:"red"}}])),e.odiag.$edits.load(t),e.odiag.dialog({width:600,buttons:{OK:function(){e.odiag.dialog("close"),e.setOptions()}}})}}),requireSimulator.setName("copyToKernel"),requirejs(["Shell","FS","WebSite"],function(n,e,t){n.copyToKernel=function(a){var i=e.get(t.tonyuHome),r=i.rel("Kernel/");if(a)return n.cp(a,r.rel(a));var o=0;return r.each(function(e){var t=n.cwd.rel(e.name());t.exists()&&(o+=n.cp(t,r))}),o}}),requireSimulator.setName("KeyEventChecker"),define([],function(){var n={};return n.down=function(e,t,a){e instanceof $||(e=$(e)),e.bind("keydown",function(i){return n.is(i,t)?a.call(e[0],i):void 0})},n.is=function(n,e){e=e.toLowerCase(),n=n.originalEvent||n;var t="";return n.altKey&&(t+="alt+"),n.ctrlKey&&(t+="ctrl+"),n.shiftKey&&(t+="shift+"),t+=n.keyCode>=112&&n.keyCode<=123?"f"+(n.keyCode-111):String.fromCharCode(n.keyCode),t=t.toLowerCase(),e==t},n}),requireSimulator.setName("WikiDialog"),define(["Wiki"],function(n){var e={};return e.create=function(e,t){t=t||{title:"help",topPage:"index"};var a=$("<div>").attr({title:t.title}),i=n(a,e,t);return t.topPage&&i.show(t.topPage),t.height||(t.height=.7*$(window).height()),t.width||(t.width=500),{show:function(n){n&&i.show(n),a.dialog({width:t.width,height:t.height})}}},e}),requireSimulator.setName("TextRect"),TextRect=function(){function n(n,t,a,i,r,o,s){o||(o="center"),n.textBaseline="top",e(n,r);var l=n.measureText(t),c={y:i,w:l.width,h:r};switch(o.substring(0,1).toLowerCase()){case"l":c.x=a;break;case"r":c.x=a-l.width;break;case"c":c.x=a-l.width/2}return"fill"==s&&n.fillText(t,c.x,i),"stroke"==s&&n.strokeText(t,c.x,i),c}function e(n,e){var t=n.font.replace(/^[0-9\.]+/,"");n.font=e+t}return{draw:n,setFontSize:e}}(),requireSimulator.setName("fukidashi"),requireSimulator.setName("runtime"),requirejs(["ImageList","TextRect","fukidashi"],function(){}),requireSimulator.setName("difflib"),__whitespace={" ":!0,"	":!0,"\n":!0,"\f":!0,"\r":!0},difflib={defaultJunkFunction:function(n){return __whitespace.hasOwnProperty(n)},stripLinebreaks:function(n){return n.replace(/^[\n\r]*|[\n\r]*$/g,"")},stringAsLines:function(n){for(var e=n.indexOf("\n"),t=n.indexOf("\r"),a=e>-1&&t>-1||0>t?"\n":"\r",i=n.split(a),r=0;r<i.length;r++)i[r]=difflib.stripLinebreaks(i[r]);return i},__reduce:function(n,e,t){if(null!=t)var a=t,i=0;else{if(!e)return null;var a=e[0],i=1}for(;i<e.length;i++)a=n(a,e[i]);return a},__ntuplecomp:function(n,e){for(var t=Math.max(n.length,e.length),a=0;t>a;a++){if(n[a]<e[a])return-1;if(n[a]>e[a])return 1}return n.length==e.length?0:n.length<e.length?-1:1},__calculate_ratio:function(n,e){return e?2*n/e:1},__isindict:function(n){return function(e){return n.hasOwnProperty(e)}},__dictget:function(n,e,t){return n.hasOwnProperty(e)?n[e]:t},SequenceMatcher:function(n,e,t){this.set_seqs=function(n,e){this.set_seq1(n),this.set_seq2(e)},this.set_seq1=function(n){n!=this.a&&(this.a=n,this.matching_blocks=this.opcodes=null)},this.set_seq2=function(n){n!=this.b&&(this.b=n,this.matching_blocks=this.opcodes=this.fullbcount=null,this.__chain_b())},this.__chain_b=function(){for(var n=this.b,e=n.length,t=this.b2j={},a={},i=0;i<n.length;i++){var r=n[i];if(t.hasOwnProperty(r)){var o=t[r];e>=200&&100*o.length>e?(a[r]=1,delete t[r]):o.push(i)}else t[r]=[i]}for(var r in a)a.hasOwnProperty(r)&&delete t[r];var s=this.isjunk,l={};if(s){for(var r in a)a.hasOwnProperty(r)&&s(r)&&(l[r]=1,delete a[r]);for(var r in t)t.hasOwnProperty(r)&&s(r)&&(l[r]=1,delete t[r])}this.isbjunk=difflib.__isindict(l),this.isbpopular=difflib.__isindict(a)},this.find_longest_match=function(n,e,t,a){for(var i=this.a,r=this.b,o=this.b2j,s=this.isbjunk,l=n,c=t,u=0,p=null,f={},d=[],h=n;e>h;h++){var x={},y=difflib.__dictget(o,i[h],d);for(var g in y)if(y.hasOwnProperty(g)){if(p=y[g],t>p)continue;if(p>=a)break;x[p]=k=difflib.__dictget(f,p-1,0)+1,k>u&&(l=h-k+1,c=p-k+1,u=k)}f=x}for(;l>n&&c>t&&!s(r[c-1])&&i[l-1]==r[c-1];)l--,c--,u++;for(;e>l+u&&a>c+u&&!s(r[c+u])&&i[l+u]==r[c+u];)u++;for(;l>n&&c>t&&s(r[c-1])&&i[l-1]==r[c-1];)l--,c--,u++;for(;e>l+u&&a>c+u&&s(r[c+u])&&i[l+u]==r[c+u];)u++;return[l,c,u]},this.get_matching_blocks=function(){if(null!=this.matching_blocks)return this.matching_blocks;for(var n,e,t,a,i,r,o,s,l,c=this.a.length,u=this.b.length,p=[[0,c,0,u]],f=[];p.length;)i=p.pop(),n=i[0],e=i[1],t=i[2],a=i[3],l=this.find_longest_match(n,e,t,a),r=l[0],o=l[1],s=l[2],s&&(f.push(l),r>n&&o>t&&p.push([n,r,t,o]),e>r+s&&a>o+s&&p.push([r+s,e,o+s,a]));f.sort(difflib.__ntuplecomp);var d=j1=k1=block=0,h=[];for(var x in f)f.hasOwnProperty(x)&&(block=f[x],i2=block[0],j2=block[1],k2=block[2],d+k1==i2&&j1+k1==j2?k1+=k2:(k1&&h.push([d,j1,k1]),d=i2,j1=j2,k1=k2));return k1&&h.push([d,j1,k1]),h.push([c,u,0]),this.matching_blocks=h,this.matching_blocks},this.get_opcodes=function(){if(null!=this.opcodes)return this.opcodes;var n=0,e=0,t=[];this.opcodes=t;var a,i,r,o,s,l=this.get_matching_blocks();for(var c in l)l.hasOwnProperty(c)&&(a=l[c],i=a[0],r=a[1],o=a[2],s="",i>n&&r>e?s="replace":i>n?s="delete":r>e&&(s="insert"),s&&t.push([s,n,i,e,r]),n=i+o,e=r+o,o&&t.push(["equal",i,n,r,e]));return t},this.get_grouped_opcodes=function(n){n||(n=3);var e=this.get_opcodes();e||(e=[["equal",0,1,0,1]]);var t,a,i,r,o,s;"equal"==e[0][0]&&(t=e[0],a=t[0],i=t[1],r=t[2],o=t[3],s=t[4],e[0]=[a,Math.max(i,r-n),r,Math.max(o,s-n),s]),"equal"==e[e.length-1][0]&&(t=e[e.length-1],a=t[0],i=t[1],r=t[2],o=t[3],s=t[4],e[e.length-1]=[a,i,Math.min(r,i+n),o,Math.min(s,o+n)]);var l=n+n,c=[],u=[];for(var p in e)e.hasOwnProperty(p)&&(t=e[p],a=t[0],i=t[1],r=t[2],o=t[3],s=t[4],"equal"==a&&r-i>l&&(c.push([a,i,Math.min(r,i+n),o,Math.min(s,o+n)]),u.push(c),c=[],i=Math.max(i,r-n),o=Math.max(o,s-n)),c.push([a,i,r,o,s]));return!c||1==c.length&&"equal"==c[0][0]||u.push(c),u},this.ratio=function(){return matches=difflib.__reduce(function(n,e){return n+e[e.length-1]},this.get_matching_blocks(),0),difflib.__calculate_ratio(matches,this.a.length+this.b.length)},this.quick_ratio=function(){var n,e;if(null==this.fullbcount){this.fullbcount=n={};for(var t=0;t<this.b.length;t++)e=this.b[t],n[e]=difflib.__dictget(n,e,0)+1}n=this.fullbcount;for(var a={},i=difflib.__isindict(a),r=numb=0,t=0;t<this.a.length;t++)e=this.a[t],numb=i(e)?a[e]:difflib.__dictget(n,e,0),a[e]=numb-1,numb>0&&r++;return difflib.__calculate_ratio(r,this.a.length+this.b.length)},this.real_quick_ratio=function(){var n=this.a.length,e=this.b.length;return _calculate_ratio(Math.min(n,e),n+e)},this.isjunk=t?t:difflib.defaultJunkFunction,this.a=this.b=null,this.set_seqs(n,e)}},requireSimulator.setName("diffview"),diffview={buildView:function(n){function e(n,e){var t=document.createElement(n);return t.className=e,t}function t(n,e){var t=document.createElement(n);return t.appendChild(document.createTextNode(e)),t}function a(n,e,t){var a=document.createElement(n);return a.className=e,a.appendChild(document.createTextNode(t)),a}function i(n,i,r,o,s){return r>i?(n.appendChild(t("th",(i+1).toString())),n.appendChild(a("td",s,o[i].replace(/\t/g,"    "))),i+1):(n.appendChild(document.createElement("th")),n.appendChild(e("td","empty")),i)}function r(n,e,i,r,o){n.appendChild(t("th",null==e?"":(e+1).toString())),n.appendChild(t("th",null==i?"":(i+1).toString())),n.appendChild(a("td",o,r[null!=e?e:i].replace(/\t/g,"    ")))}var o=n.baseTextLines,s=n.newTextLines,l=n.opcodes,c=n.baseTextName?n.baseTextName:"Base Text",u=n.newTextName?n.newTextName:"New Text",p=n.contextSize,f=0==n.viewType||1==n.viewType?n.viewType:0;if(null==o)throw"Cannot build diff view; baseTextLines is not defined.";if(null==s)throw"Cannot build diff view; newTextLines is not defined.";if(!l)throw"Canno build diff view; opcodes is not defined.";var d=document.createElement("thead"),h=document.createElement("tr");d.appendChild(h),f?(h.appendChild(document.createElement("th")),h.appendChild(document.createElement("th")),h.appendChild(a("th","texttitle",c+" vs. "+u))):(h.appendChild(document.createElement("th")),h.appendChild(a("th","texttitle",c)),h.appendChild(document.createElement("th")),h.appendChild(a("th","texttitle",u))),d=[d];for(var x,y=[],g=0;g<l.length;g++){code=l[g],change=code[0];for(var m=code[1],v=code[2],R=code[3],b=code[4],A=Math.max(v-m,b-R),I=[],w=[],E=0;A>E;E++){if(p&&l.length>1&&(g>0&&E==p||0==g&&0==E)&&"equal"==change){var U=A-(0==g?1:2)*p;if(U>1){if(I.push(h=document.createElement("tr")),m+=U,R+=U,E+=U-1,h.appendChild(t("th","...")),f||h.appendChild(a("td","skip","")),h.appendChild(t("th","...")),h.appendChild(a("td","skip","")),g+1==l.length)break;continue}}I.push(h=document.createElement("tr")),f?"insert"==change?r(h,null,R++,s,change):"replace"==change?(w.push(x=document.createElement("tr")),v>m&&r(h,m++,null,o,"delete"),b>R&&r(x,null,R++,s,"insert")):"delete"==change?r(h,m++,null,o,change):r(h,m++,R++,o,change):(m=i(h,m,v,o,change),R=i(h,R,b,s,change))}for(var E=0;E<I.length;E++)y.push(I[E]);for(var E=0;E<w.length;E++)y.push(w[E])}y.push(h=a("th","author","diff view generated by ")),h.setAttribute("colspan",f?3:4),h.appendChild(x=t("a","jsdifflib")),x.setAttribute("href","http://github.com/cemerick/jsdifflib"),d.push(h=document.createElement("tbody"));for(var g in y)y.hasOwnProperty(g)&&h.appendChild(y[g]);h=e("table","diff"+(f?" inlinediff":""));for(var g in d)d.hasOwnProperty(g)&&h.appendChild(d[g]);return h}},requireSimulator.setName("DiffDialog"),define(["UI","difflib","diffview"],function(n,e,t){var a={};return a.show=function(n,e,t){var i=a.embed(n,e,t);i.dialog({width:600,height:500})},a.embed=function(i,r){function o(n){return n&&!n.isDir()&&n.exists()}if(!a.d){var s={fromVal:function(n){return""==n?null:FS.get(n)},toVal:function(n){return n?n.path():""}};a.d=n("div",{title:"比較"},["div",["input",{style:"background-color: #f88;",$edit:{name:"baseFile",type:s},size:60}],["br"],["input",{style:"background-color: #8f8;",$var:"newFile",$edit:{name:"newFile",type:s},size:60}]],["div",{$var:"validationMessage",css:{color:"red"}}],["button",{$var:"OKButton",on:{click:function(){a.done()}}},"比較"],["div",{$var:"diffoutput",css:{height:"350px",overflow:"scroll"}}])}var l=a.d,c={baseFile:i,newFile:r};return l.$edits.load(c),l.$edits.validator.on.validate=function(n){o(n.newFile)?o(n.baseFile)?this.allOK():this.addError("base",i+"は存在しないか，ディレクトリです"):this.addError("new",r+"は存在しないか，ディレクトリです")},a.done=function(){for(var n=e.stringAsLines(c.baseFile.text()),a=e.stringAsLines(c.newFile.text()),i=new e.SequenceMatcher(n,a),r=i.get_opcodes(),o=l.$vars.diffoutput[0];o.firstChild;)o.removeChild(o.firstChild);contextSize=null,o.appendChild(t.buildView({baseTextLines:n,newTextLines:a,opcodes:r,baseTextName:c.baseFile+"",newTextName:c.newFile+"",contextSize:contextSize,viewType:1}))},o(c.baseFile)&&o(c.newFile)&&a.done(),l},a}),requireSimulator.setName("KernelDiffDialog"),define(["UI","DiffDialog","Shell"],function(n,e){function t(n,t){return function(){e.show(n,t)}}var a={};return a.show=function(n,e,t){var i=a.embed(n,e,t);i.dialog({width:250,height:400})},a.embed=function(e,i){a.d||(a.d=n("div",{title:"Kernel比較"},["div",{$var:"out"}],["button",{$var:"OKButton",on:{click:function(){a.refresh()}}},"更新"]));var r=a.d;return a.refresh=function(){var a=r.$vars.out;a.empty(),i.each(function(r){var o=e.rel(r.relPath(i));r.endsWith(".tonyu")&&o.exists()&&a.append(r.text()==o.text()?n("div",r.name(),"(同一)"):n("div",["a",{href:"javascript:;",on:{click:t(o,r)}},r.name()]))})},a.refresh(),r},a}),requireSimulator.setName("requestFragment"),define(["WebSite"],function(n){var e={};return e.ajax=function(e){function t(n){return e.redirectTo&&(n.redirectTo=e.redirectTo),n}function a(){$.ajax({type:"post",url:n.top+"/edit/runFragments",data:t({id:s}),success:function(n){return"string"==typeof n&&n.match(/^notCompleted:([\-\d]+)\/([\-\d]+)$/)?(console.log("notcomp",n),u*=2,void setTimeout(a,u)):void e.success(n)},error:e.error,complete:e.complete})}var i=e.THRESH||8e5,r=e.data;if("object"!=typeof r)throw"Data should be object: "+r;if(r=JSON.stringify(r),!e.redirectTo&&("GAE"!=n.serverType||r.length<i))return $.ajax(e);for(var o=[],s=Math.random();r.length>0;)o.push(r.substring(0,i)),r=r.substring(i);var l=o.length,c=0,u=1e3;o.forEach(function(i,r){$.ajax({type:"post",url:n.top+"/edit/sendFragment",data:t({id:s,seq:r,len:l,content:i}),success:function(n){console.log("sendFrag",n,r),c++,c>=l&&setTimeout(a,u)},error:e.error})})},e}),requireSimulator.setName("Sync"),define(["FS","Shell","requestFragment","WebSite"],function(n,e,t,a){function i(n){return n&&n.isDir}var r={};return e.sync=function(){function n(n){return function(){n&&n.apply({},arguments),e.prompt()}}var t,a,o,s=function(){},l=0;return("string"==typeof arguments[l]||i(arguments[l]))&&(t=e.resolve(arguments[l],!0),l++,("string"==typeof arguments[l]||i(arguments[l]))&&(a=e.resolve(arguments[l],!1),l++)),"object"==typeof arguments[l]&&(o=arguments[l],l++),"function"==typeof arguments[l]&&(s=arguments[l],l++),t||(a=t=e.cwd),o&&o.onend&&(o.onend=n(o.onend)),a||(a=t),e.echo("sync args=",t,a,o,s),r.sync(t,a,o,n(s)),e.ASYNC},r.sync=function(){function n(n,t){e.echo("Status: "+n+" param:",t),d.onstatus&&d.onstatus(n,t)}function r(){d.onerror&&d.onerror.apply(this,arguments)}function o(){var e={base:f.path(),excludes:JSON.stringify(d.excludes)};n("getDirInfo",e),$.ajax({type:"get",url:a.top+"/edit/getDirInfo",data:e,success:s,error:r})}function s(t){t=JSON.parse(t),d.v&&e.echo("getDirInfo",t);var i=p,o=t.data;for(var s in o){var c=i.rel(s),h=c.metaInfo(),x=o[s];u(c,s,h,x)}p.recursive(function(n){var e=n.metaInfo(),t=n.relPath(p),a=o[t];u(n,t,e,a)},{includeTrashed:!0,excludes:d.excludes}),d.v&&(e.echo("uploads:",y),e.echo("downloads:",g));var m={base:f.path(),paths:JSON.stringify(g)};n("File2LSSync",m),$.ajax({type:"post",url:a.top+"/edit/File2LSSync",data:m,success:l,error:r})}function l(i){e.echo("dlData=",i),i=JSON.parse(i),d.v&&e.echo("dlData:",i);var o=p;if(!d.test){for(var s in i.data){var l=o.rel(s),u=i.data[s];u.trashed?l.exists()&&l.rm():l.text(u.text),delete u.text,l.metaInfo(u)}var h={base:f.path(),data:JSON.stringify(y)};h.pathInfo="/LS2FileSync",n("LS2FileSync",h),t.ajax({type:"post",url:a.top+"/edit/LS2FileSync",data:h,success:c,error:r})}}function c(n){d.v&&e.echo("LS2FileSync res=",n);var t=[];for(var a in y)t.push(a);n={msg:n,uploads:t,downloads:g},"function"==typeof h&&h(n)}function u(n,t,a,i){if(!m[t])if(m[t]=1,i&&(!a||a.lastUpdate<i.lastUpdate))g.push(t),d.v&&e.echo((a?"":"New")+"Download "+n+" trash="+!!i.trashed);else if(a&&(!i||a.lastUpdate>i.lastUpdate)){var r={text:n.text()},o=n.metaInfo();for(var s in o)r[s]=o[s];y[t]=r,d.v&&e.echo((i?"":"New")+"Upload "+n+" trash="+!!a.trashed)}}var p,f,d,h,x=0;if(i(arguments[x])&&(p=arguments[x],x++,i(arguments[x])&&(f=arguments[x],x++)),"object"==typeof arguments[x]&&(d=arguments[x],x++),"function"==typeof arguments[x]&&(h=arguments[x],x++),!p)throw"Sync.sync: Local dir must be specified as file object";f||(f=p),d||(d={}),!h&&d.onend&&(h=d.onend),d.test&&(d.v=1),o();var y={},g=[],m={}},e.rsh=function(){for(var n=[],t=0;t<arguments.length;t++)n[t]=arguments[t];return $.ajax({url:a.top+"/edit/rsh",data:{args:JSON.stringify(n)},success:function(n){e.echo(n)},error:function(n,t,a){e.err(a)},complete:function(){e.prompt()}}),e.ASYNC},r}),requireSimulator.setName("searchDialog"),define(["UI","Shell"],function(n,e){var t={};return t.show=function(n,e){var a=t.embed(n,e);a.dialog({width:600})},t.embed=function(a,i){t.d||(t.d=n("div",{title:"検索"},["div",["span","検索語"],["input",{$edit:"word",on:{enterkey:function(){t.d.start()}}}]],["div",{$var:"validationMessage",css:{color:"red"}}],["button",{$var:"OKButton",on:{click:function(){t.d.start()}}},"検索"],["div",{style:"overflow-y:scroll; height:200px"},["table",{$var:"searchRes"}]]));var r=t.d,o={word:""};return r.$edits.load(o),r.start=function(){r.$vars.searchRes.empty();var t=e.grep(o.word,a);t.forEach(function(e){function t(){i&&i(e)}r.$vars.searchRes.append(n("tr",["td",{on:{click:t}},e.file.name()+"("+e.lineNo+")"],["td",{on:{click:t}},e.line]))})},r},t}),requireSimulator.setName("syncWithKernel"),requirejs(["Shell","FS","WebSite"],function(n,e,t){n.syncWithKernel=function(a){var i=e.get(t.tonyuHome),r=i.rel("Kernel/");if(a){var o=n.resolve(a),s=r.rel(a);return o.lastUpdate()>s.lastUpdate()?(n.cp(o,s,{v:1}),1):o.lastUpdate()<s.lastUpdate()?(n.cp(s,o,{v:1}),1):0}var l=0;return r.each(function(e){var t=n.resolve(e.name());t.exists()&&(l+=n.syncWithKernel(e.name()))}),l}}),requireSimulator.setName("ResEditor"),define(["FS","Tonyu","UI","ImageList","Blob","Auth","WebSite","ImageDetailEditor"],function(n,e,t,a,i,r,o,s){function l(n,e){if("string"==typeof n){var t=new Image;return t.onload=function(){l(t,e)},t.src=n,t}var a=e.width,i=e.height,r=e.getContext("2d"),o=n.width,s=n.height,c=i/s*o,u=a/o*s;u>i&&(u=i),c>a&&(c=a),r.clearRect(0,0,a,i);var p=Math.floor((a-c)/2),f=Math.floor((i-u)/2);r.drawImage(n,0,0,o,s,p,f,c,u)}var c=function(n,e){function c(e){try{return a.convURL(e,n.getDir())}catch(t){return o.urlAliases["images/ecl.png"]}}function u(){function e(e){eo=e.originalEvent;var a=eo.dataTransfer.files[0],s="GAE"==o.serverType&&a.size>3e5;if(!a.type.match(h.contentType)[1])return e.stopPropagation(),e.preventDefault(),!1;var l=a.name.replace(h.extPattern,"").replace(/\W/g,"_"),c="";a.name.match(h.extPattern)&&(c=RegExp.lastMatch);var u=h.newItem(l);if(s)r.assertLogin({showLoginLink:function(n){R.css("border","solid red 2px").empty().append(t("div","大きい"+h.name+"を追加するには，ログインが必要です：",["a",{href:n,target:"login",style:"color: blue;"},"ログインする"]))},success:function(e){R.text("アップロード中...");var t=n.getName();i.upload(e,t,a,{success:function(){R.text(v),u.url="${blobPath}/"+e+"/"+t+"/"+a.name,d(u)}})}});else{var p=new FileReader;p.onload=function(){var e=p.result,t=g.rel(l+c);t.text(e),u.url="ls:"+t.relPath(n.getDir()),d(u)},p.readAsDataURL(a)}return e.stopPropagation(),e.preventDefault(),!1}function a(n){n.stopPropagation(),n.preventDefault()}function f(e){function a(){s.show(e,n.getDir(),e.name,{onclose:function(){n.setResource(y),u()}})}function i(){for(var n=b.length-1;n>=0;n--)if(b[n]===e){b.splice(n,1);break}p()}function r(){for(var n=b.length-1;n>=1;n--)if(b[n]===e){b.splice(n,1),b.splice(n-1,0,e);break}p()}function o(){for(var n=b.length-2;n>=0;n--)if(b[n]===e){b.splice(n,1),b.splice(n+1,0,e);break}p()}var f=t("div",{style:"float:left;"},["canvas",{$var:"c",width:100,height:100,"class":"clickable",on:{click:a}}],["div",{style:"float:right;"},["button",{on:{click:i}},"×"],["br"],["button",{on:{click:r}},"←"],["br"],["button",{on:{click:o}},"→"]],["div",["input",{$var:"name",size:12,value:e.name}]]);l(c(e.url),f.$vars.c[0]);var d=f.$vars;return d.data=e,f}function d(n){b.push(n||h.newItem()),p()}x.empty();var v="ここに"+h.name+"ファイル("+h.exts.join("/")+")をドラッグ＆ドロップして追加",R=t("div",{style:"margin:10px; padding:10px; border:solid blue 2px;",on:{dragover:a,dragenter:a,drop:e}},v).appendTo(x);y=n.getResource();var b=y[h.key];m=[];var A=t("div").appendTo(x);b.forEach(function(n){var e=f(n);m.push(e),e.appendTo(A)}),x.append(t("div",{style:"clear:left;"},["button",{on:{click:function(){d()}}},"追加"],["button",{on:{click:function(){x.dialog("close")}}},"完了"]))}function p(){m.forEach(function(n){var e=n.$vars,t=e.data;t.name=e.name.val()}),console.log(y),n.setResource(y),u()}function f(){var t=y[h.key];r.currentUser(function(a,r){if(a){var s=[];t.forEach(function(n){var e;(e=i.isBlobURL(n.url))&&s.push(e.fileName)});var l={user:a,project:n.getName(),mediaType:e,csrfToken:r,retainFileNames:JSON.stringify(s)};console.log("retainBlobs",l),$.ajax({url:o.serverTop+"/retainBlobs",type:"get",data:l})}});var a={};g.each(function(e){a["ls:"+e.relPath(n.getDir())]=e}),y=n.getResource(),t.forEach(function(n){delete a[n.url]}),console.log(a);for(var s in a){var l=a[s];console.log(l+" is removed"),l.rm()}}var d={image:{name:"画像",exts:["png","gif","jpg"],path:"images/",key:"images",extPattern:/\.(png|gif|jpe?g)$/,contentType:/image\/(png|gif|jpe?g)/,newItem:function(n){var e={pwidth:32,pheight:32};return n&&(e.name="$pat_"+n),e}},sound:{name:"音声",exts:["mp3","ogg"],path:"sounds/",key:"sounds",extPattern:/\.(mp3|ogg)$/,contentType:/audio\/(mp3|ogg)/,newItem:function(n){var e={};return n&&(e.name="$se_"+n),e}}},h=d[e||"image"],x=t("div",{title:h.name+"リスト"});x.css({height:"200px","overflow-v":"scroll"});var y=n.getResource(),g=n.getDir().rel(h.path),m=[];y||n.setResource(),u(),x.dialog({modal:!0,width:800,height:500,close:function(){p(),f()}})};return c}),requireSimulator.setName("ide/editor"),requirejs(["Util","Tonyu","FS","FileList","FileMenu","showErrorPos","fixIndent","Wiki","Tonyu.Project","copySample","Shell","Shell2","ImageResEditor","ProjectOptionsEditor","copyToKernel","KeyEventChecker","WikiDialog","runtime","KernelDiffDialog","Sync","searchDialog","StackTrace","syncWithKernel","UI","ResEditor","WebSite","exceptionCatcher"],function(n,e,t,a,i,r,o,s,l,c,u,p,f,h,x,y,g,m,v,R,b,A,I,w,E,U,T){$(function(){function s(n){var e=q.getOptions();e.compiler.diagnose!=n&&(e.compiler.diagnose=n,q.setOptions(e))}function p(){var n=$(window).height()-$("#navBar").height();n-=20,J=n;var e=$("#runArea").width();$("#progs pre").css("height",n+"px"),$("#cv").attr("height",n).attr("width",e),cv=$("#cv")[0].getContext("2d"),$("#fileItemList").height(n)}function f(){_.ls(D),x()}function x(){D.each(function(n){if(n.endsWith(Y)){var e=n.truncExt(Y);V.indexOf(e)<0&&V.push(e)}});var n;for(n=V.length-1;n>=0;n--){var e=D.rel(V[n]+Y);e.exists()||V.splice(n,1)}$("#runMenu").empty(),n=0,V.forEach(function(e){var t=n;"string"!=typeof e&&(console.log(e),alert("not a string: "+e)),$("#runMenu").append($("<li>").append($("<a>").attr("href","#").text(e+"を実行"+(0==n?"(F9)":"")).click(O(function(){"string"!=typeof e&&(console.log(e),alert("not a string2: "+e)),S(e),t>0&&(V.splice(t,1),V.unshift(e),x(),H())})))),n++}),$("#runMenu").append($("<li>").append($("<a>").attr("href","#").text("停止(F2)").click(O(function(){C()})))),$("#exportToJsdoit").attr("href","exportToJsdoit.html?dir="+D.path()),$("#exportToExe").attr("href","exportToExe.html?dir="+D.path())}function m(n){var e=n.name();return n.isDir()?e:n.endsWith(Y)?n.truncExt(Y):null}function R(n,e){var t=!1;return n.match(/^[a-z]/)&&(n=n.substring(0,1).toUpperCase()+n.substring(1),t=!0),n.match(/^[A-Z_][a-zA-Z0-9_]*$/)?q.isKernel(n)?q.getOptions().kernelEditable?{ok:!0,file:D.rel(n+Y),note:"create"==e.action?"Kernelから"+n+"をコピーします":""}:{ok:!1,reason:n+"はシステムで利用されている名前なので使用できません"}:t?{ok:!0,file:D.rel(n+Y),note:"先頭を大文字("+n+") にして作成します．"}:{ok:!0,file:D.rel(n+Y)}:{ok:!1,reason:"名前は，半角英数字とアンダースコア(_)のみが使えます．先頭は英大文字にしてください．"}}function I(){var n=_.curFile();return n?Z[n.path()]:null}function k(){var n=I();return n?n.editor:null}function F(n){var e=k();switch(n){case"run":e&&e.blur(),r($("#errorPos"));break;case"compile_error":"undefined"!=typeof SplashScreen&&SplashScreen.hide();break;case"runtime_error":"undefined"!=typeof SplashScreen&&SplashScreen.hide();break;case"edit":}}function C(){q.stop()}function S(n){if(q.stop(),"string"!=typeof n){if(0==V.length)return void alert("ファイルを作成してください");n=V[0]}"string"!=typeof n&&(console.log(n),alert("not a string3: "+n)),N(),F("run"),"undefined"!=typeof SplashScreen&&SplashScreen.show(),setTimeout(function(){try{var t=q.getOptions();t.run.mainClass!=n&&(t.run.mainClass=n,q.setOptions()),q.rawRun(t.run.bootClass)}catch(a){a.isTError?(console.log("showErr: run"),r($("#errorPos"),a),F("compile_error")):e.onRuntimeError(a)}},0)}function P(n){var e=Z[n.path()];e&&(e.editor.destroy(),e.dom.remove(),delete Z[n.path()])}function Q(n){var e=n.getCursorPosition();n.setValue(o(n.getValue())),n.clearSelection(),n.moveCursorTo(e.row,e.column)}function X(){for(var n in Z){var e=Z[n],t=e.file,a=e.editor;t.exists()&&a&&(a.setValue(t.text()),a.clearSelection())}}function N(){var n=I();if(n){var e=n.file,t=n.editor;e&&t&&!e.isReadOnly()&&(Q(t),e.text(t.getValue())),_.setModified(!1)}}function j(){var n=I();if(n){var e=n.file,t=n.editor;_.setModified(e.text()!=t.getValue())}}function W(n){if(!n.isDir()){N(),ae&&ae.hide();var e=Z[n.path()];if(e)e.dom.show(),e.editor.focus(),ae=e.dom;else{var t=$("<pre>").css("height",J+"px").text(n.text()).appendTo("#progs"),a=ace.edit(t[0]);"number"==typeof B.editorFontSize&&a.setFontSize(B.editorFontSize),a.setTheme("ace/theme/eclipse"),a.getSession().setMode("ace/mode/tonyu"),Z[n.path()]={file:n,editor:a,dom:t},t.click(O(function(){F("edit")})),a.setReadOnly(!1),a.clearSelection(),a.focus(),ae=t}}}function L(){var n,e=D.rel(".desktop");return n=e.exists()?e.obj():{},n.runMenuOrd||(n.runMenuOrd=[]),B=n}function H(){var n=D.rel(".desktop");n.obj(B)}function K(){var n=D.name();return c.available(D)?void(confirm(D+" を初期状態に戻しますか？")&&(u.rm(D,{r:1}),c(n),f())):alert("このプロジェクトは初期状態に戻せません")}var O=T.f;$LASTPOS=0,c();var z=t.get(U.tonyuHome),M=z.rel("Kernel/"),G=n.getQueryString("dir","/Tonyu/Projects/SandBox/"),D=t.get(G),q=l(D,M),Y=q.EXT,B=L(),V=B.runMenuOrd;e.defaultResource={images:[{name:"$pat_base",url:"images/base.png",pwidth:32,pheight:32},{name:"$pat_sample",url:"images/Sample.png"},{name:"$pat_neko",url:"images/neko.png",pwidth:32,pheight:32},{name:"$pat_inputPad",url:"images/inputPad.png"}],sounds:[]},location.href.match(/^file/)&&e.defaultResource.images.splice(1,1),e.defaultOptions={compiler:{defaultSuperClass:"Actor"},run:{mainClass:"Main",bootClass:"Boot"},kernelEditable:!1},s(!1);var J;p();var Z={};y.down(document,"F9",O(S)),y.down(document,"F2",O(C)),y.down(document,"ctrl+s",O(function(n){return N(),n.stopPropagation(),n.preventDefault(),!1})),$(window).resize(O(p)),$("body")[0].spellcheck=!1,u.cd(D);var _=a($("#fileItemList"),{topDir:D,on:{select:O(W),displayName:m}}),ne=i();ne.fileList=_,$("#newFile").click(O(ne.create)),$("#mvFile").click(O(ne.mv)),$("#rmFile").click(O(ne.rm)),ne.on.close=P,ne.on.ls=f,ne.on.validateName=R,ne.on.createContent=function(n){var e=q.isKernel(n.truncExt(Y));n.text(e?e.text():"")},ne.on.displayName=function(n){var e=m(n);return e?e:n.name()};var ee;ne.on.mvExtraUI=function(n){ee=w("div",["input",{type:"checkbox",$var:"chk",checked:"true",value:"chked"}],"プログラム中のクラス名も変更する"),n.append(ee)},ne.on.mv=function(n,e){if(ee){var t=n.truncExt(Y),a=e.truncExt(Y);if(ee.$vars.chk.prop("checked")){N();try{q.renameClassName(t,a)}catch(i){return alert("プログラム内にエラーがあります．エラーを修正するか，「プログラム中のクラス名も変更する」のチェックを外してもう一度やり直してください．"),console.log(i),!1}}X(),ee=null}},O(ne.on),_.ls(D),x(),y.down(document,"Alt+Ctrl+D",function(){v.show(D,M)}),u.kernelDiff=function(){v.show(D,M)},u.kernelDiff.description="Compare Kernel file and this project.";var te;te=function(n){alert(n),te=function(){}},T.handleException=e.onRuntimeError=function(n){e.globals.$lastError=n;var t=q.env.traceTbl,a=A.get(n,t),i=a&&a[0]?a[0]:t.decode($LASTPOS);if(console.log("onRunTimeError:stackTrace",n.stack),i){if(i.mesg=n,n.pluginName)alert(n.message);else{var o=r($("#errorPos"),i);F("runtime_error"),$("#errorPos").find(".quickFix").append(w("button",{on:{click:function(){s(!0),o.dialog("close"),S()}}},"診断モードで実行しなおす"))}C()}else w("div",{title:"Error"},n,["pre",n.stack]).dialog({width:800})},$("#mapEditor").click(O(function(){console.log("run map"),S("MapEditor")})),$("#search").click(O(function(){console.log("src diag"),b.show(D,function(n){_.select(n.file),setTimeout(function(){var e=k();e&&e.gotoLine(n.lineNo)},50)})})),setInterval(j,1e3);var ae;d=function(){e.currentProject.dumpJS.apply(this,arguments)},$("#restore").click(O(K)),$("#imgResEditor").click(O(function(){E(q,"image")})),$("#prjOptEditor").click(O(function(){h(q)}));var ie=null;if($("#refHelp").click(O(function(){ie||(ie=g.create(z.rel("doc/tonyu2/"))),ie.show()})),"object"==typeof progBar&&progBar.clear(),$("#rmPRJ").click(O(function(){"DELETE"==prompt(D+"内のファイルをすべて削除しますか？削除する場合はDELETE と入力してください．","")&&(u.rm(D,{r:1}),document.location.href="index.html")})),$("#mvPRJ").click(O(function(){var n=prompt("新しいプロジェクトの名前を入れてください",D.name().replace(/\//g,""));if(n&&""!=n){n.match(/\/$/)||(n+="/");var e=D.up().rel(n);if(e.exists())return void alert(e+" はすでに存在します");u.cp(D,e),u.rm(D,{r:1}),document.location.href="project.html?dir="+e}})),$("#editorEditor").click(O(function(){var n=k(),e=prompt("エディタの文字の大きさ",B.editorFontSize||12);B.editorFontSize=parseInt(e),n.setFontSize(B.editorFontSize||12),H()})),u.curFile=function(){return _.curFile()},ne.onMenuStart=N,q.compileKernel(),SplashScreen.hide(),q.getBlobInfos().length>0){var re=w("div",{title:"ログイン"},["div","このプロジェクトを正常に動作させるにはログインが必要です"]);Auth.assertLogin({showLoginLink:function(n){re.append(w("a",{href:n,target:"login",style:"font-size: 20px;"},"ログインする"))},success:function(){re.dialog("close")}}),re.dialog({modal:!0})}})}),requireSimulator.setName();