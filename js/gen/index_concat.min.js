...
WebSite.devMode||WebSite.disableROM["ROM_s.js"]||WebSite.isNW?n.base="/ROM"+n.base:FS.mountROM(n)}(),requireSimulator.setName("HttpHelper"),requireSimulator.setName("Arrow"),Arrow=function(){var n={};return n.show=function(n){function e(){n.addClass("tutorial-highlight"),setTimeout(t,200)}function t(){n.removeClass("tutorial-highlight"),r-->0?setTimeout(e,200):a()}function a(){r=0,$.data(n[0],"blinking","f")}if("string"==typeof n&&(n=$(n)),0==n.length)return!1;var i=$.data(n[0],"blinking");if("t"!=i){$.data(n[0],"blinking","t");var r=3;e(),n.click(function(){a()})}},n.showOld=function(n){function e(){a&&(a.attr({src:"images/arrow"+i+".png"}),i=(i+1)%4)}if("string"==typeof n&&(n=$(n)),0==n.length)return!1;var t=n.offset(),a=$("<img>").attr({src:"images/arrow0.png"}).css({font:"40px",position:"absolute",left:t.left,top:t.top+n.height(),color:"red",zIndex:1e3,"z-index":1e3}).appendTo("body"),i=0;return setInterval(e,250),n.click(function(){a&&(a.remove(),a=null)}),!0},n}(),requireSimulator.setName("Util"),Util=function(){function n(n,t){null==t&&(t=""),n=n.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var a=new RegExp("[\\?&]"+n+"=([^&#]*)"),i=a.exec(window.location.href);return null==i?t:e(i[1])}function e(n){return decodeURIComponent(n.replace(/\+/g,"%20"))}function t(n,e){return n.substring(n.length-e.length)===e}function a(n,e){return n.substring(0,e.length)===e}return{getQueryString:n,endsWith:t,startsWith:a}}(),requireSimulator.setName("Log"),define(["FS","WebSite"],function(n,e){function t(n){return n.replace(/\n/g,"\n|")}var a={};return a.curFile=function(){var n=new Date,e=n.getFullYear(),t=n.getMonth()+1,a=n.getDate();return FS.get("/var/log/").rel(e+"/").rel(t+"/").rel(e+"-"+t+"-"+a+".log")},a.append=function(n){if(!e.isNW){var t=a.curFile(),i=t.exists()?t.text():"";t.text(i+n+"\n")}},a.d=function(n,e){a.append(new Date+": ["+n+"]"+t(e))},a.e=function(n,e){a.append(new Date+": ERROR["+n+"]"+t(e))},a}),requireSimulator.setName("exceptionCatcher"),define([],function(){var n={};return n.f=function(e){if("function"==typeof e){if(e.isTrcf)return e;var t=function(){if(!n.handleException||n.enter)return e.apply(this,arguments);try{return n.enter=!0,e.apply(this,arguments)}catch(t){n.handleException(t)}finally{n.enter=!1}};return t.isTrcf=!0,t}if("object"==typeof e){for(var a in e)e[a]=n.f(e[a]);return e}},n}),requireSimulator.setName("UI"),define(["Util","exceptionCatcher"],function(n,e){var t={},a=e.f;return t=function(){function e(){p.forEach(function(n){n()}),setTimeout(a(e),10)}function i(n){return n instanceof Array?r(n):"string"==typeof n?o(n):n}function r(n){var e=n[0],t=1,a=$("<"+e+">");for("object"!=typeof n[t]||n[t]instanceof Array||n[t]instanceof $||(s(a,n[t],e),t++);t<n.length;)a.append(i(n[t])),t++;return a}function s(e,i){function r(n,t){if("enterkey"==n)e.on("keypress",a(function(n){13==n.which&&t.apply(e,arguments)}));else if("realtimechange"==n){var r,s=!0;p.push(function(){var n;n="checkbox"==i.type?!!e.prop("checked"):e.val(),(s||r!=n)&&(t.apply(e,[n,r]),r=n),s=!1})}else e.on(n,a(t))}i.$var&&(d[i.$var]=e),i.$edit&&("string"==typeof i.$edit&&(i.$edit={name:i.$edit,type:t.types.String}),i.on||(i.on={}),i.on.realtimechange=a(function(n){u.writeToModel(i.$edit,n,e)}),d[i.$edit.name]||(d[i.$edit.name]=e),u.push({jq:e,params:i}));for(var s in i)if("on"==s)for(var o in i.on)r(o,i.on[o]);else"css"==s?e.css(i[s]):n.startsWith(s,"$")||e.attr(s,i[s])}function o(n){return $("<span>").text(n)}for(var l=[],c=0;c<arguments.length;c++)l[c]=arguments[c];var p=[],d={},u=[],h=i(l);return h.$edits=u,h.$vars=d,u.load=function(n){u.model=n,u.forEach(function(n){u.writeToJq(n.params.$edit,n.jq)})},u.writeToJq=function(n,e){var t=u.model;if(t){for(var a=n.name,i=a.split("."),r=0;r<i.length;r++)t=t[i[r]];t=n.type.toVal(t),"checkbox"==e.attr("type")?e.prop("checked",!!t):e.val(t)}},u.validator={errors:{},show:function(){if(d.validationMessage){d.validationMessage.empty();for(var n in this.errors)d.validationMessage.append(t("div",this.errors[n].mesg))}if(d.OKButton){var e=!0;for(var n in this.errors)e=!1;d.OKButton.attr("disabled",!e)}},on:{validate:function(){}},addError:function(n,e,t){this.errors[n]={mesg:e,jq:t},this.show()},removeError:function(n){delete this.errors[n],this.show()},allOK:function(){for(var n in this.errors)delete this.errors[n];this.show()},isValid:function(){var n=!0;for(var e in this.errors)n=!1;return n}},u.writeToModel=function(n,e,t){var a=u.model;if(a){var i=n.name;try{e=n.type.fromVal(e)}catch(r){return void u.validator.addError(i,r,t)}u.validator.removeError(i);for(var s=i.split("."),o=0;o<s.length;o++)o==s.length-1?u.on.writeToModel(i,e)||(a[s[o]]=e):a=a[s[o]];u.validator.on.validate.call(u.validator,u.model)}},u.on={},u.on.writeToModel=function(){},p.length>0&&setTimeout(a(e),10),h},t.types={String:{toVal:function(n){return n},fromVal:function(n){return n}},Number:{toVal:function(n){return n+""},fromVal:function(n){return parseFloat(n)}}},t}),requireSimulator.setName("Wiki"),define(["HttpHelper","Arrow","Util","WebSite","Log","UI","FS"],function(n,e,t,a,i,r,s){return Wiki=function(t,o,l){function c(n){function e(n){n.stopPropagation(),n.preventDefault()}function t(n){if(l.editMode){var e=n.originalEvent,t=e.dataTransfer.files[0];if(!t.type.match(/image\/(png|gif|jpg)/)[1])return n.stopPropagation(),n.preventDefault(),!1;var a=new FileReader;return a.onload=function(){var n=a.result;o.text(n),i.empty().append(r("img",{src:n}))},a.readAsDataURL(t),n.stopPropagation(),n.preventDefault(),!1}}var i,o;if(d.builtinImages[n])return $("<div>").append($("<img>").attr("src",a.top+"/doc/images/"+n));i=r("div",{style:"margin:10px; padding:10px; border:solid black 1px;",on:{dragover:e,dragenter:e,drop:t}},"ここに画像ファイル(png/gif/jpg)をドラッグ＆ドロップして追加");var c=s.get(a.tonyuHome);return o=c.rel("doc/images/").rel(n),o.exists()&&i.empty().append(r("img",{src:o.text()})),i}function p(n,e,t){function a(){for(var s=[];;){var o=n.indexOf(e,r),l=n.indexOf(t,r);if(l>=0&&(0>o||o>l)){s.push(n.substring(r,l)),r=l;break}if(0>o){s.push(n.substring(r)),r=n.length;break}s.push(n.substring(r,o)),r=o+e.length;var c=a();c.hasBrace=!0,r<n.length&&(r+=t.length),s.push(c)}return i(s),s}function i(n){return n.split=function(n,e){if(1==e)return this;var t=[],a=i([]);return this.forEach(function(r){if("string"==typeof r){var s=r.indexOf(n);if(t.length>=e&&(s=-1),s>=0){if(s>0){var o=r.substring(0,s);a.push(o)}if(s+=n.length,t.push(1!=a.length?a:a[0]),a=i([]),s<r.length){var o=r.substring(s);a.push(o)}}else a.push(r)}else a.push(r)}),t.push(1!=a.length?a:a[0]),t},n.text=function(n){var a=this.hasBrace&&n?e:"";return this.forEach(function(n){a+="string"==typeof n?n:n.text(!0)}),a+=this.hasBrace&&n?t:""},n.toString=function(){return this.text(!0)},n}var r=0;return a(0)}var d={},u={figures:"図",plists:"リスト"},h="marker_"+Math.floor(1e5*Math.random()),y={},f=[],x=".txt";if(l||(l={}),o&&!o.isDir())throw o+": not a dir";var g,A;d.on=y,d.cd=function(n){g=n,A=g.rel("toc.json")},o&&d.cd(o),d.parse=function(t,i,r){function s(n){f[n]={};var e=1,t=function(t,a){var i=f[n][t];return i||(i={refs:[]},f[n][t]=i),a&&(i.no=e++,i.name=u[n]+i.no,i.refs.forEach(function(n){n.text(i.name)})),i};return t}function o(n){function e(n){for(null==n&&(n=0);f.ul>n;)f.ul--,x.exit()}x.lineNo=f.lineNo;var t=0;if(n.match(/^-+/)&&(t=RegExp.lastMatch.length),t>f.ul)for(;t>f.ul;)f.ul++,x.enter("<ul>");else e(t);if(n=n.substring(t),t>0&&x.enter("<li>"),n.match(/^\*+/)){var a=RegExp.rightContext,i="h"+RegExp.lastMatch.length;x.enter("<"+i+">"),y(a),x.exit()}else if(n.match(/^$/))e(),x.p($("<p>"));else if(n.match(/^<<toc(.*)/))f.toc=[f.name],f.blocks.push({name:"toc",exit:function(){A&&!A.isReadOnly()&&A.obj(f.toc),f.toc=null}});else if(n.match(/^<<code(.*)/)){var r=RegExp.$1;if(r=r.replace(/^ */,""),r.length>0){var s,o,l=r.split(/ /,2);if(2==l.length){o=l[0],s=l[1];var c=m(s,!0);x.p($("<div>").addClass("plist").text(c.name+" "+o))}else x.p($("<div>").addClass("plist").text(l))}x.enter("<pre>"),f.blocks.push({name:"code",exit:function(){x.exit()}})}else if(n.match(/^>>/)){var p=f.blocks.pop();p&&p.exit&&p.exit(f)}else if(n.match(/^@@@@(.*)/)){if(f.pclose)x.exit();else{if(RegExp.$1.length>0){var c=m(RegExp.$1,!0);x.p($("<div>").addClass("plist").text(c.name))}x.enter("<pre>")}f.pclose=!f.pclose}else y(n),x.p("\n");t>0&&x.exit(),f.lineNo++}function y(n){function t(n){var t,i=n.text();if(i.match(/^@blink ([^>]+)>([^\s]+)/)){caption=RegExp.$1;var s=RegExp.$2;t=$("<span>").addClass("clickable").text(caption).hover(function(){var n;parent&&parent.Arrow&&(n=parent.Arrow),e&&(n=e),n&&n.show(s)})}else if(i.match(/^@plistref (.*)/)){var o=RegExp.$1,p=m(o);t=$("<strong>").text(p.name),p.refs.push(t)}else if(i.match(/^@editadd/))x.p($("<img>").attr("src",a.top+"/images/editAdd.png"));else if(i.match(/^@figref (.*)/)){var p=g(RegExp.$1);t=$("<strong>").text(p.name),p.refs.push(t)}else if(i.match(/^@cfrag (.*)/)){var h=RegExp.$1;t=$("<code>"),x.enter(t),y(h),x.exit()}else if(i.match(/^@arg (.*)/)){var A=RegExp.$1;t=$("<i>"),x.enter(t),y(A),x.exit()}else{var w=n.split(">",2);if(2==w.length?(i=w[1]+"",caption=w[0]):caption=i,f.toc&&f.toc.push(i),i.match(/\.(png|jpg|gif)$/)&&!i.match(/^http/)){var p=g(i,!0);t=$("<div>").addClass("figure").append(c(i)),x.enter(t),x.enter($("<div>")),x.p(u.figures+p.no+"."),y(caption),x.exit(),x.exit()}else if(i.match(/^https?:\/\//))t=$("<a>").attr({href:i,target:"ext"}).text(caption);else{var v=d.resolveFile(i);v.exists()||!v.isReadOnly()&&l.editMode?(t=l.useAnchor?$("<a>").attr({href:v.relPath(r.up()).replace(/\.txt$/,".html")}).text(caption):$("<span>").addClass("clickable").text(caption).click(function(){d.show(v)}),v.exists()||t.addClass("notexist")):t=$("<span>").text(caption)}}x.p(t)}var i="string"==typeof n?p(n,f.beginMark,f.endMark):n;i.forEach(function(n){"string"==typeof n?x.p(n):t(n)})}var f={},x=n({lineMark:h});f.out=x,f.name=i,f.lines=t.split(/\r?\n/),f.lineNo=0,f.ul=0,f.beginMark="[[",f.endMark="]]",f.blocks=[];var g=s("figures"),m=s("plists"),w=[];A&&A.exists()&&(w=A.obj());var v=w.indexOf(i);if(v>=0){var U="",b=w[v-1];b&&(U+="[[前へ>"+b+"]]");var C=w[v+1];C&&(U+=" - [[次へ>"+C+"]]");var k=w[0];0!=v&&(U+=" - [[目次>"+k+"]]"),f.lines.unshift(U),f.lines.push(U)}return f.lines.forEach(o),x.buf},d.resolveFile=function(n){var e;return e=n.isDir?n:g&&"/"!=n.substring(0,1)?g.rel(n+x):s.get(n)},d.show=function(n){var e=d.resolveFile(n);l.editMode||i.d("wiki","show "+e),d.cd(e.up());var a=e.truncExt(x);if(!e.exists()&&!e.isReadOnly()&&l.editMode){var r=f[f.length-1];e.text(r?"[["+r.truncExt(x)+"]]\n":"")}if(e.exists()){var s=d.parse(e.text(),a,e);t.empty(),t.scrollTop(0),t.append(s),t.append($("<div>").css({height:"100px"}).text("")),y.show&&y.show.apply(d,[e,a]),f.push(e)}else alert(n+" というページはありません")},d.back=function(){var n=f.pop();n&&show(n)};var m;return d.highlightLine=function(n){var e=$("#"+h+"-"+n);if(0!=e.length){m&&m.removeClass("wiki-cur-line"),m=e.next(),m.addClass("wiki-cur-line");var a=e.position().top,i=t;0>a&&i.scrollTop(i.scrollTop()+(a-10)/2);var r=i.height()-100;a>r&&i.scrollTop(i.scrollTop()+(a-r+10)/2)}},d.builtinImages={"50_100.png":1,"50_160.png":1,"50_300.png":1,"apple1apple2.png":1,"coords.png":1,"copy60_100.png":1,"firstRunRes.png":1,"firstVarRes.png":1,"itadaki.png":1,"noWaitCat.png":1,"runtimeError.png":1,"sample.png":1,"sayonara.png":1,"syntaxError.png":1},d}}),requireSimulator.setName("Shell"),define(["FS","Util","WebSite"],function(n,e,t){function a(n,e){var t=i(n);if(e&&!t.exists())throw t+": no such file or directory";return t}function i(t){if("string"!=typeof t)return t;if(e.startsWith(t,"/"))return n.get(t);var a=r.cwd;return a.rel(t)}var r={cwd:n.get("/")};return r.cd=function(n){return r.cwd=a(n,!0),r.pwd()},r.resolve=a,r.pwd=function(){return r.cwd+""},r.ls=function(n){return n=n?a(n,!0):r.cwd,n.ls()},r.cp=function(n,e,t){t||(t={}),t.v&&r.echo("cp",n,e);var i=a(n,!0),s=a(e);if(i.isDir()&&s.isDir()){var o=0;return i.recursive(function(n){var e=n.relPath(i),a=s.rel(e);(t.test||t.v)&&r.echo((a.exists()?"[ovr]":"[new]")+a+"<-"+n),t.test||a.copyFrom(n,t),o++}),o}if(i.isDir()||s.isDir()){if(!i.isDir()&&s.isDir())return s.rel(i.name()).text(i.text()),1;throw"Cannot copy directory "+i+" to file "+s}return s.text(i.text()),1},r.rm=function(n,e){if(e||(e={}),e.notrash)return n=a(n,!1),n.removeWithoutTrash(),1;if(n=a(n,!0),n.isDir()&&e.r){var t=n,i=0;return t.each(function(n){n.exists()&&(i+=r.rm(n,e))}),t.rm(),i+1}return n.rm(),1},r.cat=function(n){n=a(n,!0),r.echo(n.text())},r.resolve=function(n){return n||(n="."),n=a(n)},r.grep=function(n,e,t){function i(n,e,a){t.res&&t.res.push({file:n,lineNo:e,line:a}),r.echo(n+"("+e+"): "+a)}return e=a(e,!0),t||(t={}),t.res||(t.res=[]),e.isDir()?e.each(function(e){r.grep(n,e,t)}):"string"==typeof n&&e.lines().forEach(function(t,a){t.indexOf(n)>=0&&i(e,a+1,t)}),t.res},r.touch=function(n){return n=a(n),n.text(n.exists()?n.text():""),1},r.setout=function(n){r.outUI=n},r.echo=function(){console.log.apply(console,arguments),r.outUI&&r.outUI.log&&r.outUI.log.apply(r.outUI,arguments)},r.err=function(){console.log.apply(console,arguments),r.outUI&&r.outUI.err&&r.outUI.err.apply(r.outUI,arguments)},r.prompt=function(){},r.ASYNC={r:"SH_ASYNC"},r.help=function(){for(var n in r){var e=r[n];"function"==typeof e&&r.echo(n+(e.description?" - "+e.description:""))}},sh=r,t.isNW&&(sh.devtool=function(){require("nw.gui").Window.get().showDevTools()}),r}),requireSimulator.setName("Shell2"),define(["Shell","UI","FS","Util"],function(n,e,t,a){var i={};return i.show=function(n){var e=i.embed(n);e.dialog({width:600,height:500})},i.embed=function(){i.d||(i.d=e("div",{title:"Shell"},["div",{$var:"inner"},"Type 'help' to show commands.",["br"]]),i.inner=i.d.$vars.inner,n.prompt());var t=i.d;return t},n.cls=function(){i.d.$vars.inner.empty()},n.prompt=function(){function t(n){return 9==n.which?(n.stopPropagation(),n.preventDefault(),s(),!1):void(13==n.which&&(p.empty(),r(l.val())))}function r(){var t=l.val().replace(/^ */,"").replace(/ *$/,"");if(0!=t.length){var a=t.split(/ +/),i=a.shift(),r=n[i];if("function"!=typeof r)return c.append(i+": command not found.");try{var s=[],o=null;a.forEach(function(n){var e=/^-([A-Za-z_0-9]+)(=(.*))?/.exec(n);e?(o||(o={}),o[e[1]]=null!=e[3]?e[3]:1):s.push(n)}),o&&s.push(o);var p=r.apply(n,s);if(p===n.ASYNC)return;if("object"==typeof p)if(p instanceof Array){var d=e("table"),u=null,h=0;p.forEach(function(n){u||(u=e("tr").appendTo(d)),u.append(e("td",n)),h++,h%3==0&&(u=null)}),d.appendTo(c)}else c.append(JSON.stringify(p));else c.append(p);n.prompt()}catch(y){n.err(y),n.prompt()}}}function s(){var e=l.val(),t=e.split(" "),i=t.pop(),r=[];if(0==t.length)for(var s in n)"function"==typeof n[s]&&a.startsWith(s,i)&&r.push(s);else{var o=n.resolve(i,!1);if(!o)return;var c=o.isDir()?o:o.up();c.each(function(n){a.startsWith(n.path(),o.path())&&r.push(n.name())})}if(1==r.length){var d=i.split("/");d.pop(),d.push(r[0]),t.push(d.join("/")),l.val(t.join(" ")),p.empty()}else p.text(r.join(", "))}var o=e("div",["input",{$var:"cmd",size:40,on:{keydown:t}}],["pre",{$var:"out","class":"shell out"},["div",{$var:"cand","class":"shell cand"}]]),l=o.$vars.cmd,c=o.$vars.out,p=o.$vars.cand;return n.setout({log:function(){for(var n=[],e=0;e<arguments.length;e++)n.push(arguments[e]);c.append(n.join(" ")+"\n")},err:function(n){c.append(e("div",{"class":"shell error"},n,["br"],["pre",n.stack]))}}),o.appendTo(i.inner),l.focus(),i.inner.closest(".ui-dialog-content").scrollTop(i.inner.height()),n.ASYNC},n.window=function(){i.show(n.cwd)},n.atest=function(n,e,t){console.log(n,e,t)},i}),requireSimulator.setName("copySample"),define(["Shell","FS","WebSite"],function(n,e,t){function a(){o.exists()&&o.ls().forEach(r)}function i(n){var e=n.name();return o.rel(e).exists()&&l.equals(n.up())}function r(e){if(!e)return a();var t=o.rel(e),i=l.rel(e);t.exists()&&!i.exists()&&n.cp(t,i)}var s=FS.get(t.tonyuHome),o=s.rel("SampleROM/"),l=s.rel("Projects/");return r.available=i,r.all=a,r}),requireSimulator.setName("NewProjectDialog"),define(["UI"],function(n){var e={};return e.show=function(n,t,a){var i=e.embed(n,t,a);i.dialog({width:600})},e.embed=function(t,a,i){if(i||(i={}),!e.d){var r={fromVal:function(n){return""==n?null:FS.get(n)},toVal:function(n){return n?n.path():""}};e.d=n("div",{title:"新規プロジェクト"},["div",["span","プロジェクト名"],["input",{$edit:"name",value:i.defName||"",on:{enterkey:function(){e.d.done()}}}]],["div",["span","親フォルダ"],["input",{$edit:{name:"parentDir",type:r}}]],["div",["span","作成先フォルダ："],["span",{$var:"dstDir"}]],["div",{$var:"validationMessage",css:{color:"red"}}],["button",{$var:"OKButton",on:{click:function(){e.d.done()}}},"OK"])}var s=e.d,o={name:i.defName||"",parentDir:t};return s.$edits.load(o),s.$edits.validator.on.validate=function(n){return""==n.name?void this.addError("name","名前を入力してください"):(this.allOK(),n.dstDir=n.parentDir.rel(n.name+"/"),void s.$vars.dstDir.text(n.dstDir+""))},s.done=function(){s.$edits.validator.isValid()&&a(o.dstDir)},s},e}),requireSimulator.setName("requestFragment"),define(["WebSite"],function(n){var e={};return e.ajax=function(e){function t(n){return e.redirectTo&&(n.redirectTo=e.redirectTo),n}function a(){$.ajax({type:"post",url:n.top+"/edit/runFragments",data:t({id:o}),success:function(n){return"string"==typeof n&&n.match(/^notCompleted:([\-\d]+)\/([\-\d]+)$/)?(console.log("notcomp",n),p*=2,void setTimeout(a,p)):void e.success(n)},error:e.error,complete:e.complete})}var i=e.THRESH||8e5,r=e.data;if("object"!=typeof r)throw"Data should be object: "+r;if(r=JSON.stringify(r),!e.redirectTo&&("GAE"!=n.serverType||r.length<i))return $.ajax(e);for(var s=[],o=Math.random();r.length>0;)s.push(r.substring(0,i)),r=r.substring(i);var l=s.length,c=0,p=1e3;s.forEach(function(i,r){$.ajax({type:"post",url:n.top+"/edit/sendFragment",data:t({id:o,seq:r,len:l,content:i}),success:function(n){console.log("sendFrag",n,r),c++,c>=l&&setTimeout(a,p)},error:e.error})})},e}),requireSimulator.setName("Sync"),define(["FS","Shell","requestFragment","WebSite"],function(n,e,t,a){function i(n){return n&&n.isDir}var r={};return e.sync=function(){function n(n){return function(){n&&n.apply({},arguments),e.prompt()}}var t,a,s,o=function(){},l=0;return("string"==typeof arguments[l]||i(arguments[l]))&&(t=e.resolve(arguments[l],!0),l++,("string"==typeof arguments[l]||i(arguments[l]))&&(a=e.resolve(arguments[l],!1),l++)),"object"==typeof arguments[l]&&(s=arguments[l],l++),"function"==typeof arguments[l]&&(o=arguments[l],l++),t||(a=t=e.cwd),s&&s.onend&&(s.onend=n(s.onend)),a||(a=t),e.echo("sync args=",t,a,s,o),r.sync(t,a,s,n(o)),e.ASYNC},r.sync=function(){function n(n,t){e.echo("Status: "+n+" param:",t),h.onstatus&&h.onstatus(n,t)}function r(){h.onerror&&h.onerror.apply(this,arguments)}function s(){var e={base:u.path(),excludes:JSON.stringify(h.excludes)};n("getDirInfo",e),$.ajax({type:"get",url:a.top+"/edit/getDirInfo",data:e,success:o,error:r})}function o(t){t=JSON.parse(t),h.v&&e.echo("getDirInfo",t);var i=d,s=t.data;for(var o in s){var c=i.rel(o),y=c.metaInfo(),f=s[o];p(c,o,y,f)}d.recursive(function(n){var e=n.metaInfo(),t=n.relPath(d),a=s[t];p(n,t,e,a)},{includeTrashed:!0,excludes:h.excludes}),h.v&&(e.echo("uploads:",x),e.echo("downloads:",g));var A={base:u.path(),paths:JSON.stringify(g)};n("File2LSSync",A),$.ajax({type:"post",url:a.top+"/edit/File2LSSync",data:A,success:l,error:r})}function l(i){e.echo("dlData=",i),i=JSON.parse(i),h.v&&e.echo("dlData:",i);var s=d;if(!h.test){for(var o in i.data){var l=s.rel(o),p=i.data[o];p.trashed?l.exists()&&l.rm():l.text(p.text),delete p.text,l.metaInfo(p)}var y={base:u.path(),data:JSON.stringify(x)};y.pathInfo="/LS2FileSync",n("LS2FileSync",y),t.ajax({type:"post",url:a.top+"/edit/LS2FileSync",data:y,success:c,error:r})}}function c(n){h.v&&e.echo("LS2FileSync res=",n);var t=[];for(var a in x)t.push(a);n={msg:n,uploads:t,downloads:g},"function"==typeof y&&y(n)}function p(n,t,a,i){if(!A[t])if(A[t]=1,i&&(!a||a.lastUpdate<i.lastUpdate))g.push(t),h.v&&e.echo((a?"":"New")+"Download "+n+" trash="+!!i.trashed);else if(a&&(!i||a.lastUpdate>i.lastUpdate)){var r={text:n.text()},s=n.metaInfo();for(var o in s)r[o]=s[o];x[t]=r,h.v&&e.echo((i?"":"New")+"Upload "+n+" trash="+!!a.trashed)}}var d,u,h,y,f=0;if(i(arguments[f])&&(d=arguments[f],f++,i(arguments[f])&&(u=arguments[f],f++)),"object"==typeof arguments[f]&&(h=arguments[f],f++),"function"==typeof arguments[f]&&(y=arguments[f],f++),!d)throw"Sync.sync: Local dir must be specified as file object";u||(u=d),h||(h={}),!y&&h.onend&&(y=h.onend),h.test&&(h.v=1),s();var x={},g=[],A={}},e.rsh=function(){for(var n=[],t=0;t<arguments.length;t++)n[t]=arguments[t];return $.ajax({url:a.top+"/edit/rsh",data:{args:JSON.stringify(n)},success:function(n){e.echo(n)},error:function(n,t,a){e.err(a)},complete:function(){e.prompt()}}),e.ASYNC},r}),requireSimulator.setName("Auth"),define(["WebSite"],function(n){var e={};return e.currentUser=function(e){$.ajax({type:"get",url:n.serverTop+"/currentUser",data:{withCsrfToken:!0},success:function(n){console.log("auth.currentUser",n),n=JSON.parse(n);var t=n.user;"null"==t&&(t=null),console.log("user",t,"csrfToken",n.csrfToken),e(t,n.csrfToken)}})},e.assertLogin=function(t){e.currentUser(function(e,a){return e?t.success(e,a):(window.onLoggedIn=t.success,void t.showLoginLink(n.serverTop+"/login"))})},window.Auth=e,e}),requireSimulator.setName("zip"),define(["FS","Shell"],function(n,e){if("undefined"==typeof JSZip)return{};var t={};return t.zip=function(n){function e(n,t){t.each(function(t){if(t.isDir()){var a=n.folder(t.name());e(a,t)}else n.file(t.name(),t.text())})}var t=new JSZip;e(t,n);var a=t.generate({type:"blob"});return a},"undefined"!=typeof saveAs&&(e.dlzip=function(n){n=e.resolve(n);var a=t.zip(n);saveAs(a,n.name().replace(/\//g,"")+".zip")}),t}),requireSimulator.setName("ide/selProject"),requirejs(["FS","Wiki","Shell","Shell2","copySample","NewProjectDialog","UI","Sync","Auth","zip","requestFragment","WebSite"],function(n,e,t,a,i,r,s,o,l,c,p,d){$(function(){function a(){$("#prjItemList").empty();var n=[];u.each(function(e){if(e.isDir()){var t=e.lastUpdate(),a=e.rel("options.json");a.exists()&&(t=a.lastUpdate()),n.push([e,t])}}),n=n.sort(function(n,e){return e[1]-n[1]}),n.forEach(function(n){var e=n[0],t=e.name();if(e.isDir()){var a=s("div",{"class":"project"},["a",{href:"project.html?dir="+e.path()},["img",{$var:"t",src:"../../images/nowprint.png"}],["div",t]]);a.appendTo("#prjItemList"),setTimeout(function(){var n=e.rel("images/").rel("icon_thumbnail.png");n.exists()&&a.$vars.t.attr("src",n.text())},10)}})}i();var c=n.get(d.tonyuHome),p=c.rel("Projects/");t.cd(p);var u=p;l.currentUser(function(n){n?($(".while-logged-out").hide(),$("#login").text(n)):$(".while-logged-in").hide()});var h=e($("#wikiViewArea"),c.rel("doc/")),y=!1;d.devMode?o.sync(c,{v:1}):d.disableROM["ROM_d.js"]&&(y=!0,o.sync(c.rel("doc/"),{v:1,excludes:[c.rel("doc/html/").path()],onend:function(){c.rel("doc/index.txt").exists()&&h.show("index")}})),y||h.show("index"),$("#newPrj").click(function(){r.show(p,function(n){n.mkdir(),document.location.href="project.html?dir="+n.path()})}),a(),SplashScreen.hide()})}),requireSimulator.setName();