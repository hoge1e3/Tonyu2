...
var www=FS.get(module.filename).rel("../../www/");
var js=www.rel("js/");
console.log("js.path",js.path());
exports.genShim=function () {
    var reqConf=require ("../www/js/reqConf2").conf;
    var revPath={};
    var shim={};
...
exports.concat=function (params) {
    ...
    progs.forEach(function (name) {
        ...
        buf+=www.rel(fn+".js").text().replace(/\r/g,"")+"\n";
        var s=reqConf.shim[name];
        if (s && s.exports) buf+="define('"+name+"',[],function (){ return "+s.exports+"; });\n";
    });
    ...
    var gen=js.rel("../gen/");
    var ouf=gen.rel(outFile+"_concat.js");
    ouf.text(buf);

    var ugf=gen.rel(outFile+"_concat.min.js");
    uglify(ouf, ugf);
};
