...
Tonyu.klass.define({
  ...
  methods: {
    ...
    draw :function _trc_T1Sprite_draw(ctx) {
      ...
      //$LASTPOS=20000147;//kernel.T1Sprite:147
      if (! _this.pImg) {
        return _this;
      }
      //$LASTPOS=20000171;//kernel.T1Sprite:171
      ctx.save();
      //$LASTPOS=20000188;//kernel.T1Sprite:188
      ctx.translate(_this.x,_this.y);
      //$LASTPOS=20000213;//kernel.T1Sprite:213
      ctx.rotate(_this.angle/180*Math.PI);
      //$LASTPOS=20000254;//kernel.T1Sprite:254
      sgn = (_this.f?- 1:1);
      
      //$LASTPOS=20000277;//kernel.T1Sprite:277
      if (typeof  _this.scaleY==="undefined") {
        //$LASTPOS=20000325;//kernel.T1Sprite:325
        ctx.scale(_this.scaleX*sgn,_this.scaleX);
        
      } else {
        //$LASTPOS=20000386;//kernel.T1Sprite:386
        ctx.scale(_this.scaleX*sgn,_this.scaleY);
        
      }
      //$LASTPOS=20000438;//kernel.T1Sprite:438
      ctx.globalAlpha=_this.alpha/255;
      //$LASTPOS=20000475;//kernel.T1Sprite:475
      ...
      //$LASTPOS=20000615;//kernel.T1Sprite:615
      ctx.restore();
      //$LASTPOS=20000635;//kernel.T1Sprite:635
      _this.drawn=true;
    },
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    initialize :function _trc_BaseActor_initialize(x,y,p) {
      ...
      //$LASTPOS=25000439;//kernel.BaseActor:439
      if (_this.scaleX==null) {
        //$LASTPOS=25000457;//kernel.BaseActor:457
        _this.scaleX=1;
      }
      //$LASTPOS=25000472;//kernel.BaseActor:472
      if (_this.rotation==null) {
        //$LASTPOS=25000492;//kernel.BaseActor:492
        _this.rotation=0;
      }
      //$LASTPOS=25000509;//kernel.BaseActor:509
      if (_this.rotate==null) {
        //$LASTPOS=25000527;//kernel.BaseActor:527
        _this.rotate=0;
      }
      //$LASTPOS=25000542;//kernel.BaseActor:542
      if (_this.alpha==null) {
        //$LASTPOS=25000559;//kernel.BaseActor:559
        _this.alpha=255;
      }
      //$LASTPOS=25000575;//kernel.BaseActor:575
      if (_this.zOrder==null) {
        //$LASTPOS=25000593;//kernel.BaseActor:593
        _this.zOrder=0;
      }
      //$LASTPOS=25000608;//kernel.BaseActor:608
      if (_this.age==null) {
        //$LASTPOS=25000623;//kernel.BaseActor:623
        _this.age=0;
      }
      //$LASTPOS=25000635;//kernel.BaseActor:635
      if (_this.anim!=null&&typeof  _this.anim=="object") {
        //$LASTPOS=25000686;//kernel.BaseActor:686
        _this.animMode=true;
        //$LASTPOS=25000710;//kernel.BaseActor:710
        _this.animFrame=0;
        
      } else {
        //$LASTPOS=25000744;//kernel.BaseActor:744
        _this.animMode=false;
        
      }
      //$LASTPOS=25000772;//kernel.BaseActor:772
      if (_this.animFps==null) {
        //$LASTPOS=25000791;//kernel.BaseActor:791
        _this.animFps=1;
      }
    },
    ...
    print :function _trc_BaseActor_print(pt) {
      ...
      //$LASTPOS=25000895;//kernel.BaseActor:895
      console.log.apply(console,arguments);
      //$LASTPOS=25000938;//kernel.BaseActor:938
      mergedArg = "";
      
      //$LASTPOS=25000961;//kernel.BaseActor:961
      if (Tonyu.globals.$consolePanel) {
        //$LASTPOS=25000989;//kernel.BaseActor:989
        //$LASTPOS=25000993;//kernel.BaseActor:993
        argCount = 0;
        for (; argCount<arguments.length ; argCount++) {
          {
            //$LASTPOS=25001060;//kernel.BaseActor:1060
            mergedArg=mergedArg+arguments[argCount]+" ";
          }
        }
        //$LASTPOS=25001125;//kernel.BaseActor:1125
        _this.splits=mergedArg.split("\n");
        //$LASTPOS=25001164;//kernel.BaseActor:1164
        //$LASTPOS=25001168;//kernel.BaseActor:1168
        printCount = 0;
        for (; printCount<_this.splits.length ; printCount++) {
          {
            //$LASTPOS=25001238;//kernel.BaseActor:1238
            Tonyu.globals.$consolePanel.scroll(0,20);
            //$LASTPOS=25001279;//kernel.BaseActor:1279
            Tonyu.globals.$consolePanel.setFillStyle("white");
            //$LASTPOS=25001329;//kernel.BaseActor:1329
    ...
    setAnimFps :function _trc_BaseActor_setAnimFps(f) {
      ...
      //$LASTPOS=25001452;//kernel.BaseActor:1452
      _this.animFps=f;
      //$LASTPOS=25001473;//kernel.BaseActor:1473
      _this.animFrame=0;
      //$LASTPOS=25001496;//kernel.BaseActor:1496
      _this.animMode=true;
    },
    startAnim :function _trc_BaseActor_startAnim() {
      ...
      //$LASTPOS=25001546;//kernel.BaseActor:1546
      _this.animMode=true;
    },
    stopAnim :function _trc_BaseActor_stopAnim() {
      ...
      //$LASTPOS=25001595;//kernel.BaseActor:1595
      _this.animMode=false;
    },
    update :function _trc_BaseActor_update() {
      ...
      //$LASTPOS=25001637;//kernel.BaseActor:1637
      _this.onUpdate();
      //$LASTPOS=25001654;//kernel.BaseActor:1654
      if (null) {
        //$LASTPOS=25001677;//kernel.BaseActor:1677
        null.suspend();
        //$LASTPOS=25001705;//kernel.BaseActor:1705
        if (Tonyu.globals.$Scheduler) {
          //$LASTPOS=25001721;//kernel.BaseActor:1721
    ...
    updateEx :function _trc_BaseActor_updateEx(updateT) {
      ...
      //$LASTPOS=25001815;//kernel.BaseActor:1815
      //$LASTPOS=25001819;//kernel.BaseActor:1819
      updateCount = 0;
      for (; updateCount<updateT ; updateCount++) {
        {
          //$LASTPOS=25001882;//kernel.BaseActor:1882
          _this.update();
        }
      }
    },
    ...
    all :function _trc_BaseActor_all(c) {
      ...
      //$LASTPOS=25002025;//kernel.BaseActor:2025
      res = new Tonyu.classes.kernel.TQuery;
      
      //$LASTPOS=25002050;//kernel.BaseActor:2050
      if (arguments.length>0&&typeof  c!="function") {
        return res;
        
      }
      //$LASTPOS=25002133;//kernel.BaseActor:2133
      Tonyu.globals.$Sprites.sprites.forEach((function anonymous_2158(s) {
        
        //$LASTPOS=25002174;//kernel.BaseActor:2174
        if (s===_this) {
          return _this;
        }
        //$LASTPOS=25002205;//kernel.BaseActor:2205
        if (! c||s instanceof c) {
          //$LASTPOS=25002246;//kernel.BaseActor:2246
          res.push(s);
    ...
    allCrash :function _trc_BaseActor_allCrash(t) {
      ...
      //$LASTPOS=25002353;//kernel.BaseActor:2353
      res = new Tonyu.classes.kernel.TQuery;
      
      //$LASTPOS=25002378;//kernel.BaseActor:2378
      sp = _this;
      
      //$LASTPOS=25002415;//kernel.BaseActor:2415
      ...
      //$LASTPOS=25002469;//kernel.BaseActor:2469
      Tonyu.globals.$Sprites.sprites.forEach((function anonymous_2494(s) {
        var t2;
        
        
        //$LASTPOS=25002527;//kernel.BaseActor:2527
        if (s!==_this&&! s.excludeFromAll&&s instanceof t&&(t2=s.getCrashRect())&&Math.abs(t1.x-t2.x)*2<t1.width+t2.width&&Math.abs(t1.y-t2.y)*2<t1.height+t2.height) {
          //$LASTPOS=25002753;//kernel.BaseActor:2753
          res.push(s);
    ...
    crashTo :function _trc_BaseActor_crashTo(t) {
      ...
      //$LASTPOS=25002833;//kernel.BaseActor:2833
      if (! t) {
        return false;
      }
      //$LASTPOS=25002860;//kernel.BaseActor:2860
    ...
    crashTo1 :function _trc_BaseActor_crashTo1(t) {
      ...
      //$LASTPOS=25002983;//kernel.BaseActor:2983
      if (! t||t._isDead) {
        return false;
      }
      //$LASTPOS=25003023;//kernel.BaseActor:3023
      t1 = _this.getCrashRect();
    ...
    crashToChecker :function _trc_BaseActor_crashToChecker(d,f) {
      ...
      //$LASTPOS=25003360;//kernel.BaseActor:3360
      while (true) {
        //$LASTPOS=25003382;//kernel.BaseActor:3382
        if (typeof  d=="function") {
          //$LASTPOS=25003421;//kernel.BaseActor:3421
          _it_157=Tonyu.iterator(_this.allCrash(d),1);
          while(_it_157.next()) {
            obj=_it_157[0];
            
            //$LASTPOS=25003463;//kernel.BaseActor:3463
            _this.callEventHandler(f,[obj]);
            
          }
          
        } else {
          //$LASTPOS=25003520;//kernel.BaseActor:3520
          if (_this.crashTo(d)) {
            //$LASTPOS=25003549;//kernel.BaseActor:3549
            _this.callEventHandler(f,[d]);
            
          }
        }
        //$LASTPOS=25003594;//kernel.BaseActor:3594
        _this.update();
    ...
    getCrashRect :function _trc_BaseActor_getCrashRect() {
      ...
      //$LASTPOS=25003645;//kernel.BaseActor:3645
      actWidth = _this.width*_this.scaleX;
      
      //$LASTPOS=25003688;//kernel.BaseActor:3688
      if (typeof  _this.scaleY==="undefined") {
        //$LASTPOS=25003730;//kernel.BaseActor:3730
        actHeight=_this.height*_this.scaleX;
        
      } else {
        //$LASTPOS=25003776;//kernel.BaseActor:3776
    ...
    allWithin :function _trc_BaseActor_allWithin(t,distance) {
      ...
      //$LASTPOS=25004037;//kernel.BaseActor:4037
      res = new Tonyu.classes.kernel.TQuery;
      
      //$LASTPOS=25004062;//kernel.BaseActor:4062
      sp = _this;
      
      //$LASTPOS=25004099;//kernel.BaseActor:4099
      t1 = _this.getCrashRect();
      ...
      //$LASTPOS=25004153;//kernel.BaseActor:4153
      Tonyu.globals.$Sprites.sprites.forEach((function anonymous_4178(s) {
        var t2;
        
        
        //$LASTPOS=25004211;//kernel.BaseActor:4211
        if (s!==_this&&! s.excludeFromAll&&s instanceof t&&Math.sqrt(Math.abs(_this.x-s.x)*Math.abs(_this.x-s.x)+Math.abs(_this.y-s.y)*Math.abs(_this.y-s.y))<distance) {
          //$LASTPOS=25004394;//kernel.BaseActor:4394
          res.push(s);
    ...
    within :function _trc_BaseActor_within(t,distance) {
      ...
      //$LASTPOS=25004481;//kernel.BaseActor:4481
      if (! t) {
        return false;
      }
      //$LASTPOS=25004507;//kernel.BaseActor:4507
      if (typeof  t=="function") {
    ...
    within1 :function _trc_BaseActor_within1(t,distance) {
      ...
      //$LASTPOS=25004653;//kernel.BaseActor:4653
      if (! t||t._isDead) {
        return false;
      }
      //$LASTPOS=25004692;//kernel.BaseActor:4692
    ...
    withinChecker :function _trc_BaseActor_withinChecker(d,r,f) {
      ...
      //$LASTPOS=25004862;//kernel.BaseActor:4862
      while (true) {
        //$LASTPOS=25004884;//kernel.BaseActor:4884
        if (typeof  d=="function") {
          //$LASTPOS=25004923;//kernel.BaseActor:4923
          _it_167=Tonyu.iterator(_this.allWithin(d,r),1);
          while(_it_167.next()) {
            obj=_it_167[0];
            
            //$LASTPOS=25004997;//kernel.BaseActor:4997
            f(obj);
            
          }
          
        } else {
          //$LASTPOS=25005035;//kernel.BaseActor:5035
          if (_this.within(d,r)) {
            //$LASTPOS=25005065;//kernel.BaseActor:5065
            f(d);
            
          }
        }
        //$LASTPOS=25005091;//kernel.BaseActor:5091
        _this.update();
    ...
    watchHit :function _trc_BaseActor_watchHit(typeA,typeB,onHit) {
      ...
      //$LASTPOS=25005155;//kernel.BaseActor:5155
      Tonyu.globals.$Sprites.watchHit(typeA,typeB,(function anonymous_5188(a,b) {
        
        //$LASTPOS=25005206;//kernel.BaseActor:5206
    ...
    die :function _trc_BaseActor_die() {
      ...
      //$LASTPOS=25005360;//kernel.BaseActor:5360
      _this.killThreadGroup();
      //$LASTPOS=25005384;//kernel.BaseActor:5384
      _this.hide();
      //$LASTPOS=25005397;//kernel.BaseActor:5397
      _this.fireEvent("die");
      //$LASTPOS=25005420;//kernel.BaseActor:5420
      _this._isDead=true;
      //$LASTPOS=25005439;//kernel.BaseActor:5439
      if (_this._poolArray) {
        //$LASTPOS=25005466;//kernel.BaseActor:5466
        _this._poolArray.push(_this);
        //$LASTPOS=25005498;//kernel.BaseActor:5498
    ...
    hide :function _trc_BaseActor_hide() {
      ...
      //$LASTPOS=25005567;//kernel.BaseActor:5567
      if (_this.layer&&typeof  _this.layer.remove=="function") {
        //$LASTPOS=25005622;//kernel.BaseActor:5622
        _this.layer.remove(_this);
        
      } else {
        //$LASTPOS=25005663;//kernel.BaseActor:5663
    ...
    show :function _trc_BaseActor_show(x,y,p) {
      ...
      if (_this.layer&&typeof  _this.layer.add=="function") {
        //$LASTPOS=25005776;//kernel.BaseActor:5776
        _this.layer.add(_this);
        
      } else {
        //$LASTPOS=25005814;//kernel.BaseActor:5814
        Tonyu.globals.$Sprites.add(_this);
        
      }
      //$LASTPOS=25005846;//kernel.BaseActor:5846
      if (x!=null) {
        //$LASTPOS=25005859;//kernel.BaseActor:5859
        _this.x=x;
      }
      //$LASTPOS=25005874;//kernel.BaseActor:5874
      if (y!=null) {
        //$LASTPOS=25005887;//kernel.BaseActor:5887
        _this.y=y;
      }
      //$LASTPOS=25005902;//kernel.BaseActor:5902
      if (p!=null) {
        //$LASTPOS=25005915;//kernel.BaseActor:5915
        _this.p=p;
      }
    },
    detectShape :function _trc_BaseActor_detectShape() {
      ...
      //$LASTPOS=25005960;//kernel.BaseActor:5960
      if (typeof  _this.p!="number") {
        //$LASTPOS=25005995;//kernel.BaseActor:5995
        if (_this.text!=null) {
          return _this;
        }
      ...
      //$LASTPOS=25006045;//kernel.BaseActor:6045
      _this.p=Math.floor(_this.p);
      //$LASTPOS=25006067;//kernel.BaseActor:6067
      _this.pImg=Tonyu.globals.$imageList[_this.p];
      //$LASTPOS=25006122;//kernel.BaseActor:6122
      if (! _this.pImg) {
        return _this;
      }
      //$LASTPOS=25006146;//kernel.BaseActor:6146
      _this.width=_this.pImg.width;
      //$LASTPOS=25006169;//kernel.BaseActor:6169
    ...
    animation :function _trc_BaseActor_animation() {
      ...
      //$LASTPOS=25006265;//kernel.BaseActor:6265
      _this.age++;
      //$LASTPOS=25006277;//kernel.BaseActor:6277
      if (_this.animMode&&_this.age%_this.animFps==0) {
        //$LASTPOS=25006318;//kernel.BaseActor:6318
        _this.p=_this.anim[_this.animFrame%_this.anim.length];
        //$LASTPOS=25006358;//kernel.BaseActor:6358
        _this.animFrame++;
    ...
    draw :function _trc_BaseActor_draw(ctx) {
      ...
      //$LASTPOS=25006407;//kernel.BaseActor:6407
      if (_this.x==null||_this.y==null||_this._isInvisible) {
        return _this;
      }
      //$LASTPOS=25006460;//kernel.BaseActor:6460
      _this.detectShape();
      //$LASTPOS=25006480;//kernel.BaseActor:6480
      if (_this.pImg) {
        //$LASTPOS=25006501;//kernel.BaseActor:6501
        ctx.save();
        //$LASTPOS=25006522;//kernel.BaseActor:6522
        ctx.translate(_this.x,_this.y);
        //$LASTPOS=25006666;//kernel.BaseActor:6666
        _this.animation();
        //$LASTPOS=25006688;//kernel.BaseActor:6688
        if (_this.rotation!=0) {
          //$LASTPOS=25006723;//kernel.BaseActor:6723
          ctx.rotate(_this.rotation/180*Math.PI);
          
        } else {
          //$LASTPOS=25006791;//kernel.BaseActor:6791
          ctx.rotate(_this.rotate/180*Math.PI);
          
        }
        //$LASTPOS=25006848;//kernel.BaseActor:6848
        if (typeof  _this.scaleY==="undefined") {
          //$LASTPOS=25006900;//kernel.BaseActor:6900
          ctx.scale(_this.scaleX,_this.scaleX);
          
        } else {
          //$LASTPOS=25006965;//kernel.BaseActor:6965
          ctx.scale(_this.scaleX,_this.scaleY);
          
        }
        //$LASTPOS=25007021;//kernel.BaseActor:7021
        ctx.globalAlpha=_this.alpha/255;
        //$LASTPOS=25007062;//kernel.BaseActor:7062
        ctx.drawImage(_this.pImg.image,_this.pImg.x,_this.pImg.y,_this.pImg.width,_this.pImg.height,- _this.width/2,- _this.height/2,_this.width,_this.height);
        //$LASTPOS=25007194;//kernel.BaseActor:7194
        ctx.restore();
        
      } else {
        //$LASTPOS=25007221;//kernel.BaseActor:7221
        if (_this.text!==null&&_this.text!==undefined) {
          //$LASTPOS=25007269;//kernel.BaseActor:7269
          splitsText = (_this.text+"").split("\n");
          
          //$LASTPOS=25007316;//kernel.BaseActor:7316
          _this.drawY=_this.y;
          //$LASTPOS=25007334;//kernel.BaseActor:7334
          if (! _this.size) {
            //$LASTPOS=25007345;//kernel.BaseActor:7345
            _this.size=15;
          }
          //$LASTPOS=25007363;//kernel.BaseActor:7363
          if (! _this.align) {
            //$LASTPOS=25007375;//kernel.BaseActor:7375
            _this.align="center";
          }
          //$LASTPOS=25007400;//kernel.BaseActor:7400
          if (! _this.fillStyle) {
            //$LASTPOS=25007416;//kernel.BaseActor:7416
            _this.fillStyle="white";
          }
          //$LASTPOS=25007444;//kernel.BaseActor:7444
          if (_this.font) {
            //$LASTPOS=25007454;//kernel.BaseActor:7454
            ctx.font=_this.size+"px "+_this.font;
          }
          //$LASTPOS=25007489;//kernel.BaseActor:7489
          ctx.fillStyle=_this.fillStyle;
          //$LASTPOS=25007523;//kernel.BaseActor:7523
          ctx.globalAlpha=_this.alpha/255;
          //$LASTPOS=25007564;//kernel.BaseActor:7564
          _this.height=0;
          //$LASTPOS=25007573;//kernel.BaseActor:7573
          _this.width=0;
          //$LASTPOS=25007591;//kernel.BaseActor:7591
          //$LASTPOS=25007595;//kernel.BaseActor:7595
          textCount = 0;
          for (; textCount<splitsText.length ; textCount++) {
            {
              //$LASTPOS=25007666;//kernel.BaseActor:7666
              rect = _this.drawTextRect(ctx,splitsText[textCount],_this.x,_this.drawY,_this.size,_this.align,"fill");
              
              //$LASTPOS=25007762;//kernel.BaseActor:7762
              if (_this.width<rect.w) {
                //$LASTPOS=25007779;//kernel.BaseActor:7779
                _this.width=rect.w;
              }
              //$LASTPOS=25007806;//kernel.BaseActor:7806
              _this.height+=rect.h;
              //$LASTPOS=25007835;//kernel.BaseActor:7835
      ...
      if (_this._fukidashi) {
        //$LASTPOS=25007898;//kernel.BaseActor:7898
        if (_this._fukidashi.c>0) {
          //$LASTPOS=25007933;//kernel.BaseActor:7933
          _this._fukidashi.c--;
          //$LASTPOS=25007962;//kernel.BaseActor:7962
          ctx.fillStyle="white";
          //$LASTPOS=25007998;//kernel.BaseActor:7998
          ctx.strokeStyle="black";
          //$LASTPOS=25008036;//kernel.BaseActor:8036
    ...
    runAsync :function _trc_BaseActor_runAsync(f) {
      ...
      //$LASTPOS=25008164;//kernel.BaseActor:8164
      if (! null) {
        throw new Error("runAsync should run in wait mode");
        
      }
      //$LASTPOS=25008236;//kernel.BaseActor:8236
      null.runAsync(f);
    },
    ...
    screenOut :function _trc_BaseActor_screenOut(a) {
      ...
      //$LASTPOS=25008318;//kernel.BaseActor:8318
      if (! a) {
        //$LASTPOS=25008326;//kernel.BaseActor:8326
        a=0;
      }
      //$LASTPOS=25008336;//kernel.BaseActor:8336
      r = 0;
      ...
      //$LASTPOS=25008396;//kernel.BaseActor:8396
      if (_this.x<viewX+a) {
        //$LASTPOS=25008425;//kernel.BaseActor:8425
        r+=viewX+a-_this.x;
      }
      //$LASTPOS=25008444;//kernel.BaseActor:8444
      if (_this.y<viewY+a) {
        //$LASTPOS=25008473;//kernel.BaseActor:8473
        r+=viewY+a-_this.y;
      }
      //$LASTPOS=25008492;//kernel.BaseActor:8492
      if (_this.x>Tonyu.globals.$screenWidth+viewX-a) {
        //$LASTPOS=25008521;//kernel.BaseActor:8521
        r+=_this.x-(Tonyu.globals.$screenWidth+viewX-a);
      }
      //$LASTPOS=25008556;//kernel.BaseActor:8556
      if (_this.y>Tonyu.globals.$screenHeight+viewY-a) {
        //$LASTPOS=25008585;//kernel.BaseActor:8585
    ...
    screenOutChecker :function _trc_BaseActor_screenOutChecker(d,f) {
      ...
      //$LASTPOS=25008663;//kernel.BaseActor:8663
      while (true) {
        //$LASTPOS=25008685;//kernel.BaseActor:8685
        while (true) {
          //$LASTPOS=25008711;//kernel.BaseActor:8711
          if (_this.screenOut()>d) {
            //$LASTPOS=25008747;//kernel.BaseActor:8747
            f();
            break;
        ...
        //$LASTPOS=25008834;//kernel.BaseActor:8834
        while (true) {
          //$LASTPOS=25008860;//kernel.BaseActor:8860
          if (_this.screenOut()<=d) {
            break;
        ...
        //$LASTPOS=25008962;//kernel.BaseActor:8962
        _this.update();
    ...
    file :function _trc_BaseActor_file(path) {
      ...
      //$LASTPOS=25009002;//kernel.BaseActor:9002
      d = Tonyu.currentProject.getDir();
      
      //$LASTPOS=25009044;//kernel.BaseActor:9044
      files = d.rel("files/");
    ...
    waitInputDevice :function _trc_BaseActor_waitInputDevice(fl) {
      ...
      //$LASTPOS=25009153;//kernel.BaseActor:9153
      _this.runAsync((function anonymous_9162(f) {
        
        //$LASTPOS=25009177;//kernel.BaseActor:9177
    ...
    fiber$waitInputDevice :function _trc_BaseActor_f_waitInputDevice(_thread,fl) {
      ...
      _thread.enter(function _trc_BaseActor_ent_waitInputDevice(_thread) {
        ...
        for(var __cnt=100 ; __cnt--;) {
          ...
          case 0:
            //$LASTPOS=25009153;//kernel.BaseActor:9153
            _this.fiber$runAsync(_thread, (function anonymous_9162(f) {
    ...
    redrawScreen :function _trc_BaseActor_redrawScreen() {
      ...
      //$LASTPOS=25009248;//kernel.BaseActor:9248
      Tonyu.globals.$Sprites.draw(Tonyu.globals.$Screen.buf[0]);
      //$LASTPOS=25009284;//kernel.BaseActor:9284
    ...
    loadPage :function _trc_BaseActor_loadPage(page,arg) {
      ...
      //$LASTPOS=25009413;//kernel.BaseActor:9413
      _this.all().die();
      //$LASTPOS=25009431;//kernel.BaseActor:9431
      new page(arg);
      //$LASTPOS=25009451;//kernel.BaseActor:9451
      _this.die();
    },
    ...
    setVisible :function _trc_BaseActor_setVisible(v) {
      ...
      //$LASTPOS=25009486;//kernel.BaseActor:9486
    ...
    __setter__useObjectPool :function _trc_BaseActor___setter__useObjectPool(value) {
      ...
      if (value) {
        //$LASTPOS=25009557;//kernel.BaseActor:9557
    ...
    appear :function _trc_BaseActor_appear(o,param) {
      ...
      //$LASTPOS=25009650;//kernel.BaseActor:9650
      if (typeof  o=="function") {
        //$LASTPOS=25009687;//kernel.BaseActor:9687
        p = Tonyu.globals.$ObjectPool.withdraw(o.meta.fullName);
        
        //$LASTPOS=25009741;//kernel.BaseActor:9741
        if (p) {
          //$LASTPOS=25009760;//kernel.BaseActor:9760
          _it_181=Tonyu.iterator(Object.keys(p),1);
          while(_it_181.next()) {
            k=_it_181[0];
            
            //$LASTPOS=25009805;//kernel.BaseActor:9805
            if (k!="objectPoolAge") {
          ...
          //$LASTPOS=25009858;//kernel.BaseActor:9858
          o.call(p,param);
          return p;
    ...
    wait :function _trc_BaseActor_wait(t) {
      ...
      //$LASTPOS=25010009;//kernel.BaseActor:10009
      if (null) {
        //$LASTPOS=25010032;//kernel.BaseActor:10032
        null.suspend();
        //$LASTPOS=25010060;//kernel.BaseActor:10060
        if (t) {
          //$LASTPOS=25010082;//kernel.BaseActor:10082
          null.waitCount=t;
          //$LASTPOS=25010116;//kernel.BaseActor:10116
          if (Tonyu.globals.$Scheduler) {
            //$LASTPOS=25010132;//kernel.BaseActor:10132
            Tonyu.globals.$Scheduler.addToNext(null);
          }
        ...
        if (_this._th) {
          //$LASTPOS=25010206;//kernel.BaseActor:10206
          if (t) {
            //$LASTPOS=25010228;//kernel.BaseActor:10228
            _this._th.waitCount=t;
            
          } else {
            //$LASTPOS=25010276;//kernel.BaseActor:10276
            if (_this._th.scheduled) {
              //$LASTPOS=25010295;//kernel.BaseActor:10295
    ...
    notify :function _trc_BaseActor_notify() {
      ...
      //$LASTPOS=25010372;//kernel.BaseActor:10372
      if (_this._th) {
        //$LASTPOS=25010392;//kernel.BaseActor:10392
        if (_this._th.scheduled) {
          //$LASTPOS=25010427;//kernel.BaseActor:10427
          _this._th.waitCount=0;
          
        } else {
          //$LASTPOS=25010475;//kernel.BaseActor:10475
          if (Tonyu.globals.$Scheduler) {
            //$LASTPOS=25010491;//kernel.BaseActor:10491
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    set :function _trc_Map_set(setCol,setRow,p) {
      ...
      //$LASTPOS=32001976;//kernel.Map:1976
      if (! _this.pImg) {
        //$LASTPOS=32001998;//kernel.Map:1998
        _this.ctx.clearRect(setCol*_this.chipWidth,setRow*_this.chipHeight,_this.chipWidth,_this.chipHeight);
        return _this;
        
      }
      //$LASTPOS=32002099;//kernel.Map:2099
      _this.ctx.clearRect(setCol*_this.chipWidth,setRow*_this.chipHeight,_this.chipWidth,_this.chipHeight);
      //$LASTPOS=32002176;//kernel.Map:2176
      _this.ctx.save();
      //$LASTPOS=32002193;//kernel.Map:2193
      _this.ctx.drawImage(_this.pImg.image,_this.pImg.x,_this.pImg.y,_this.pImg.width,_this.pImg.height,setCol*_this.chipWidth,setRow*_this.chipHeight,_this.chipWidth,_this.chipHeight);
      //$LASTPOS=32002337;//kernel.Map:2337
      _this.ctx.restore();
    },
    ...
    setOn :function _trc_Map_setOn(setCol,setRow,p) {
      ...
      //$LASTPOS=32002386;//kernel.Map:2386
      if (setCol>=_this.col||setRow>=_this.row||setCol<0||setRow<0) {
        return _this;
      }
      //$LASTPOS=32002454;//kernel.Map:2454
      _this.set(setCol,setRow,_this.mapTable[setRow][setCol]);
      //$LASTPOS=32002504;//kernel.Map:2504
      _this.mapOnTable[setRow][setCol]=p;
      //$LASTPOS=32002539;//kernel.Map:2539
      _this.ctx=_this.buf[0].getContext("2d");
      //$LASTPOS=32002573;//kernel.Map:2573
      p=Math.floor(p);
      //$LASTPOS=32002595;//kernel.Map:2595
      _this.pImg=Tonyu.globals.$imageList[p];
      //$LASTPOS=32002649;//kernel.Map:2649
      if (! _this.pImg) {
        return _this;
      }
      //$LASTPOS=32002673;//kernel.Map:2673
      _this.ctx.save();
      //$LASTPOS=32002690;//kernel.Map:2690
      _this.ctx.drawImage(_this.pImg.image,_this.pImg.x,_this.pImg.y,_this.pImg.width,_this.pImg.height,setCol*_this.chipWidth,setRow*_this.chipHeight,_this.chipWidth,_this.chipHeight);
      //$LASTPOS=32002834;//kernel.Map:2834
      _this.ctx.restore();
    },
    ...
    setOnAt :function _trc_Map_setOnAt(setX,setY,p) {
      ...
      //$LASTPOS=32002881;//kernel.Map:2881
    ...
    setAt :function _trc_Map_setAt(setX,setY,p) {
      ...
      //$LASTPOS=32002976;//kernel.Map:2976
    ...
    get :function _trc_Map_get(getCol,getRow) {
      ...
      //$LASTPOS=32003069;//kernel.Map:3069
    ...
    getOn :function _trc_Map_getOn(getCol,getRow) {
      ...
      //$LASTPOS=32003301;//kernel.Map:3301
      if (getCol<_this.col&&getRow<_this.row&&getCol>=0&&getRow>=0) {
    ...
    scrollTo :function _trc_Map_scrollTo(scrollX,scrollY) {
      ...
      //$LASTPOS=32003544;//kernel.Map:3544
      _this.sx=- scrollX;
      //$LASTPOS=32003562;//kernel.Map:3562
      _this.sy=- scrollY;
    },
    ...
    draw :function _trc_Map_draw(ctx) {
      ...
      //$LASTPOS=32003597;//kernel.Map:3597
      _this.pImg=_this.buf[0];
      //$LASTPOS=32003615;//kernel.Map:3615
      ctx.save();
      //$LASTPOS=32003632;//kernel.Map:3632
      ctx.drawImage(_this.pImg,0,0,_this.col*_this.chipWidth,_this.row*_this.chipHeight,_this.sx,_this.sy,_this.col*_this.chipWidth,_this.row*_this.chipHeight);
      //$LASTPOS=32003744;//kernel.Map:3744
      ctx.restore();
    },
    __dummy: false
  },
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    initialize :function _trc_Panel_initialize(opt) {
      ...
      //$LASTPOS=33000104;//kernel.Panel:104
      _this.width=_this.width;
      //$LASTPOS=33000127;//kernel.Panel:127
      _this.height=_this.height;
      //$LASTPOS=33000152;//kernel.Panel:152
      if (_this.align==null) {
        //$LASTPOS=33000168;//kernel.Panel:168
        _this.align="center";
      }
      //$LASTPOS=33000189;//kernel.Panel:189
      if (_this.alpha==null) {
        //$LASTPOS=33000205;//kernel.Panel:205
        _this.alpha=255;
      }
      //$LASTPOS=33000221;//kernel.Panel:221
      if (_this._drawn==null) {
        //$LASTPOS=33000238;//kernel.Panel:238
        _this._drawn=false;
      }
      //$LASTPOS=33000257;//kernel.Panel:257
    ...
    setPanel :function _trc_Panel_setPanel(width,height) {
      ...
      //$LASTPOS=33000329;//kernel.Panel:329
      _this.width=width;
      //$LASTPOS=33000352;//kernel.Panel:352
      _this.height=height;
      //$LASTPOS=33000377;//kernel.Panel:377
      _this.buf=$("<canvas>").attr({width: width,height: height});
    },
    ...
    resize :function _trc_Panel_resize(width,height) {
      ...
      //$LASTPOS=33000447;//kernel.Panel:447
    ...
    getContext :function _trc_Panel_getContext() {
      ...
      //$LASTPOS=33000495;//kernel.Panel:495
      _this._drawn=true;
    ...
    __getter__context :function _trc_Panel___getter__context() {
      ...
      //$LASTPOS=33000565;//kernel.Panel:565
      _this._drawn=true;
      return _this.buf[0].getContext("2d");
    },
    __getter__image :function _trc_Panel___getter__image() {
      ...
      //$LASTPOS=33000633;//kernel.Panel:633
      _this._drawn=true;
      return _this.buf[0];
    },
    setFillStyle :function _trc_Panel_setFillStyle(color) {
      ...
      //$LASTPOS=33000697;//kernel.Panel:697
    ...
    fillRect :function _trc_Panel_fillRect(x,y,rectWidth,rectHeight) {
      ...
      //$LASTPOS=33000765;//kernel.Panel:765
      _this.ctx=_this.getContext();
      //$LASTPOS=33000788;//kernel.Panel:788
      _this.ctx.save();
      //$LASTPOS=33000855;//kernel.Panel:855
      _this.ctx.fillStyle=_this.fillStyle;
      //$LASTPOS=33000885;//kernel.Panel:885
      _this.ctx.fillRect(x,y,rectWidth,rectHeight);
      //$LASTPOS=33000930;//kernel.Panel:930
      _this.ctx.restore();
    },
    ...
    fillText :function _trc_Panel_fillText(text,x,y,size,align) {
      ...
      //$LASTPOS=33000986;//kernel.Panel:986
      _this.ctx=_this.getContext();
      //$LASTPOS=33001009;//kernel.Panel:1009
      _this.ctx.save();
      //$LASTPOS=33001026;//kernel.Panel:1026
      text=text+"";
      //$LASTPOS=33001045;//kernel.Panel:1045
      splits = text.split("\n");
      
      //$LASTPOS=33001131;//kernel.Panel:1131
      _this.ctx.textAlign=align;
      //$LASTPOS=33001159;//kernel.Panel:1159
      _this.ctx.fillStyle=_this.fillStyle;
      //$LASTPOS=33001189;//kernel.Panel:1189
      _this.ctx.font=size+"px 'Courier New'";
      //$LASTPOS=33001228;//kernel.Panel:1228
      //$LASTPOS=33001232;//kernel.Panel:1232
      colCount = 0;
      for (; colCount<splits.length ; colCount++) {
        {
          //$LASTPOS=33001292;//kernel.Panel:1292
          _this.ctx.fillText(splits[colCount],x,y);
          //$LASTPOS=33001337;//kernel.Panel:1337
          y+=size;
        }
      }
      //$LASTPOS=33001358;//kernel.Panel:1358
      _this.ctx.restore();
    },
    ...
    clearRect :function _trc_Panel_clearRect(clearX,clearY,clearW,clearH) {
      ...
      //$LASTPOS=33001423;//kernel.Panel:1423
      _this.ctx=_this.getContext();
      //$LASTPOS=33001446;//kernel.Panel:1446
      _this.ctx.save();
      //$LASTPOS=33001463;//kernel.Panel:1463
    ...
    getPixel :function _trc_Panel_getPixel(getX,getY) {
      ...
      //$LASTPOS=33001558;//kernel.Panel:1558
      if (typeof  getX=="number"&&! isNaN(getX)&&typeof  getY=="number"&&! isNaN(getY)) {
        //$LASTPOS=33001657;//kernel.Panel:1657
        _this.ctx=_this.getContext();
        //$LASTPOS=33001684;//kernel.Panel:1684
        _this.imagedata=_this.ctx.getImageData(getX,getY,1,1);
        //$LASTPOS=33001736;//kernel.Panel:1736
        _this.colordata=[_this.imagedata.data[0],_this.imagedata.data[1],_this.imagedata.data[2],_this.imagedata.data[3]];
        
      } else {
        //$LASTPOS=33001876;//kernel.Panel:1876
    ...
    scroll :function _trc_Panel_scroll(scrollX,scrollY) {
      ...
      //$LASTPOS=33001963;//kernel.Panel:1963
      _this.ctx=_this.getContext();
      //$LASTPOS=33001986;//kernel.Panel:1986
      _this.ctx.save();
      //$LASTPOS=33002003;//kernel.Panel:2003
      _this.imagedata=_this.ctx.getImageData(0,0,_this.width,_this.height);
      //$LASTPOS=33002064;//kernel.Panel:2064
      _this.clearRect(0,0,_this.width,_this.height);
      //$LASTPOS=33002098;//kernel.Panel:2098
      _this.ctx.putImageData(_this.imagedata,- scrollX,- scrollY);
      //$LASTPOS=33002150;//kernel.Panel:2150
      _this.ctx.restore();
    },
    ...
    draw :function _trc_Panel_draw(ctx) {
      ...
      //$LASTPOS=33002186;//kernel.Panel:2186
      if (_this._drawn) {
        //$LASTPOS=33002207;//kernel.Panel:2207
        _this.pImg=_this.buf[0];
        //$LASTPOS=33002229;//kernel.Panel:2229
        ctx.save();
        //$LASTPOS=33002250;//kernel.Panel:2250
        if (_this.align=="left") {
          //$LASTPOS=33002282;//kernel.Panel:2282
          ctx.translate(_this.x+_this.width/2,_this.y+_this.height/2);
          
        } else {
          //$LASTPOS=33002334;//kernel.Panel:2334
          if (_this.align=="center") {
            //$LASTPOS=33002368;//kernel.Panel:2368
            ctx.translate(_this.x,_this.y);
            
          } else {
            //$LASTPOS=33002403;//kernel.Panel:2403
            if (_this.align=="right") {
              //$LASTPOS=33002436;//kernel.Panel:2436
              ctx.translate(_this.x-_this.width/2,_this.y-_this.height/2);
        ...
        if (_this.rotation!=0) {
          //$LASTPOS=33002528;//kernel.Panel:2528
          ctx.rotate(_this.rotation/180*Math.PI);
          
        } else {
          //$LASTPOS=33002596;//kernel.Panel:2596
          ctx.rotate(_this.rotate/180*Math.PI);
          
        }
        //$LASTPOS=33002653;//kernel.Panel:2653
        ctx.globalAlpha=_this.alpha/255;
        //$LASTPOS=33002694;//kernel.Panel:2694
        ctx.drawImage(_this.pImg,0,0,_this.width,_this.height,- _this.width/2,- _this.height/2,_this.width,_this.height);
        //$LASTPOS=33002798;//kernel.Panel:2798
        ctx.restore();
    ...
    copy :function _trc_Panel_copy() {
      ...
      //$LASTPOS=33003043;//kernel.Panel:3043
      a = new Tonyu.classes.kernel.ArgParser(arguments);
      
      //$LASTPOS=33003080;//kernel.Panel:3080
      srcPanel = a.shift(Tonyu.classes.kernel.Panel)||_this;
      
      //$LASTPOS=33003122;//kernel.Panel:3122
      if (a.length<=4) {
        //$LASTPOS=33003150;//kernel.Panel:3150
        dx=a.shift();
        //$LASTPOS=33003173;//kernel.Panel:3173
        dy=a.shift();
        //$LASTPOS=33003196;//kernel.Panel:3196
        if (a.length==0) {
          //$LASTPOS=33003228;//kernel.Panel:3228
          _this.context.drawImage(srcPanel.image,dx,dy);
          
        } else {
          //$LASTPOS=33003301;//kernel.Panel:3301
          dw=a.shift();
          //$LASTPOS=33003328;//kernel.Panel:3328
          dh=a.shift();
          //$LASTPOS=33003355;//kernel.Panel:3355
          _this.context.drawImage(srcPanel.image,dx,dy,dw,dh);
          
        }
        
      } else {
        //$LASTPOS=33003436;//kernel.Panel:3436
        sx=a.shift();
        //$LASTPOS=33003459;//kernel.Panel:3459
        sy=a.shift();
        //$LASTPOS=33003482;//kernel.Panel:3482
        sw=a.shift();
        //$LASTPOS=33003505;//kernel.Panel:3505
        sh=a.shift();
        //$LASTPOS=33003528;//kernel.Panel:3528
        dx=a.shift();
        //$LASTPOS=33003551;//kernel.Panel:3551
        dy=a.shift();
        //$LASTPOS=33003574;//kernel.Panel:3574
        dw=a.shift()||sw;
        //$LASTPOS=33003603;//kernel.Panel:3603
        dh=a.shift()||sh;
        //$LASTPOS=33003682;//kernel.Panel:3682
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    draw :function _trc_Sprites_draw(cv) {
      ...
      //$LASTPOS=35001556;//kernel.Sprites:1556
      ctx = cv.getContext("2d");
      
      //$LASTPOS=35001590;//kernel.Sprites:1590
      ctx.save();
      //$LASTPOS=35001607;//kernel.Sprites:1607
      orderArray = [];
      
      //$LASTPOS=35001631;//kernel.Sprites:1631
      if (_this.t1Sprites) {
        //$LASTPOS=35001657;//kernel.Sprites:1657
        _this.sprites.forEach((function anonymous_1673(s) {
          
          //$LASTPOS=35001693;//kernel.Sprites:1693
          if (s instanceof Tonyu.classes.kernel.PlainChar) {
            //$LASTPOS=35001740;//kernel.Sprites:1740
            s.draw();
            
          } else {
            //$LASTPOS=35001770;//kernel.Sprites:1770
            orderArray.push(s);
          }
        }));
        
      } else {
        //$LASTPOS=35001825;//kernel.Sprites:1825
        orderArray=orderArray.concat(_this.sprites);
        
      }
      //$LASTPOS=35001876;//kernel.Sprites:1876
      orderArray.sort(Tonyu.bindFunc(_this,_this.compOrder));
      //$LASTPOS=35001909;//kernel.Sprites:1909
      ctx.translate(- _this.sx,- _this.sy);
      //$LASTPOS=35001938;//kernel.Sprites:1938
      _this.drawing=ctx;
      //$LASTPOS=35001956;//kernel.Sprites:1956
      orderArray.forEach((function anonymous_1975(s) {
        
        //$LASTPOS=35001990;//kernel.Sprites:1990
        s.draw(ctx);
      }));
      //$LASTPOS=35002017;//kernel.Sprites:2017
      _this.drawing=null;
      //$LASTPOS=35002036;//kernel.Sprites:2036
      ctx.restore();
    },
    checkHit :function _trc_Sprites_checkHit() {
      ...
      //$LASTPOS=35002082;//kernel.Sprites:2082
      _this.hitWatchers.forEach((function anonymous_2102(w) {
        
        //$LASTPOS=35002126;//kernel.Sprites:2126
        _this.sprites.forEach((function anonymous_2142(a) {
          var a_owner;
          
          //$LASTPOS=35002214;//kernel.Sprites:2214
          a_owner = a;
          
          //$LASTPOS=35002256;//kernel.Sprites:2256
          if (! (a_owner instanceof w.A)) {
            return _this;
          }
          //$LASTPOS=35002309;//kernel.Sprites:2309
          _this.sprites.forEach((function anonymous_2325(b) {
            var b_owner;
            
            //$LASTPOS=35002357;//kernel.Sprites:2357
            b_owner = b;
            
            //$LASTPOS=35002403;//kernel.Sprites:2403
            if (a===b) {
              return _this;
            }
            //$LASTPOS=35002439;//kernel.Sprites:2439
            if (! (b_owner instanceof w.B)) {
              return _this;
            }
            //$LASTPOS=35002544;//kernel.Sprites:2544
            if (a.crashTo1(b)) {
              //$LASTPOS=35002647;//kernel.Sprites:2647
              w.h(a_owner,b_owner);
    ...
    watchHit :function _trc_Sprites_watchHit(typeA,typeB,onHit) {
      ...
      //$LASTPOS=35002777;//kernel.Sprites:2777
      p = {A: typeA,B: typeB,h: onHit};
      
      //$LASTPOS=35002841;//kernel.Sprites:2841
    ...
    drawGrid :function _trc_Sprites_drawGrid(c) {
      ...
      //$LASTPOS=35002894;//kernel.Sprites:2894
      ctx = c.getContext("2d");
      
      //$LASTPOS=35002927;//kernel.Sprites:2927
      ctx.textBaseline="top";
      //$LASTPOS=35002956;//kernel.Sprites:2956
      ctx.save();
      //$LASTPOS=35002973;//kernel.Sprites:2973
      ctx.strokeStyle="rgb(40,100,200)";
      //$LASTPOS=35003013;//kernel.Sprites:3013
      //$LASTPOS=35003018;//kernel.Sprites:3018
      i = 0;
      for (; i<c.width ; i+=10) {
        {
          //$LASTPOS=35003058;//kernel.Sprites:3058
          ctx.beginPath();
          //$LASTPOS=35003084;//kernel.Sprites:3084
          ctx.lineWidth=(i%100==0?4:1);
          //$LASTPOS=35003130;//kernel.Sprites:3130
          ctx.moveTo(i,0);
          //$LASTPOS=35003156;//kernel.Sprites:3156
          ctx.lineTo(i,c.height);
          //$LASTPOS=35003189;//kernel.Sprites:3189
          ctx.closePath();
          //$LASTPOS=35003215;//kernel.Sprites:3215
          ctx.stroke();
        }
      }
      //$LASTPOS=35003243;//kernel.Sprites:3243
      //$LASTPOS=35003248;//kernel.Sprites:3248
      i = 0;
      for (; i<c.height ; i+=10) {
        {
          //$LASTPOS=35003289;//kernel.Sprites:3289
          ctx.beginPath();
          //$LASTPOS=35003315;//kernel.Sprites:3315
          ctx.lineWidth=(i%100==0?4:1);
          //$LASTPOS=35003361;//kernel.Sprites:3361
          ctx.moveTo(0,i);
          //$LASTPOS=35003387;//kernel.Sprites:3387
          ctx.lineTo(c.width,i);
          //$LASTPOS=35003419;//kernel.Sprites:3419
          ctx.closePath();
          //$LASTPOS=35003445;//kernel.Sprites:3445
          ctx.stroke();
        }
      }
      //$LASTPOS=35003471;//kernel.Sprites:3471
      ctx.fillStyle="white";
      //$LASTPOS=35003499;//kernel.Sprites:3499
      ctx.font="15px monospaced";
      //$LASTPOS=35003532;//kernel.Sprites:3532
      //$LASTPOS=35003537;//kernel.Sprites:3537
      i = 100;
      for (; i<c.width ; i+=100) {
        {
          //$LASTPOS=35003580;//kernel.Sprites:3580
          ctx.fillText(i,i,0);
        }
      }
      //$LASTPOS=35003614;//kernel.Sprites:3614
      //$LASTPOS=35003619;//kernel.Sprites:3619
      i = 100;
      for (; i<c.height ; i+=100) {
        {
          //$LASTPOS=35003663;//kernel.Sprites:3663
          ctx.fillText(i,0,i);
        }
      }
      //$LASTPOS=35003697;//kernel.Sprites:3697
      ctx.restore();
    },
    ...
    setImageList :function _trc_Sprites_setImageList(il) {
      ...
      //$LASTPOS=35003749;//kernel.Sprites:3749
      _this.imageList=il;
    },
    ...
    scrollTo :function _trc_Sprites_scrollTo(scrollX,scrollY) {
      ...
      //$LASTPOS=35003861;//kernel.Sprites:3861
      _this.sx=scrollX;
      //$LASTPOS=35003878;//kernel.Sprites:3878
      _this.sy=scrollY;
    },
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    initialize :function _trc_PlainChar_initialize(x,y,p) {
      ...
      if (typeof  x=="object") {
        //$LASTPOS=39000192;//kernel.PlainChar:192
        Tonyu.extend(_this,x);
      } else {
        //$LASTPOS=39000224;//kernel.PlainChar:224
        if (typeof  x=="number") {
          //$LASTPOS=39000259;//kernel.PlainChar:259
          _this.x=x;
          //$LASTPOS=39000278;//kernel.PlainChar:278
          _this.y=y;
          //$LASTPOS=39000297;//kernel.PlainChar:297
          _this.p=p;
    ...
    draw :function _trc_PlainChar_draw(c) {
      ...
      //$LASTPOS=39000334;//kernel.PlainChar:334
      _this.onDraw();
      //$LASTPOS=39000349;//kernel.PlainChar:349
    ...
    setVisible :function _trc_PlainChar_setVisible(v) {
      ...
      //$LASTPOS=39000423;//kernel.PlainChar:423
      _this._isInvisible=! v;
    },
    ...
    update :function _trc_PlainChar_update() {
      ...
      //$LASTPOS=39000479;//kernel.PlainChar:479
      _this.onUpdate();
      //$LASTPOS=39000496;//kernel.PlainChar:496
    ...
    initSprite :function _trc_PlainChar_initSprite() {
      ...
      //$LASTPOS=39000557;//kernel.PlainChar:557
      if (_this.layer&&typeof  _this.layer.add=="function") {
        //$LASTPOS=39000609;//kernel.PlainChar:609
        _this.layer.add(_this);
        
      } else {
        //$LASTPOS=39000647;//kernel.PlainChar:647
        Tonyu.globals.$Sprites.add(_this);
        
      }
      //$LASTPOS=39000679;//kernel.PlainChar:679
      _this.onAppear();
    },
    ...
    tMain :function _trc_PlainChar_tMain() {
      ...
      //$LASTPOS=39000711;//kernel.PlainChar:711
      _this.main();
      //$LASTPOS=39000724;//kernel.PlainChar:724
      _this.die();
    },
...
Tonyu.klass.define({
  ...
  methods: {
    main :function _trc_MapEditor_main() {
      ...
      //$LASTPOS=46003264;//kernel.MapEditor:3264
      ...
      //$LASTPOS=46003346;//kernel.MapEditor:3346
      _this.counter=0;
      //$LASTPOS=46003358;//kernel.MapEditor:3358
      //$LASTPOS=46003362;//kernel.MapEditor:3362
      _this.i = 0;
      for (; _this.i<Tonyu.globals.$mp.row ; _this.i++) {
        {
          //$LASTPOS=46003391;//kernel.MapEditor:3391
          //$LASTPOS=46003395;//kernel.MapEditor:3395
          _this.j = 0;
          for (; _this.j<Tonyu.globals.$mp.col ; _this.j++) {
            {
              //$LASTPOS=46003428;//kernel.MapEditor:3428
              Tonyu.globals.$mp.set(_this.j,_this.i,Tonyu.globals.$pat_mapchip+_this.counter);
              //$LASTPOS=46003472;//kernel.MapEditor:3472
              _this.counter++;
            }
          }
        }
      }
      //$LASTPOS=46003496;//kernel.MapEditor:3496
      Tonyu.globals.$consolePanel.clearRect(0,0,Tonyu.globals.$screenWidth,Tonyu.globals.$screenHeight);
      //$LASTPOS=46003576;//kernel.MapEditor:3576
      _this.mode="get";
      //$LASTPOS=46003589;//kernel.MapEditor:3589
      _this.prevMode="set";
      //$LASTPOS=46003606;//kernel.MapEditor:3606
      _this.mapp=0;
      //$LASTPOS=46003615;//kernel.MapEditor:3615
      _this.maponp=- 1;
      //$LASTPOS=46003627;//kernel.MapEditor:3627
      _this.mx=- 40;
      //$LASTPOS=46003636;//kernel.MapEditor:3636
      _this.my=- 40;
      //$LASTPOS=46003645;//kernel.MapEditor:3645
      _this.chipX=- 40;
      //$LASTPOS=46003657;//kernel.MapEditor:3657
      _this.chipY=- 40;
      //$LASTPOS=46003669;//kernel.MapEditor:3669
      _this.x=Tonyu.globals.$screenWidth-_this.chipWidth/2;
      //$LASTPOS=46003698;//kernel.MapEditor:3698
      _this.y=Tonyu.globals.$screenHeight-_this.chipHeight/2;
      //$LASTPOS=46003729;//kernel.MapEditor:3729
      Tonyu.globals.$map.scrollTo(_this.mx,_this.my);
      //$LASTPOS=46003754;//kernel.MapEditor:3754
      _this.initialWidth=Tonyu.globals.$map.chipWidth;
      //$LASTPOS=46003784;//kernel.MapEditor:3784
      _this.initialHeight=Tonyu.globals.$map.chipHeight;
      //$LASTPOS=46003816;//kernel.MapEditor:3816
      _this.layers=["base","on","all"];
      //$LASTPOS=46003845;//kernel.MapEditor:3845
      _this.lc=0;
      //$LASTPOS=46003852;//kernel.MapEditor:3852
      _this.selectedLayer=_this.layers[_this.lc];
      //$LASTPOS=46003879;//kernel.MapEditor:3879
      _this.drawPanel();
      //$LASTPOS=46003893;//kernel.MapEditor:3893
      _this.drawLetter(_this.mode);
      //$LASTPOS=46003914;//kernel.MapEditor:3914
      while (true) {
        //$LASTPOS=46003932;//kernel.MapEditor:3932
        _this.p=_this.mapp;
        //$LASTPOS=46003945;//kernel.MapEditor:3945
        if (Tonyu.globals.$touches[0].touched==1&&Tonyu.globals.$touches[0].x>0&&Tonyu.globals.$touches[0].x<120&&Tonyu.globals.$touches[0].y>560&&Tonyu.globals.$touches[0].y<640) {
          //$LASTPOS=46004064;//kernel.MapEditor:4064
          Tonyu.globals.$mp.scrollTo(1000,1000);
          //$LASTPOS=46004098;//kernel.MapEditor:4098
          _this.mode="erase";
          //$LASTPOS=46004153;//kernel.MapEditor:4153
          _this.drawLetter(_this.mode);
          
        }
        //$LASTPOS=46004183;//kernel.MapEditor:4183
        if (Tonyu.globals.$touches[0].touched==1&&Tonyu.globals.$touches[0].x>0&&Tonyu.globals.$touches[0].x<120&&Tonyu.globals.$touches[0].y>480&&Tonyu.globals.$touches[0].y<560) {
          //$LASTPOS=46004302;//kernel.MapEditor:4302
          Tonyu.globals.$mp.scrollTo(1000,1000);
          //$LASTPOS=46004336;//kernel.MapEditor:4336
          _this.mode="set";
          //$LASTPOS=46004357;//kernel.MapEditor:4357
          _this.drawLetter(_this.mode);
          
        }
        //$LASTPOS=46004387;//kernel.MapEditor:4387
        if (Tonyu.globals.$touches[0].touched==1&&Tonyu.globals.$touches[0].x>120&&Tonyu.globals.$touches[0].x<240&&Tonyu.globals.$touches[0].y>480&&Tonyu.globals.$touches[0].y<560) {
          //$LASTPOS=46004508;//kernel.MapEditor:4508
          _this.lc++;
          //$LASTPOS=46004523;//kernel.MapEditor:4523
          _this.selectedLayer=_this.layers[_this.lc%3];
          //$LASTPOS=46004560;//kernel.MapEditor:4560
          _this.drawPanel();
          //$LASTPOS=46004614;//kernel.MapEditor:4614
          _this.drawLetter(_this.mode);
          
        }
        //$LASTPOS=46004737;//kernel.MapEditor:4737
        if (Tonyu.globals.$touches[0].touched==1&&Tonyu.globals.$touches[0].x>240&&Tonyu.globals.$touches[0].x<360&&Tonyu.globals.$touches[0].y>480&&Tonyu.globals.$touches[0].y<560) {
          //$LASTPOS=46004858;//kernel.MapEditor:4858
          if (_this.mode!="get") {
            //$LASTPOS=46004888;//kernel.MapEditor:4888
            _this.prevMode=_this.mode;
            //$LASTPOS=46004916;//kernel.MapEditor:4916
            Tonyu.globals.$mp.scrollTo(- 40,- 40);
            //$LASTPOS=46004952;//kernel.MapEditor:4952
            _this.mode="get";
            //$LASTPOS=46004977;//kernel.MapEditor:4977
            _this.chipX=- 40;
            //$LASTPOS=46005001;//kernel.MapEditor:5001
            _this.chipY=- 40;
            
          } else {
            //$LASTPOS=46005041;//kernel.MapEditor:5041
            Tonyu.globals.$mp.scrollTo(1000,1000);
            //$LASTPOS=46005079;//kernel.MapEditor:5079
            _this.mode=_this.prevMode;
            
          }
          //$LASTPOS=46005146;//kernel.MapEditor:5146
          _this.drawLetter(_this.mode);
          
        }
        //$LASTPOS=46005176;//kernel.MapEditor:5176
        if (Tonyu.globals.$touches[0].touched==1&&Tonyu.globals.$touches[0].x>360&&Tonyu.globals.$touches[0].x<480&&Tonyu.globals.$touches[0].y>480&&Tonyu.globals.$touches[0].y<560) {
          //$LASTPOS=46005312;//kernel.MapEditor:5312
          if (_this.loadedFile) {
            //$LASTPOS=46005341;//kernel.MapEditor:5341
            _this.saveFileName=_this.prompt("input json file(*.json)",_this.loadedFile);
            
          } else {
            //$LASTPOS=46005429;//kernel.MapEditor:5429
            _this.saveFileName=_this.prompt("input json file(*.json)","map.json");
            
          }
          //$LASTPOS=46005523;//kernel.MapEditor:5523
          if (_this.saveFileName) {
            //$LASTPOS=46005554;//kernel.MapEditor:5554
            _this.saveDataFile=_this.file("../maps/").rel(_this.saveFileName);
            //$LASTPOS=46005616;//kernel.MapEditor:5616
            ...
            //$LASTPOS=46005778;//kernel.MapEditor:5778
            _this.saveDataFile.obj(_this.data);
            //$LASTPOS=46005815;//kernel.MapEditor:5815
            _this.print(_this.saveFileName+" Saved");
            
          }
          
        }
        //$LASTPOS=46005868;//kernel.MapEditor:5868
        if (Tonyu.globals.$touches[0].touched==1&&Tonyu.globals.$touches[0].x>120&&Tonyu.globals.$touches[0].x<240&&Tonyu.globals.$touches[0].y>560&&Tonyu.globals.$touches[0].y<640) {
          //$LASTPOS=46005989;//kernel.MapEditor:5989
          Tonyu.globals.$mp.scrollTo(1000,1000);
          //$LASTPOS=46006023;//kernel.MapEditor:6023
          _this.mode="copy";
          //$LASTPOS=46006077;//kernel.MapEditor:6077
          _this.drawLetter(_this.mode);
          
        }
        //$LASTPOS=46006107;//kernel.MapEditor:6107
        if (_this.mode!="get") {
          //$LASTPOS=46006133;//kernel.MapEditor:6133
          if (_this.getkey("left")>0||(Tonyu.globals.$touches[0].touched&&Tonyu.globals.$touches[0].x>0&&Tonyu.globals.$touches[0].x<40&&Tonyu.globals.$touches[0].y<480)) {
            //$LASTPOS=46006239;//kernel.MapEditor:6239
            _this.mx=_this.mx-8;
          }
          //$LASTPOS=46006257;//kernel.MapEditor:6257
          if (_this.getkey("right")>0||(Tonyu.globals.$touches[0].touched&&Tonyu.globals.$touches[0].x>Tonyu.globals.$screenWidth-40&&Tonyu.globals.$touches[0].x<Tonyu.globals.$screenWidth&&Tonyu.globals.$touches[0].y<480)) {
            //$LASTPOS=46006388;//kernel.MapEditor:6388
            _this.mx=_this.mx+8;
          }
          //$LASTPOS=46006406;//kernel.MapEditor:6406
          if (_this.getkey("up")>0||(Tonyu.globals.$touches[0].touched&&Tonyu.globals.$touches[0].x>0&&Tonyu.globals.$touches[0].x<Tonyu.globals.$screenWidth&&Tonyu.globals.$touches[0].y<40)) {
            //$LASTPOS=46006519;//kernel.MapEditor:6519
            _this.my=_this.my-8;
          }
          //$LASTPOS=46006537;//kernel.MapEditor:6537
          if (_this.getkey("down")>0||(Tonyu.globals.$touches[0].touched&&Tonyu.globals.$touches[0].x>0&&Tonyu.globals.$touches[0].x<Tonyu.globals.$screenWidth&&Tonyu.globals.$touches[0].y<480&&Tonyu.globals.$touches[0].y>440)) {
            //$LASTPOS=46006672;//kernel.MapEditor:6672
            _this.my=_this.my+8;
          }
          //$LASTPOS=46006690;//kernel.MapEditor:6690
          Tonyu.globals.$map.scrollTo(_this.mx,_this.my);
          
        } else {
          //$LASTPOS=46006733;//kernel.MapEditor:6733
          if (_this.getkey("left")>0||(Tonyu.globals.$touches[0].touched&&Tonyu.globals.$touches[0].x>0&&Tonyu.globals.$touches[0].x<40&&Tonyu.globals.$touches[0].y<480)) {
            //$LASTPOS=46006839;//kernel.MapEditor:6839
            _this.chipX=_this.chipX-8;
          }
          //$LASTPOS=46006863;//kernel.MapEditor:6863
          if (_this.getkey("right")>0||(Tonyu.globals.$touches[0].touched&&Tonyu.globals.$touches[0].x>Tonyu.globals.$screenWidth-40&&Tonyu.globals.$touches[0].x<Tonyu.globals.$screenWidth&&Tonyu.globals.$touches[0].y<480)) {
            //$LASTPOS=46006994;//kernel.MapEditor:6994
            _this.chipX=_this.chipX+8;
          }
          //$LASTPOS=46007018;//kernel.MapEditor:7018
          if (_this.getkey("up")>0||(Tonyu.globals.$touches[0].touched&&Tonyu.globals.$touches[0].x>0&&Tonyu.globals.$touches[0].x<Tonyu.globals.$screenWidth&&Tonyu.globals.$touches[0].y<40)) {
            //$LASTPOS=46007131;//kernel.MapEditor:7131
            _this.chipY=_this.chipY-8;
          }
          //$LASTPOS=46007155;//kernel.MapEditor:7155
          if (_this.getkey("down")>0||(Tonyu.globals.$touches[0].touched&&Tonyu.globals.$touches[0].x>0&&Tonyu.globals.$touches[0].x<Tonyu.globals.$screenWidth&&Tonyu.globals.$touches[0].y<480&&Tonyu.globals.$touches[0].y>440)) {
            //$LASTPOS=46007290;//kernel.MapEditor:7290
            _this.chipY=_this.chipY+8;
          }
          //$LASTPOS=46007314;//kernel.MapEditor:7314
          Tonyu.globals.$mp.scrollTo(_this.chipX,_this.chipY);
          
        }
        //$LASTPOS=46007387;//kernel.MapEditor:7387
        if (_this.getkey("i")==1) {
          //$LASTPOS=46007416;//kernel.MapEditor:7416
          if (Tonyu.globals.$map.chipWidth<_this.initialWidth) {
            //$LASTPOS=46007448;//kernel.MapEditor:7448
            Tonyu.globals.$map.chipWidth+=4;
          }
          //$LASTPOS=46007476;//kernel.MapEditor:7476
          if (Tonyu.globals.$map.chipHeight<_this.initialHeight) {
            //$LASTPOS=46007510;//kernel.MapEditor:7510
            Tonyu.globals.$map.chipHeight+=4;
          }
          //$LASTPOS=46007539;//kernel.MapEditor:7539
          Tonyu.globals.$map.redrawMap();
          //$LASTPOS=46007566;//kernel.MapEditor:7566
          _this.panel.die();
          //$LASTPOS=46007588;//kernel.MapEditor:7588
          _this.panel=new Tonyu.classes.kernel.Panel({width: Tonyu.globals.$map.col*Tonyu.globals.$map.chipWidth,height: Tonyu.globals.$map.row*Tonyu.globals.$map.chipHeight,zOrder: 100});
          //$LASTPOS=46007688;//kernel.MapEditor:7688
          _this.panel.x=_this.panel.width/2+40;
          //$LASTPOS=46007723;//kernel.MapEditor:7723
          _this.panel.y=_this.panel.height/2+40;
          //$LASTPOS=46007759;//kernel.MapEditor:7759
          _this.panel.setFillStyle("cyan");
          //$LASTPOS=46007796;//kernel.MapEditor:7796
          _this.panel.fillRect(0,0,_this.panel.width,_this.panel.height);
          
        }
        //$LASTPOS=46007854;//kernel.MapEditor:7854
        if (_this.getkey("o")==1) {
          //$LASTPOS=46007883;//kernel.MapEditor:7883
          if (Tonyu.globals.$map.chipWidth>4) {
            //$LASTPOS=46007904;//kernel.MapEditor:7904
            Tonyu.globals.$map.chipWidth-=4;
          }
          //$LASTPOS=46007932;//kernel.MapEditor:7932
          if (Tonyu.globals.$map.chipHeight>4) {
            //$LASTPOS=46007954;//kernel.MapEditor:7954
            Tonyu.globals.$map.chipHeight-=4;
          }
          //$LASTPOS=46007983;//kernel.MapEditor:7983
          Tonyu.globals.$map.redrawMap();
          //$LASTPOS=46008010;//kernel.MapEditor:8010
          _this.panel.die();
          //$LASTPOS=46008032;//kernel.MapEditor:8032
          _this.panel=new Tonyu.classes.kernel.Panel({width: Tonyu.globals.$map.col*Tonyu.globals.$map.chipWidth,height: Tonyu.globals.$map.row*Tonyu.globals.$map.chipHeight,zOrder: 100});
          //$LASTPOS=46008132;//kernel.MapEditor:8132
          _this.panel.x=_this.panel.width/2+40;
          //$LASTPOS=46008167;//kernel.MapEditor:8167
          _this.panel.y=_this.panel.height/2+40;
          //$LASTPOS=46008203;//kernel.MapEditor:8203
          _this.panel.setFillStyle("cyan");
          //$LASTPOS=46008240;//kernel.MapEditor:8240
          _this.panel.fillRect(0,0,_this.panel.width,_this.panel.height);
          
        }
        //$LASTPOS=46008332;//kernel.MapEditor:8332
        _this.panel.x=_this.panel.width/2-_this.mx;
        //$LASTPOS=46008363;//kernel.MapEditor:8363
        _this.panel.y=_this.panel.height/2-_this.my;
        //$LASTPOS=46008395;//kernel.MapEditor:8395
        if (_this.mode=="set"&&_this.getkey(1)>0&&_this.inRect()) {
          //$LASTPOS=46008448;//kernel.MapEditor:8448
          if (_this.selectedLayer=="base") {
            //$LASTPOS=46008488;//kernel.MapEditor:8488
            _this.tmpon=Tonyu.globals.$map.getOnAt(Tonyu.globals.$mouseX+_this.mx,Tonyu.globals.$mouseY+_this.my);
            //$LASTPOS=46008544;//kernel.MapEditor:8544
            Tonyu.globals.$map.setAt(Tonyu.globals.$mouseX+_this.mx,Tonyu.globals.$mouseY+_this.my,_this.mapp);
            //$LASTPOS=46008597;//kernel.MapEditor:8597
            Tonyu.globals.$map.setOnAt(Tonyu.globals.$mouseX+_this.mx,Tonyu.globals.$mouseY+_this.my,_this.tmpon);
            
          } else {
            //$LASTPOS=46008655;//kernel.MapEditor:8655
            if (_this.selectedLayer=="on") {
              //$LASTPOS=46008693;//kernel.MapEditor:8693
              Tonyu.globals.$map.setOnAt(Tonyu.globals.$mouseX+_this.mx,Tonyu.globals.$mouseY+_this.my,_this.mapp);
              
            } else {
              //$LASTPOS=46008764;//kernel.MapEditor:8764
              Tonyu.globals.$map.setAt(Tonyu.globals.$mouseX+_this.mx,Tonyu.globals.$mouseY+_this.my,_this.mapp);
              //$LASTPOS=46008817;//kernel.MapEditor:8817
          ...
          //$LASTPOS=46008883;//kernel.MapEditor:8883
          if (_this.mode=="erase"&&_this.getkey(1)>0&&_this.inRect()) {
            //$LASTPOS=46008938;//kernel.MapEditor:8938
            if (_this.selectedLayer=="base") {
              //$LASTPOS=46008978;//kernel.MapEditor:8978
              _this.tmpon=Tonyu.globals.$map.getOnAt(Tonyu.globals.$mouseX+_this.mx,Tonyu.globals.$mouseY+_this.my);
              //$LASTPOS=46009034;//kernel.MapEditor:9034
              Tonyu.globals.$map.setAt(Tonyu.globals.$mouseX+_this.mx,Tonyu.globals.$mouseY+_this.my,- 1);
              //$LASTPOS=46009085;//kernel.MapEditor:9085
              Tonyu.globals.$map.setOnAt(Tonyu.globals.$mouseX+_this.mx,Tonyu.globals.$mouseY+_this.my,_this.tmpon);
              
            } else {
              //$LASTPOS=46009143;//kernel.MapEditor:9143
              if (_this.selectedLayer=="on") {
                //$LASTPOS=46009181;//kernel.MapEditor:9181
                Tonyu.globals.$map.setOnAt(Tonyu.globals.$mouseX+_this.mx,Tonyu.globals.$mouseY+_this.my,- 1);
                
              } else {
                //$LASTPOS=46009250;//kernel.MapEditor:9250
                Tonyu.globals.$map.setAt(Tonyu.globals.$mouseX+_this.mx,Tonyu.globals.$mouseY+_this.my,- 1);
                //$LASTPOS=46009301;//kernel.MapEditor:9301
                Tonyu.globals.$map.setOnAt(Tonyu.globals.$mouseX+_this.mx,Tonyu.globals.$mouseY+_this.my,- 1);
            ...
            //$LASTPOS=46009363;//kernel.MapEditor:9363
            if (_this.mode=="get"&&_this.getkey(1)>0&&_this.inRect()) {
              //$LASTPOS=46009416;//kernel.MapEditor:9416
              _this.mapp=Tonyu.globals.$mp.getAt(Tonyu.globals.$mouseX+_this.chipX,Tonyu.globals.$mouseY+_this.chipY);
              //$LASTPOS=46009496;//kernel.MapEditor:9496
              _this.mode="set";
              //$LASTPOS=46009517;//kernel.MapEditor:9517
              Tonyu.globals.$mp.scrollTo(1000,1000);
              //$LASTPOS=46009583;//kernel.MapEditor:9583
              _this.drawLetter(_this.mode);
              //$LASTPOS=46009610;//kernel.MapEditor:9610
              _this.updateEx(10);
              
            } else {
              //$LASTPOS=46009635;//kernel.MapEditor:9635
              if (_this.mode=="setOn"&&_this.getkey(1)>0&&_this.inRect()) {
                //$LASTPOS=46009690;//kernel.MapEditor:9690
                Tonyu.globals.$map.setOnAt(Tonyu.globals.$mouseX+_this.mx,Tonyu.globals.$mouseY+_this.my,_this.mapp);
                
              } else {
                //$LASTPOS=46009743;//kernel.MapEditor:9743
                if (_this.mode=="copy"&&_this.getkey(1)>0&&_this.inRect()) {
                  //$LASTPOS=46009797;//kernel.MapEditor:9797
                  if (_this.selectedLayer=="base") {
                    //$LASTPOS=46009837;//kernel.MapEditor:9837
                    _this.mapp=Tonyu.globals.$map.getAt(Tonyu.globals.$mouseX+_this.mx,Tonyu.globals.$mouseY+_this.my);
                    //$LASTPOS=46009890;//kernel.MapEditor:9890
                    _this.maponp=- 1;
                    
                  } else {
                    //$LASTPOS=46009916;//kernel.MapEditor:9916
                    if (_this.selectedLayer=="on") {
                      //$LASTPOS=46009954;//kernel.MapEditor:9954
                      _this.mapp=Tonyu.globals.$map.getOnAt(Tonyu.globals.$mouseX+_this.mx,Tonyu.globals.$mouseY+_this.my);
                      
                    } else {
                      //$LASTPOS=46010025;//kernel.MapEditor:10025
                      _this.mapp=Tonyu.globals.$map.getAt(Tonyu.globals.$mouseX+_this.mx,Tonyu.globals.$mouseY+_this.my);
                      //$LASTPOS=46010078;//kernel.MapEditor:10078
                      _this.maponp=Tonyu.globals.$map.getOnAt(Tonyu.globals.$mouseX+_this.mx,Tonyu.globals.$mouseY+_this.my);
                      
                    }
                  }
                  //$LASTPOS=46010203;//kernel.MapEditor:10203
                  _this.mode="set";
                  //$LASTPOS=46010256;//kernel.MapEditor:10256
                  _this.drawLetter(_this.mode);
                  //$LASTPOS=46010283;//kernel.MapEditor:10283
                  _this.updateEx(10);
        ...
        //$LASTPOS=46010309;//kernel.MapEditor:10309
        _this.update();
    ...
    drawLetter :function _trc_MapEditor_drawLetter(mode) {
      ...
      //$LASTPOS=46012324;//kernel.MapEditor:12324
      if (mode=="set") {
        //$LASTPOS=46012340;//kernel.MapEditor:12340
        Tonyu.globals.$panel.setFillStyle("red");
      } else {
        //$LASTPOS=46012378;//kernel.MapEditor:12378
        Tonyu.globals.$panel.setFillStyle("black");
      }
      //$LASTPOS=46012413;//kernel.MapEditor:12413
      Tonyu.globals.$panel.fillText("set",Tonyu.globals.$screenWidth/4-60,Tonyu.globals.$screenHeight-110,40,"center");
      //$LASTPOS=46012490;//kernel.MapEditor:12490
      if (mode=="get") {
        //$LASTPOS=46012506;//kernel.MapEditor:12506
        Tonyu.globals.$panel.setFillStyle("red");
      } else {
        //$LASTPOS=46012544;//kernel.MapEditor:12544
        Tonyu.globals.$panel.setFillStyle("black");
      }
      //$LASTPOS=46012579;//kernel.MapEditor:12579
      Tonyu.globals.$panel.fillText("get",Tonyu.globals.$screenWidth/2+60,Tonyu.globals.$screenHeight-110,40,"center");
      //$LASTPOS=46012656;//kernel.MapEditor:12656
      if (mode=="erase") {
        //$LASTPOS=46012674;//kernel.MapEditor:12674
        Tonyu.globals.$panel.setFillStyle("red");
      } else {
        //$LASTPOS=46012712;//kernel.MapEditor:12712
        Tonyu.globals.$panel.setFillStyle("black");
      }
      //$LASTPOS=46012747;//kernel.MapEditor:12747
      Tonyu.globals.$panel.fillText("erase",Tonyu.globals.$screenWidth/4-60,Tonyu.globals.$screenHeight-30,35,"center");
      //$LASTPOS=46012825;//kernel.MapEditor:12825
      if (mode=="copy") {
        //$LASTPOS=46012842;//kernel.MapEditor:12842
        Tonyu.globals.$panel.setFillStyle("red");
      } else {
        //$LASTPOS=46012880;//kernel.MapEditor:12880
        Tonyu.globals.$panel.setFillStyle("black");
      }
      //$LASTPOS=46012915;//kernel.MapEditor:12915
      Tonyu.globals.$panel.fillText("copy",Tonyu.globals.$screenWidth/4+60,Tonyu.globals.$screenHeight-30,35,"center");
      //$LASTPOS=46012992;//kernel.MapEditor:12992
      Tonyu.globals.$panel.setFillStyle("black");
      //$LASTPOS=46013027;//kernel.MapEditor:13027
      Tonyu.globals.$panel.fillText(_this.selectedLayer,Tonyu.globals.$screenWidth/4+60,Tonyu.globals.$screenHeight-110,35,"center");
      //$LASTPOS=46013112;//kernel.MapEditor:13112
      Tonyu.globals.$panel.fillText("save",Tonyu.globals.$screenWidth-60,Tonyu.globals.$screenHeight-110,40,"center");
    },
...
Tonyu.klass.define({
  ...
  methods: {
    main :function _trc_Boot_main() {
      ...
      //$LASTPOS=50002184;//kernel.Boot:2184
      Tonyu.globals.$Boot=_this;
      //$LASTPOS=50002197;//kernel.Boot:2197
      _this.initEvents();
      //$LASTPOS=50002212;//kernel.Boot:2212
      _this.loadPlugins();
      //$LASTPOS=50002228;//kernel.Boot:2228
      _this.initSprites();
      //$LASTPOS=50002244;//kernel.Boot:2244
      _this.initSounds();
      //$LASTPOS=50002259;//kernel.Boot:2259
      Tonyu.globals.$InputDevice=new Tonyu.classes.kernel.InputDevice;
      //$LASTPOS=50002290;//kernel.Boot:2290
      Tonyu.globals.$InputDevice.initCanvasEvents(_this.cvj);
      //$LASTPOS=50002327;//kernel.Boot:2327
      _this.initThread();
      //$LASTPOS=50002344;//kernel.Boot:2344
      Tonyu.globals.$ObjectPool=new Tonyu.classes.kernel.ObjectPool;
      //$LASTPOS=50002373;//kernel.Boot:2373
      Tonyu.globals.$pat_fruits=30;
      //$LASTPOS=50002390;//kernel.Boot:2390
      Tonyu.globals.$Keys=new Tonyu.classes.kernel.Keys;
      //$LASTPOS=50002407;//kernel.Boot:2407
      Tonyu.globals.$Math=Math;
      //$LASTPOS=50002420;//kernel.Boot:2420
      Tonyu.globals.$consolePanel=new Tonyu.classes.kernel.Panel({align: "center",x: 465/2,y: 465/2,width: 465,height: 465,zOrder: - 10,layer: Tonyu.globals.$FrontSprites});
      //$LASTPOS=50002530;//kernel.Boot:2530
      Tonyu.globals.$consolePrintY=465-15;
      //$LASTPOS=50002554;//kernel.Boot:2554
      Tonyu.globals.$panel=new Tonyu.classes.kernel.Panel({align: "center",x: Tonyu.globals.$screenWidth/2,y: Tonyu.globals.$screenHeight/2,width: Tonyu.globals.$screenWidth,height: Tonyu.globals.$screenHeight,zOrder: - 1,layer: Tonyu.globals.$FrontSprites});
      //$LASTPOS=50002694;//kernel.Boot:2694
      _this.initFPSParams();
      //$LASTPOS=50002714;//kernel.Boot:2714
      Tonyu.globals.$mouseX=Tonyu.globals.$mouseX||0;
      //$LASTPOS=50002735;//kernel.Boot:2735
      Tonyu.globals.$mouseY=Tonyu.globals.$mouseY||0;
      //$LASTPOS=50002756;//kernel.Boot:2756
      if (typeof  SplashScreen!="undefined") {
        //$LASTPOS=50002794;//kernel.Boot:2794
        SplashScreen.hide();
      }
      //$LASTPOS=50002816;//kernel.Boot:2816
      while (true) {
        //$LASTPOS=50002833;//kernel.Boot:2833
        if (_this._useRAF) {
          //$LASTPOS=50002846;//kernel.Boot:2846
          _this.loopRAF();
        } else {
          //$LASTPOS=50002864;//kernel.Boot:2864
          _this.loopTimer();
        }
        //$LASTPOS=50002882;//kernel.Boot:2882
        _this.measureFps();
        //$LASTPOS=50002898;//kernel.Boot:2898
        _this.handlePause();
    ...
    initialize :function _trc_Boot_initialize(param) {
      ...
      //$LASTPOS=50000239;//kernel.Boot:239
      _this.extend(param);
    },
    update :function _trc_Boot_update() {
      ...
      //$LASTPOS=50000275;//kernel.Boot:275
    ...
    loadPlugins :function _trc_Boot_loadPlugins() {
      ...
      //$LASTPOS=50000356;//kernel.Boot:356
      _this.print("Loading plugins..");
      //$LASTPOS=50000390;//kernel.Boot:390
      _this.runAsync((function anonymous_399(r) {
        
        //$LASTPOS=50000415;//kernel.Boot:415
    ...
    fiber$loadPlugins :function _trc_Boot_f_loadPlugins(_thread) {
      ...
      _thread.enter(function _trc_Boot_ent_loadPlugins(_thread) {
        ...
        for(var __cnt=100 ; __cnt--;) {
          ...
          case 0:
            //$LASTPOS=50000390;//kernel.Boot:390
            _this.fiber$runAsync(_thread, (function anonymous_399(r) {
    ...
    initSprites :function _trc_Boot_initSprites() {
      ...
      //$LASTPOS=50000481;//kernel.Boot:481
      Tonyu.globals.$Sprites=new Tonyu.classes.kernel.Sprites();
      //$LASTPOS=50000510;//kernel.Boot:510
      Tonyu.globals.$FrontSprites=new Tonyu.classes.kernel.Sprites();
      //$LASTPOS=50000544;//kernel.Boot:544
      _this.cvj=$("canvas");
      //$LASTPOS=50000566;//kernel.Boot:566
      if (Tonyu.noviceMode) {
        //$LASTPOS=50000599;//kernel.Boot:599
        Tonyu.globals.$Screen=new Tonyu.classes.kernel.ScaledCanvas({canvas: _this.cvj,width: 600,height: 300});
        
      } else {
        //$LASTPOS=50000683;//kernel.Boot:683
        Tonyu.globals.$Screen=new Tonyu.classes.kernel.ScaledCanvas({canvas: _this.cvj,width: 465,height: 465});
        
      }
      //$LASTPOS=50000756;//kernel.Boot:756
      _this.drawFrame();
      //$LASTPOS=50000774;//kernel.Boot:774
      _this.print("Loading pats..");
      //$LASTPOS=50000805;//kernel.Boot:805
      rs = Tonyu.globals.$currentProject.getResource();
      
      
      //$LASTPOS=50000860;//kernel.Boot:860
      r=_this.runAsync((function anonymous_871(succ) {
        
        //$LASTPOS=50000890;//kernel.Boot:890
        ImageList.load(rs.images,succ,{baseDir: Tonyu.globals.$currentProject.getDir()});
      }));
      //$LASTPOS=50001015;//kernel.Boot:1015
      Tonyu.globals.$imageList=r[0];
      //$LASTPOS=50001037;//kernel.Boot:1037
      Tonyu.globals.$Sprites.setImageList(r[0]);
      //$LASTPOS=50001071;//kernel.Boot:1071
      _it_339=Tonyu.iterator(r[0].names,2);
      while(_it_339.next()) {
        name=_it_339[0];
        val=_it_339[1];
        
        //$LASTPOS=50001115;//kernel.Boot:1115
        Tonyu.setGlobal(name,val);
        
      }
      //$LASTPOS=50001155;//kernel.Boot:1155
    ...
    fiber$initSprites :function _trc_Boot_f_initSprites(_thread) {
      ...
      _thread.enter(function _trc_Boot_ent_initSprites(_thread) {
        ...
        for(var __cnt=100 ; __cnt--;) {
          ...
          case 0:
            //$LASTPOS=50000860;//kernel.Boot:860
            _this.fiber$runAsync(_thread, (function anonymous_871(succ) {
    ...
    initSounds :function _trc_Boot_initSounds() {
      ...
      //$LASTPOS=50001210;//kernel.Boot:1210
      _this.print("Loading sounds...");
      //$LASTPOS=50001244;//kernel.Boot:1244
      _this.initT2MediaPlayer();
      //$LASTPOS=50001270;//kernel.Boot:1270
      _this.loadFromProject(Tonyu.globals.$currentProject);
      //$LASTPOS=50001309;//kernel.Boot:1309
      _this.print("Loading sounds done.");
      //$LASTPOS=50001346;//kernel.Boot:1346
      _this.on("stop",(function anonymous_1356() {
        
        //$LASTPOS=50001368;//kernel.Boot:1368
        _this.clearSEData();
      }));
      //$LASTPOS=50001396;//kernel.Boot:1396
    ...
    initThread :function _trc_Boot_initThread() {
      ...
      //$LASTPOS=50001450;//kernel.Boot:1450
      o = Tonyu.currentProject.getOptions();
      
      //$LASTPOS=50001496;//kernel.Boot:1496
      mainClassName = o.run.mainClass;
      
      //$LASTPOS=50001536;//kernel.Boot:1536
      _this.print("MainClass= "+mainClassName);
      //$LASTPOS=50001577;//kernel.Boot:1577
      _this.mainClass=Tonyu.getClass(mainClassName);
      //$LASTPOS=50001623;//kernel.Boot:1623
      if (! _this.mainClass) {
        throw new Error(mainClassName+" というクラスはありません");
        
        
      }
      //$LASTPOS=50001711;//kernel.Boot:1711
      _this.scheduler=Tonyu.globals.$Scheduler=new Tonyu.classes.kernel.Scheduler;
      //$LASTPOS=50001752;//kernel.Boot:1752
      new _this.mainClass();
    },
    ...
    stop :function _trc_Boot_stop() {
      ...
      //$LASTPOS=50001788;//kernel.Boot:1788
      _this.fireEvent("stop");
      //$LASTPOS=50001812;//kernel.Boot:1812
      _this.die();
    },
    ...
    schedule :function _trc_Boot_schedule(obj,method,args) {
      ...
      //$LASTPOS=50001857;//kernel.Boot:1857
      method=method||"main";
      //$LASTPOS=50001885;//kernel.Boot:1885
      args=args||[];
      //$LASTPOS=50001905;//kernel.Boot:1905
      th = _this.scheduler.newThread(obj,method,args);
      
      //$LASTPOS=50001957;//kernel.Boot:1957
      obj.setThreadGroup(_this);
      //$LASTPOS=50001988;//kernel.Boot:1988
    ...
    initEvents :function _trc_Boot_initEvents() {
      ...
      //$LASTPOS=50002053;//kernel.Boot:2053
    ...
    loopRAF :function _trc_Boot_loopRAF() {
      ...
      //$LASTPOS=50002932;//kernel.Boot:2932
      start = _this.now();
      
      //$LASTPOS=50002959;//kernel.Boot:2959
      time = 1000/_this._fps;
      
      //$LASTPOS=50002998;//kernel.Boot:2998
      moves = 0;
      
      //$LASTPOS=50003013;//kernel.Boot:3013
      while (moves<_this.frameSkip) {
        //$LASTPOS=50003041;//kernel.Boot:3041
        _this.moveFrame();
        //$LASTPOS=50003057;//kernel.Boot:3057
        moves++;
        //$LASTPOS=50003069;//kernel.Boot:3069
        if (moves<_this.frameSkip) {
          //$LASTPOS=50003090;//kernel.Boot:3090
          _this.afterDraw(false);
        }
        
      }
      //$LASTPOS=50003114;//kernel.Boot:3114
      _this.drawFrame();
      //$LASTPOS=50003129;//kernel.Boot:3129
      _this.afterDraw(true);
      //$LASTPOS=50003148;//kernel.Boot:3148
      _this.waitRAF();
      //$LASTPOS=50003167;//kernel.Boot:3167
      elapsed=_this.now()-start;
      //$LASTPOS=50003195;//kernel.Boot:3195
      cnt = _this.rafCount-1;
      
      //$LASTPOS=50003220;//kernel.Boot:3220
      if (_this.rafResolution) {
        //$LASTPOS=50003291;//kernel.Boot:3291
        rafResMS = time/_this.rafResolution;
        
        //$LASTPOS=50003369;//kernel.Boot:3369
        elapsedRAF = _this.floor(elapsed/rafResMS+0.5);
        
        //$LASTPOS=50003429;//kernel.Boot:3429
        if (elapsedRAF>1) {
      ...
      //$LASTPOS=50003505;//kernel.Boot:3505
      _this.rafCntDebug=cnt;
      //$LASTPOS=50003524;//kernel.Boot:3524
      while (cnt>0) {
        //$LASTPOS=50003542;//kernel.Boot:3542
        _this.waitRAF();
        //$LASTPOS=50003556;//kernel.Boot:3556
        cnt--;
    ...
    waitRAF :function _trc_Boot_waitRAF() {
      ...
      //$LASTPOS=50003592;//kernel.Boot:3592
      _this.waitFor(Tonyu.animationFrame());
      //$LASTPOS=50003630;//kernel.Boot:3630
      rafStart = _this.now();
      
      //$LASTPOS=50003655;//kernel.Boot:3655
      if (_this.pRafStart) {
        //$LASTPOS=50003670;//kernel.Boot:3670
        _this.detectRAFResolution(rafStart-_this.pRafStart);
      }
      //$LASTPOS=50003716;//kernel.Boot:3716
    ...
    detectRAFResolution :function _trc_Boot_detectRAFResolution(t) {
      ...
      //$LASTPOS=50003775;//kernel.Boot:3775
      if (_this.rafResolution) {
        return _this;
      }
      ...
      //$LASTPOS=50003880;//kernel.Boot:3880
      reso = time/t;
      
      //$LASTPOS=50003966;//kernel.Boot:3966
      if (reso>1) {
        //$LASTPOS=50003978;//kernel.Boot:3978
        reso=_this.floor(reso+0.5);
      } else {
        //$LASTPOS=50004019;//kernel.Boot:4019
        reso=1/_this.floor(1/reso+0.5);
      }
      //$LASTPOS=50004098;//kernel.Boot:4098
      _this.rafRess=_this.rafRess||{};
      //$LASTPOS=50004121;//kernel.Boot:4121
      if ((_this.rafRess[reso+""]=(_this.rafRess[reso+""]||0)+1)>10) {
        //$LASTPOS=50004183;//kernel.Boot:4183
        _this.rafResolution=reso;
        //$LASTPOS=50004206;//kernel.Boot:4206
        if (reso<1) {
          //$LASTPOS=50004224;//kernel.Boot:4224
          _this.frameSkip=_this.floor(1/reso+0.5);
          //$LASTPOS=50004257;//kernel.Boot:4257
          _this.rafCount=1;
          
        } else {
          //$LASTPOS=50004285;//kernel.Boot:4285
          _this.rafCount=reso;
          //$LASTPOS=50004304;//kernel.Boot:4304
          _this.frameSkip=1;
    ...
    measureRAFInterval :function _trc_Boot_measureRAFInterval() {
      ...
      //$LASTPOS=50004358;//kernel.Boot:4358
      if (Tonyu.globals.$RAFInterval) {
        return _this;
      }
      //$LASTPOS=50004386;//kernel.Boot:4386
      s = _this.now();
      
      //$LASTPOS=50004401;//kernel.Boot:4401
      //$LASTPOS=50004406;//kernel.Boot:4406
      i = 0;
      for (; i<20 ; i++) {
        {
          //$LASTPOS=50004432;//kernel.Boot:4432
          _this.waitFor(Tonyu.animationFrame());
        }
      }
      //$LASTPOS=50004471;//kernel.Boot:4471
    ...
    loopTimer :function _trc_Boot_loopTimer() {
      ...
      //$LASTPOS=50004522;//kernel.Boot:4522
      _this.moveFrame();
      //$LASTPOS=50004540;//kernel.Boot:4540
      _this.doDraw=_this.now()<_this.deadLine;
      //$LASTPOS=50004568;//kernel.Boot:4568
      if (! _this.doDraw&&_this.frameSkipped>=_this.maxFrameSkip) {
        //$LASTPOS=50004622;//kernel.Boot:4622
        _this.doDraw=true;
        //$LASTPOS=50004644;//kernel.Boot:4644
        _this.resetDeadLine();
        
      }
      //$LASTPOS=50004673;//kernel.Boot:4673
      if (_this.doDraw) {
        //$LASTPOS=50004710;//kernel.Boot:4710
        _this.drawFrame();
        //$LASTPOS=50004732;//kernel.Boot:4732
        _this.frameSkipped=0;
        
      } else {
        //$LASTPOS=50004771;//kernel.Boot:4771
        _this.frameSkipped++;
        
      }
      //$LASTPOS=50004799;//kernel.Boot:4799
      _this.afterDraw(_this.doDraw);
      //$LASTPOS=50004823;//kernel.Boot:4823
      _this.waitFrame();
    },
    ...
    handlePause :function _trc_Boot_handlePause() {
      ...
      //$LASTPOS=50004871;//kernel.Boot:4871
      while (_this.paused) {
        //$LASTPOS=50004896;//kernel.Boot:4896
        _this.waitFor(Tonyu.timeout(1));
        //$LASTPOS=50004932;//kernel.Boot:4932
        if (! _this.paused) {
          //$LASTPOS=50004945;//kernel.Boot:4945
          _this.resetDeadLine();
        }
    ...
    drawFrame :function _trc_Boot_drawFrame() {
      ...
      //$LASTPOS=50004997;//kernel.Boot:4997
      s = _this.now();
      
      //$LASTPOS=50005015;//kernel.Boot:5015
      Tonyu.globals.$Screen.fillCanvas(Tonyu.globals.$Screen.buf[0]);
      //$LASTPOS=50005056;//kernel.Boot:5056
      Tonyu.globals.$Sprites.draw(Tonyu.globals.$Screen.buf[0]);
      //$LASTPOS=50005092;//kernel.Boot:5092
      Tonyu.globals.$FrontSprites.draw(Tonyu.globals.$Screen.buf[0]);
      //$LASTPOS=50005133;//kernel.Boot:5133
      Tonyu.globals.$Screen.draw();
      //$LASTPOS=50005154;//kernel.Boot:5154
    ...
    moveFrame :function _trc_Boot_moveFrame() {
      ...
      //$LASTPOS=50005220;//kernel.Boot:5220
      s = _this.now();
      
      //$LASTPOS=50005238;//kernel.Boot:5238
      _this.scheduler.stepsAll();
      //$LASTPOS=50005265;//kernel.Boot:5265
      Tonyu.globals.$Keys.update();
      //$LASTPOS=50005286;//kernel.Boot:5286
      Tonyu.globals.$InputDevice.update();
      //$LASTPOS=50005314;//kernel.Boot:5314
      Tonyu.globals.$screenWidth=Tonyu.globals.$Screen.width;
      //$LASTPOS=50005347;//kernel.Boot:5347
      Tonyu.globals.$screenHeight=Tonyu.globals.$Screen.height;
      //$LASTPOS=50005382;//kernel.Boot:5382
      _this.moveTime=_this.now()-s;
      //$LASTPOS=50005405;//kernel.Boot:5405
      _this.fps_rpsCnt++;
    },
    afterDraw :function _trc_Boot_afterDraw(drawn) {
      ...
      //$LASTPOS=50005508;//kernel.Boot:5508
      Tonyu.globals.$Sprites.checkHit();
      //$LASTPOS=50005534;//kernel.Boot:5534
    ...
    initFPSParams :function _trc_Boot_initFPSParams() {
      ...
      //$LASTPOS=50005621;//kernel.Boot:5621
      _this._fps=30;
      //$LASTPOS=50005637;//kernel.Boot:5637
      _this.maxFrameSkip=5;
      //$LASTPOS=50005660;//kernel.Boot:5660
      _this.minFrameSkip=1;
      //$LASTPOS=50005710;//kernel.Boot:5710
      _this.frameCnt=0;
      //$LASTPOS=50005729;//kernel.Boot:5729
      _this.resetDeadLine();
      //$LASTPOS=50005751;//kernel.Boot:5751
      _this.lastMeasured=_this.now();
      //$LASTPOS=50005776;//kernel.Boot:5776
      _this.fps_fps=_this.fps_rps=_this.fps_fpsCnt=_this.fps_rpsCnt=0;
      //$LASTPOS=50005822;//kernel.Boot:5822
      _this.drawTime=5;
      //$LASTPOS=50005833;//kernel.Boot:5833
      _this.moveTime=5;
      //$LASTPOS=50005847;//kernel.Boot:5847
      _this.rafAccept=1.1;
      //$LASTPOS=50005864;//kernel.Boot:5864
      _this.rafInterval=1000/60;
      //$LASTPOS=50005887;//kernel.Boot:5887
      _this._useRAF=true;
      //$LASTPOS=50005903;//kernel.Boot:5903
      _this.rafCount=2;
      //$LASTPOS=50005917;//kernel.Boot:5917
      _this.frameSkip=1;
    },
    ...
    resetDeadLine :function _trc_Boot_resetDeadLine() {
      ...
      //$LASTPOS=50006019;//kernel.Boot:6019
      _this.deadLine=_this.now()+1000/_this._fps;
      //$LASTPOS=50006050;//kernel.Boot:6050
      _this.frameSkipped=0;
    },
    waitFrame :function _trc_Boot_waitFrame() {
      ...
      //$LASTPOS=50006094;//kernel.Boot:6094
      wt = _this.deadLine-_this.now();
      
      //$LASTPOS=50006122;//kernel.Boot:6122
      if (wt<1) {
        //$LASTPOS=50006143;//kernel.Boot:6143
        if (wt<- 1000) {
          //$LASTPOS=50006157;//kernel.Boot:6157
          _this.resetDeadLine();
        }
        //$LASTPOS=50006183;//kernel.Boot:6183
        wt=1;
        
      }
      //$LASTPOS=50006201;//kernel.Boot:6201
      wt=_this.floor(wt);
      //$LASTPOS=50006220;//kernel.Boot:6220
      _this.waitFor(Tonyu.timeout(wt));
      //$LASTPOS=50006253;//kernel.Boot:6253
    ...
    setFrameRate :function _trc_Boot_setFrameRate(fps,maxFrameSkip) {
      ...
      //$LASTPOS=50006410;//kernel.Boot:6410
      if (_this._fps!=fps) {
        //$LASTPOS=50006430;//kernel.Boot:6430
        _this.rafRess={};
        //$LASTPOS=50006445;//kernel.Boot:6445
        _this.rafResolution=null;
        //$LASTPOS=50006468;//kernel.Boot:6468
        _this.frameSkip=1;
        //$LASTPOS=50006484;//kernel.Boot:6484
        _this.rafCnt=_this.floor(60/fps+0.5);
        
      }
      //$LASTPOS=50006519;//kernel.Boot:6519
      _this._fps=fps;
      //$LASTPOS=50006536;//kernel.Boot:6536
      if (typeof  maxFrameSkip!="number") {
        //$LASTPOS=50006571;//kernel.Boot:6571
        maxFrameSkip=5;
      }
      //$LASTPOS=50006592;//kernel.Boot:6592
      _this.maxFrameSkip=maxFrameSkip;
      //$LASTPOS=50006631;//kernel.Boot:6631
      _this.resetDeadLine();
    },
    ...
    measureFps :function _trc_Boot_measureFps() {
      ...
      if (_this.now()>_this.lastMeasured+1000) {
        //$LASTPOS=50006950;//kernel.Boot:6950
        _this.fps_fps=_this.fps_fpsCnt;
        //$LASTPOS=50006979;//kernel.Boot:6979
        _this.fps_rps=_this.fps_rpsCnt;
        //$LASTPOS=50007008;//kernel.Boot:7008
        _this.fps_fpsCnt=0;
        //$LASTPOS=50007031;//kernel.Boot:7031
        _this.fps_rpsCnt=0;
        //$LASTPOS=50007054;//kernel.Boot:7054
        _this.lastMeasured=_this.now();
