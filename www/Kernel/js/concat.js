...
Tonyu.klass.define({
  ...
  methods: {
    ...
    parallel :function _trc_ParallelMod_parallel() {
      ...
      name = arguments[0];
      //$LASTPOS=26000202;//kernel.ParallelMod:202
      th;
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    removeOneframes :function _trc_Sprites_removeOneframes(drawn) {
      ...
      //$LASTPOS=34000753;//kernel.Sprites:753
      s;
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    getPadButton :function _trc_Pad_getPadButton(i) {
      ...
      //$LASTPOS=48002940;//kernel.Pad:2940
      value;
    ...
    getButton :function _trc_Pad_getButton(i) {
      ...
      //$LASTPOS=48003163;//kernel.Pad:3163
      value;
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    initSprites :function _trc_Boot_initSprites() {
      ...
      //$LASTPOS=49000846;//kernel.Boot:846
      r;
