...
Tonyu.klass.define({
  ...
  methods: {
    ...
    rndFloat :function _trc_MathMod_rndFloat(r,m) {
      ...
      //$LASTPOS=9001103;//kernel.MathMod:1103
      if (typeof  r!=="number") {
        //$LASTPOS=9001128;//kernel.MathMod:1128
        r=0;
      }
      //$LASTPOS=9001138;//kernel.MathMod:1138
      if (typeof  m!=="number") {
        //$LASTPOS=9001163;//kernel.MathMod:1163
        m=1;
      }
      //$LASTPOS=9001173;//kernel.MathMod:1173
      if (r<m) {
    ...
    rnd :function _trc_MathMod_rnd(r,m) {
      ...
      //$LASTPOS=9001313;//kernel.MathMod:1313
      if (typeof  r=="number") {
        //$LASTPOS=9001348;//kernel.MathMod:1348
        if (typeof  m=="number") {
          //$LASTPOS=9001387;//kernel.MathMod:1387
          if (r<m) {
    ...
    clamp :function _trc_MathMod_clamp(v,min,max) {
      ...
      //$LASTPOS=9001764;//kernel.MathMod:1764
      if (min>max) {
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    initialize :function _trc_BaseActor_initialize(x,y,p) {
      ...
      if (Tonyu.runMode) {
        //$LASTPOS=27000289;//kernel.BaseActor:289
        _this._th=Tonyu.globals.$Boot.schedule(_this,"main",[]);
      }
      //$LASTPOS=27000330;//kernel.BaseActor:330
      if (typeof  x=="object") {
        //$LASTPOS=27000354;//kernel.BaseActor:354
        Tonyu.extend(_this,x);
      } else {
        //$LASTPOS=27000386;//kernel.BaseActor:386
        if (typeof  x=="number") {
          //$LASTPOS=27000421;//kernel.BaseActor:421
          _this.x=x;
          //$LASTPOS=27000440;//kernel.BaseActor:440
          _this.y=y;
          //$LASTPOS=27000459;//kernel.BaseActor:459
          _this.p=p;
          
        }
      }
      //$LASTPOS=27000481;//kernel.BaseActor:481
      _this.scheduler=_this.scheduler||Tonyu.globals.$Scheduler;
      //$LASTPOS=27000519;//kernel.BaseActor:519
      _this.layer=_this.layer||_this.defaultLayer;
      //$LASTPOS=27000551;//kernel.BaseActor:551
      _this.crashScale=1;
      //$LASTPOS=27000570;//kernel.BaseActor:570
      if (_this.scaleX==null) {
        //$LASTPOS=27000588;//kernel.BaseActor:588
        _this.scaleX=1;
      }
      //$LASTPOS=27000603;//kernel.BaseActor:603
      if (_this.rotation==null) {
        //$LASTPOS=27000623;//kernel.BaseActor:623
        _this.rotation=0;
      }
      //$LASTPOS=27000685;//kernel.BaseActor:685
      if (_this.alpha==null) {
        //$LASTPOS=27000702;//kernel.BaseActor:702
        _this.alpha=255;
      }
      //$LASTPOS=27000718;//kernel.BaseActor:718
      if (_this.zOrder==null) {
        //$LASTPOS=27000736;//kernel.BaseActor:736
        _this.zOrder=0;
      }
      //$LASTPOS=27000751;//kernel.BaseActor:751
      if (_this.age==null) {
        //$LASTPOS=27000766;//kernel.BaseActor:766
        _this.age=0;
      }
      //$LASTPOS=27000778;//kernel.BaseActor:778
      if (_this.anim!=null&&typeof  _this.anim=="object") {
        //$LASTPOS=27000829;//kernel.BaseActor:829
        _this.animMode=true;
        //$LASTPOS=27000853;//kernel.BaseActor:853
        _this.animFrame=0;
        
      } else {
        //$LASTPOS=27000887;//kernel.BaseActor:887
        _this.animMode=false;
        
      }
      //$LASTPOS=27000915;//kernel.BaseActor:915
      if (_this.animFps==null) {
        //$LASTPOS=27000934;//kernel.BaseActor:934
        _this.animFps=1;
      }
    },
    ...
    print :function _trc_BaseActor_print(pt) {
      ...
      //$LASTPOS=27001038;//kernel.BaseActor:1038
      console.log.apply(console,arguments);
      //$LASTPOS=27001081;//kernel.BaseActor:1081
      mergedArg = "";
      
      //$LASTPOS=27001104;//kernel.BaseActor:1104
      if (Tonyu.globals.$consolePanel) {
        //$LASTPOS=27001132;//kernel.BaseActor:1132
        //$LASTPOS=27001136;//kernel.BaseActor:1136
        argCount = 0;
        for (; argCount<arguments.length ; argCount++) {
          {
            //$LASTPOS=27001203;//kernel.BaseActor:1203
            mergedArg=mergedArg+arguments[argCount]+" ";
          }
        }
        //$LASTPOS=27001268;//kernel.BaseActor:1268
        _this.splits=mergedArg.split("\n");
        //$LASTPOS=27001307;//kernel.BaseActor:1307
        //$LASTPOS=27001311;//kernel.BaseActor:1311
        printCount = 0;
        for (; printCount<_this.splits.length ; printCount++) {
          {
            //$LASTPOS=27001381;//kernel.BaseActor:1381
            Tonyu.globals.$consolePanel.scroll(0,20);
            //$LASTPOS=27001422;//kernel.BaseActor:1422
            Tonyu.globals.$consolePanel.setFillStyle("white");
            //$LASTPOS=27001472;//kernel.BaseActor:1472
    ...
    setAnimFps :function _trc_BaseActor_setAnimFps(f) {
      ...
      //$LASTPOS=27001595;//kernel.BaseActor:1595
      _this.animFps=f;
      //$LASTPOS=27001616;//kernel.BaseActor:1616
      _this.animFrame=0;
      //$LASTPOS=27001639;//kernel.BaseActor:1639
      _this.animMode=true;
    },
    startAnim :function _trc_BaseActor_startAnim() {
      ...
      //$LASTPOS=27001689;//kernel.BaseActor:1689
      _this.animMode=true;
    },
    stopAnim :function _trc_BaseActor_stopAnim() {
      ...
      //$LASTPOS=27001738;//kernel.BaseActor:1738
      _this.animMode=false;
    },
    update :function _trc_BaseActor_update() {
      ...
      _this.onUpdate();
      //$LASTPOS=27001797;//kernel.BaseActor:1797
      if (null) {
        //$LASTPOS=27001820;//kernel.BaseActor:1820
        null.suspend();
        //$LASTPOS=27001848;//kernel.BaseActor:1848
        if (_this.scheduler) {
          //$LASTPOS=27001863;//kernel.BaseActor:1863
          _this.scheduler.addToNext(null);
        }
        
      } else {
        //$LASTPOS=27001916;//kernel.BaseActor:1916
        _this.scheduler.checkTimeout();
    ...
    fiber$update :function _trc_BaseActor_f_update(_thread) {
      ...
      if (_thread) {
        ...
        if (_this.scheduler) {
          //$LASTPOS=27001863;//kernel.BaseActor:1863
          _this.scheduler.addToNext(_thread);
        }
    ...
    updateEx :function _trc_BaseActor_updateEx(updateT) {
      ...
      //$LASTPOS=27002005;//kernel.BaseActor:2005
      //$LASTPOS=27002009;//kernel.BaseActor:2009
      updateCount = 0;
      for (; updateCount<updateT ; updateCount++) {
        {
          //$LASTPOS=27002072;//kernel.BaseActor:2072
          _this.update();
        }
      }
    },
    ...
    all :function _trc_BaseActor_all(c) {
      ...
      //$LASTPOS=27002283;//kernel.BaseActor:2283
      res = new Tonyu.classes.kernel.TQuery(_this);
      
      //$LASTPOS=27002314;//kernel.BaseActor:2314
      if (arguments.length>0&&typeof  c!="function") {
        return res;
        
      }
      //$LASTPOS=27002397;//kernel.BaseActor:2397
      _this.layer.sprites.forEach((function anonymous_2419(s) {
        
        //$LASTPOS=27002435;//kernel.BaseActor:2435
        if (s===_this) {
          return _this;
        }
        //$LASTPOS=27002466;//kernel.BaseActor:2466
        if (! c||s instanceof c) {
          //$LASTPOS=27002507;//kernel.BaseActor:2507
          res.push(s);
    ...
    allCrash :function _trc_BaseActor_allCrash(t) {
      ...
      //$LASTPOS=27002587;//kernel.BaseActor:2587
      res = new Tonyu.classes.kernel.TQuery(_this);
      
      //$LASTPOS=27002618;//kernel.BaseActor:2618
      sp = _this;
      
      //$LASTPOS=27002655;//kernel.BaseActor:2655
      t1 = _this.getCrashRect();
      
      //$LASTPOS=27002683;//kernel.BaseActor:2683
      if (! t1) {
        return res;
      }
      //$LASTPOS=27002709;//kernel.BaseActor:2709
      _this.layer.sprites.forEach((function anonymous_2731(s) {
        var t2;
        
        
        //$LASTPOS=27002764;//kernel.BaseActor:2764
        if (s!==_this&&! s.excludeFromAll&&s instanceof t&&(t2=s.getCrashRect())&&Math.abs(t1.x-t2.x)*2<t1.width+t2.width&&Math.abs(t1.y-t2.y)*2<t1.height+t2.height) {
          //$LASTPOS=27002990;//kernel.BaseActor:2990
          res.push(s);
    ...
    crashTo :function _trc_BaseActor_crashTo(t) {
      ...
      //$LASTPOS=27003070;//kernel.BaseActor:3070
      if (! t) {
        return false;
      }
      //$LASTPOS=27003097;//kernel.BaseActor:3097
    ...
    crashTo1 :function _trc_BaseActor_crashTo1(t) {
      ...
      //$LASTPOS=27003220;//kernel.BaseActor:3220
      if (! t||t._isDead) {
        return false;
      }
      //$LASTPOS=27003260;//kernel.BaseActor:3260
      t1 = _this.getCrashRect();
      
      //$LASTPOS=27003288;//kernel.BaseActor:3288
      t2 = t.getCrashRect();
    ...
    crashToChecker :function _trc_BaseActor_crashToChecker(d,f) {
      ...
      //$LASTPOS=27003597;//kernel.BaseActor:3597
      while (true) {
        //$LASTPOS=27003619;//kernel.BaseActor:3619
        if (typeof  d=="function") {
          //$LASTPOS=27003658;//kernel.BaseActor:3658
          _it_203=Tonyu.iterator(_this.allCrash(d),1);
          while(_it_203.next()) {
            obj=_it_203[0];
            
            //$LASTPOS=27003700;//kernel.BaseActor:3700
            _this.callEventHandler(f,[obj]);
            
          }
          
        } else {
          //$LASTPOS=27003757;//kernel.BaseActor:3757
          if (_this.crashTo(d)) {
            //$LASTPOS=27003786;//kernel.BaseActor:3786
            _this.callEventHandler(f,[d]);
            
          }
        }
        //$LASTPOS=27003831;//kernel.BaseActor:3831
        _this.update();
    ...
    getCrashRect :function _trc_BaseActor_getCrashRect() {
      ...
      //$LASTPOS=27003882;//kernel.BaseActor:3882
      actWidth = (_this.width||_this.radius*2)*_this.scaleX*_this.crashScale;
      
      //$LASTPOS=27003948;//kernel.BaseActor:3948
      if (typeof  _this.scaleY==="undefined") {
        //$LASTPOS=27003990;//kernel.BaseActor:3990
        actHeight=(_this.height||_this.radius*2)*_this.scaleX*_this.crashScale;
        
      } else {
        //$LASTPOS=27004059;//kernel.BaseActor:4059
    ...
    allWithin :function _trc_BaseActor_allWithin(t,distance) {
      ...
      //$LASTPOS=27004349;//kernel.BaseActor:4349
      res = new Tonyu.classes.kernel.TQuery(_this);
      
      //$LASTPOS=27004380;//kernel.BaseActor:4380
      sp = _this;
      
      //$LASTPOS=27004417;//kernel.BaseActor:4417
      t1 = _this.getCrashRect();
      
      //$LASTPOS=27004445;//kernel.BaseActor:4445
      if (! t1) {
        return res;
      }
      //$LASTPOS=27004471;//kernel.BaseActor:4471
      _this.layer.sprites.forEach((function anonymous_4493(s) {
        var t2;
        
        
        //$LASTPOS=27004526;//kernel.BaseActor:4526
        if (s!==_this&&! s.excludeFromAll&&s instanceof t&&Math.sqrt(Math.abs(_this.x-s.x)*Math.abs(_this.x-s.x)+Math.abs(_this.y-s.y)*Math.abs(_this.y-s.y))<distance) {
          //$LASTPOS=27004709;//kernel.BaseActor:4709
          res.push(s);
    ...
    within :function _trc_BaseActor_within(t,distance) {
      ...
      //$LASTPOS=27004796;//kernel.BaseActor:4796
      if (! t) {
        return false;
      }
      //$LASTPOS=27004822;//kernel.BaseActor:4822
      if (typeof  t=="function") {
    ...
    within1 :function _trc_BaseActor_within1(t,distance) {
      ...
      //$LASTPOS=27004968;//kernel.BaseActor:4968
      if (! t||t._isDead) {
        return false;
      }
      //$LASTPOS=27005007;//kernel.BaseActor:5007
    ...
    withinChecker :function _trc_BaseActor_withinChecker(d,r,f) {
      ...
      while (true) {
        //$LASTPOS=27005199;//kernel.BaseActor:5199
        if (typeof  d=="function") {
          //$LASTPOS=27005238;//kernel.BaseActor:5238
          _it_213=Tonyu.iterator(_this.allWithin(d,r),1);
          while(_it_213.next()) {
            obj=_it_213[0];
            
            //$LASTPOS=27005312;//kernel.BaseActor:5312
            f(obj);
            
          }
          
        } else {
          //$LASTPOS=27005350;//kernel.BaseActor:5350
          if (_this.within(d,r)) {
            //$LASTPOS=27005380;//kernel.BaseActor:5380
            f(d);
            
          }
        }
        //$LASTPOS=27005406;//kernel.BaseActor:5406
        _this.update();
    ...
    watchHit :function _trc_BaseActor_watchHit(typeA,typeB,onHit) {
      ...
      //$LASTPOS=27005470;//kernel.BaseActor:5470
      _this.layer.watchHit(typeA,typeB,(function anonymous_5500(a,b) {
        
        //$LASTPOS=27005518;//kernel.BaseActor:5518
    ...
    die :function _trc_BaseActor_die() {
      ...
      //$LASTPOS=27005671;//kernel.BaseActor:5671
      _this.killThreadGroup();
      //$LASTPOS=27005695;//kernel.BaseActor:5695
      _this.hide();
      //$LASTPOS=27005708;//kernel.BaseActor:5708
      _this.fireEvent("die");
      //$LASTPOS=27005731;//kernel.BaseActor:5731
      _this._isDead=true;
      //$LASTPOS=27005750;//kernel.BaseActor:5750
      if (_this._poolArray) {
        //$LASTPOS=27005777;//kernel.BaseActor:5777
        _this._poolArray.push(_this);
        //$LASTPOS=27005809;//kernel.BaseActor:5809
    ...
    hide :function _trc_BaseActor_hide() {
      ...
      //$LASTPOS=27005878;//kernel.BaseActor:5878
    ...
    show :function _trc_BaseActor_show(x,y,p) {
      ...
      //$LASTPOS=27005929;//kernel.BaseActor:5929
      _this.layer.add(_this);
      //$LASTPOS=27005951;//kernel.BaseActor:5951
      if (x!=null) {
        //$LASTPOS=27005964;//kernel.BaseActor:5964
        _this.x=x;
      }
      //$LASTPOS=27005979;//kernel.BaseActor:5979
      if (y!=null) {
        //$LASTPOS=27005992;//kernel.BaseActor:5992
        _this.y=y;
      }
      //$LASTPOS=27006007;//kernel.BaseActor:6007
      if (p!=null) {
        //$LASTPOS=27006020;//kernel.BaseActor:6020
        _this.p=p;
      }
    },
    detectShape :function _trc_BaseActor_detectShape() {
      ...
      //$LASTPOS=27006065;//kernel.BaseActor:6065
      if (typeof  _this.p!="number") {
        //$LASTPOS=27006100;//kernel.BaseActor:6100
        _this.p=0;
        
      }
      //$LASTPOS=27006117;//kernel.BaseActor:6117
      _this.p=Math.floor(_this.p);
      //$LASTPOS=27006139;//kernel.BaseActor:6139
      _this.pImg=Tonyu.globals.$imageList[_this.p];
      //$LASTPOS=27006164;//kernel.BaseActor:6164
      if (! _this.pImg) {
        return _this;
      }
      //$LASTPOS=27006188;//kernel.BaseActor:6188
      _this.width=_this.pImg.width;
      //$LASTPOS=27006211;//kernel.BaseActor:6211
    ...
    _animation :function _trc_BaseActor__animation() {
      ...
      //$LASTPOS=27006308;//kernel.BaseActor:6308
      _this.age++;
      //$LASTPOS=27006320;//kernel.BaseActor:6320
      if (_this.animMode&&_this.age%_this.animFps==0) {
        //$LASTPOS=27006361;//kernel.BaseActor:6361
        _this.p=_this.anim[_this.animFrame%_this.anim.length];
        //$LASTPOS=27006401;//kernel.BaseActor:6401
        _this.animFrame++;
    ...
    performTransform :function _trc_BaseActor_performTransform(ctx) {
      ...
      //$LASTPOS=27006462;//kernel.BaseActor:6462
      if (_this.x!==_this.x||_this.y!==_this.y||_this.x==null||_this.y==null) {
        
        
      }
      //$LASTPOS=27006591;//kernel.BaseActor:6591
      ctx.translate(_this.x,_this.y);
      //$LASTPOS=27006616;//kernel.BaseActor:6616
      if (_this.rotation!=0) {
        //$LASTPOS=27006647;//kernel.BaseActor:6647
        ctx.rotate(_this.rotation/180*Math.PI);
        
      } else {
        //$LASTPOS=27006707;//kernel.BaseActor:6707
        ctx.rotate(_this.rotate/180*Math.PI);
        
      }
      //$LASTPOS=27006756;//kernel.BaseActor:6756
      if (typeof  _this.scaleY==="undefined") {
        //$LASTPOS=27006804;//kernel.BaseActor:6804
        ctx.scale(_this.scaleX,_this.scaleX);
        
      } else {
        //$LASTPOS=27006861;//kernel.BaseActor:6861
        ctx.scale(_this.scaleX,_this.scaleY);
        
      }
      //$LASTPOS=27006909;//kernel.BaseActor:6909
      ctx.globalAlpha=_this.alpha/255;
    },
    draw :function _trc_BaseActor_draw(ctx) {
      ...
      //$LASTPOS=27006970;//kernel.BaseActor:6970
      if (_this.x==null||_this.y==null||_this._isInvisible) {
        return _this;
      }
      //$LASTPOS=27007023;//kernel.BaseActor:7023
      if (_this.text!=null) {
        //$LASTPOS=27007050;//kernel.BaseActor:7050
        splitsText = (_this.text+"").split("\n");
        
        //$LASTPOS=27007097;//kernel.BaseActor:7097
        _this.drawY=_this.y;
        //$LASTPOS=27007115;//kernel.BaseActor:7115
        if (! _this.size) {
          //$LASTPOS=27007126;//kernel.BaseActor:7126
          _this.size=15;
        }
        //$LASTPOS=27007144;//kernel.BaseActor:7144
        if (! _this.align) {
          //$LASTPOS=27007156;//kernel.BaseActor:7156
          _this.align="center";
        }
        //$LASTPOS=27007181;//kernel.BaseActor:7181
        if (! _this.fillStyle) {
          //$LASTPOS=27007197;//kernel.BaseActor:7197
          _this.fillStyle="white";
        }
        //$LASTPOS=27007225;//kernel.BaseActor:7225
        if (_this.font) {
          //$LASTPOS=27007235;//kernel.BaseActor:7235
          ctx.font=_this.size+"px "+_this.font;
        }
        //$LASTPOS=27007270;//kernel.BaseActor:7270
        ctx.fillStyle=_this.fillStyle;
        //$LASTPOS=27007304;//kernel.BaseActor:7304
        ctx.globalAlpha=_this.alpha/255;
        //$LASTPOS=27007345;//kernel.BaseActor:7345
        _this.height=0;
        //$LASTPOS=27007354;//kernel.BaseActor:7354
        _this.width=0;
        //$LASTPOS=27007372;//kernel.BaseActor:7372
        //$LASTPOS=27007376;//kernel.BaseActor:7376
        textCount = 0;
        for (; textCount<splitsText.length ; textCount++) {
          {
            //$LASTPOS=27007447;//kernel.BaseActor:7447
            rect = _this.drawTextRect(ctx,splitsText[textCount],_this.x,_this.drawY,_this.size,_this.align,"fill");
            
            //$LASTPOS=27007543;//kernel.BaseActor:7543
            if (_this.width<rect.w) {
              //$LASTPOS=27007560;//kernel.BaseActor:7560
              _this.width=rect.w;
            }
            //$LASTPOS=27007587;//kernel.BaseActor:7587
            _this.height+=rect.h;
            //$LASTPOS=27007616;//kernel.BaseActor:7616
            _this.drawY+=_this.size;
          }
        }
        
      } else {
        //$LASTPOS=27007652;//kernel.BaseActor:7652
        if (_this.fillStyle!=null) {
          //$LASTPOS=27007684;//kernel.BaseActor:7684
          ctx.save();
          //$LASTPOS=27007705;//kernel.BaseActor:7705
          _this.performTransform(ctx);
          //$LASTPOS=27007737;//kernel.BaseActor:7737
          ctx.fillStyle=_this.fillStyle;
          //$LASTPOS=27007771;//kernel.BaseActor:7771
          if (_this.radius) {
            //$LASTPOS=27007798;//kernel.BaseActor:7798
            ctx.beginPath();
            //$LASTPOS=27007828;//kernel.BaseActor:7828
            ctx.arc(0,0,_this.radius,0,2*Math.PI);
            //$LASTPOS=27007874;//kernel.BaseActor:7874
            ctx.fill();
            
          } else {
            //$LASTPOS=27007917;//kernel.BaseActor:7917
            ctx.fillRect(- _this.width/2,- _this.height/2,_this.width,_this.height);
            
          }
          //$LASTPOS=27007984;//kernel.BaseActor:7984
          ctx.restore();
          
        } else {
          //$LASTPOS=27008022;//kernel.BaseActor:8022
          _this.detectShape();
          //$LASTPOS=27008046;//kernel.BaseActor:8046
          if (_this.pImg) {
            //$LASTPOS=27008071;//kernel.BaseActor:8071
            _this._animation();
            //$LASTPOS=27008098;//kernel.BaseActor:8098
            ctx.save();
            //$LASTPOS=27008123;//kernel.BaseActor:8123
            _this.performTransform(ctx);
            //$LASTPOS=27008159;//kernel.BaseActor:8159
            ctx.drawImage(_this.pImg.image,_this.pImg.x,_this.pImg.y,_this.pImg.width,_this.pImg.height,- _this.width/2,- _this.height/2,_this.width,_this.height);
            //$LASTPOS=27008303;//kernel.BaseActor:8303
            ctx.restore();
      ...
      //$LASTPOS=27008341;//kernel.BaseActor:8341
      if (_this._fukidashi) {
        //$LASTPOS=27008368;//kernel.BaseActor:8368
        if (_this._fukidashi.c>0) {
          //$LASTPOS=27008403;//kernel.BaseActor:8403
          _this._fukidashi.c--;
          //$LASTPOS=27008432;//kernel.BaseActor:8432
          ctx.fillStyle="white";
          //$LASTPOS=27008468;//kernel.BaseActor:8468
          ctx.strokeStyle="black";
          //$LASTPOS=27008506;//kernel.BaseActor:8506
    ...
    runAsync :function _trc_BaseActor_runAsync(f) {
      ...
      //$LASTPOS=27008634;//kernel.BaseActor:8634
      if (! null) {
        throw new Error("runAsync should run in wait mode");
        
      }
      //$LASTPOS=27008706;//kernel.BaseActor:8706
      null.runAsync(f);
    },
    ...
    screenOut :function _trc_BaseActor_screenOut(a) {
      ...
      //$LASTPOS=27008788;//kernel.BaseActor:8788
      if (! a) {
        //$LASTPOS=27008796;//kernel.BaseActor:8796
        a=0;
      }
      //$LASTPOS=27008822;//kernel.BaseActor:8822
    ...
    screenOutChecker :function _trc_BaseActor_screenOutChecker(d,f) {
      ...
      //$LASTPOS=27009280;//kernel.BaseActor:9280
      while (true) {
        //$LASTPOS=27009302;//kernel.BaseActor:9302
        while (true) {
          //$LASTPOS=27009328;//kernel.BaseActor:9328
          ...
          //$LASTPOS=27009421;//kernel.BaseActor:9421
          _this.update();
          
        }
        //$LASTPOS=27009451;//kernel.BaseActor:9451
        while (true) {
          //$LASTPOS=27009477;//kernel.BaseActor:9477
          if (_this.screenOut()<=d) {
            break;
            
            
          }
          //$LASTPOS=27009549;//kernel.BaseActor:9549
          _this.update();
          
        }
        //$LASTPOS=27009579;//kernel.BaseActor:9579
        _this.update();
    ...
    file :function _trc_BaseActor_file(path) {
      ...
      //$LASTPOS=27009661;//kernel.BaseActor:9661
      files = d.rel("files/");
    ...
    waitInputDevice :function _trc_BaseActor_waitInputDevice(fl) {
      ...
      //$LASTPOS=27009770;//kernel.BaseActor:9770
      _this.runAsync((function anonymous_9779(f) {
        
        //$LASTPOS=27009794;//kernel.BaseActor:9794
    ...
    fiber$waitInputDevice :function _trc_BaseActor_f_waitInputDevice(_thread,fl) {
      ...
      _thread.enter(function _trc_BaseActor_ent_waitInputDevice(_thread) {
        ...
        for(var __cnt=100 ; __cnt--;) {
          ...
          case 0:
            //$LASTPOS=27009770;//kernel.BaseActor:9770
            _this.fiber$runAsync(_thread, (function anonymous_9779(f) {
    ...
    loadPage :function _trc_BaseActor_loadPage() {
      ...
      //$LASTPOS=27010040;//kernel.BaseActor:10040
    ...
    setVisible :function _trc_BaseActor_setVisible(v) {
      ...
      //$LASTPOS=27010165;//kernel.BaseActor:10165
    ...
    __setter__useObjectPool :function _trc_BaseActor___setter__useObjectPool(value) {
      ...
      //$LASTPOS=27010214;//kernel.BaseActor:10214
      if (value) {
        //$LASTPOS=27010236;//kernel.BaseActor:10236
    ...
    appear :function _trc_BaseActor_appear(o,param) {
      ...
      //$LASTPOS=27010329;//kernel.BaseActor:10329
      if (typeof  o=="function") {
        //$LASTPOS=27010366;//kernel.BaseActor:10366
        if (param) {
          //$LASTPOS=27010379;//kernel.BaseActor:10379
          param.layer=param.layer||_this.layer;
          
        }
        //$LASTPOS=27010422;//kernel.BaseActor:10422
        p = Tonyu.globals.$ObjectPool.withdraw(o.meta.fullName);
        
        //$LASTPOS=27010476;//kernel.BaseActor:10476
        if (p) {
          ...
          while(_it_225.next()) {
            ...
            //$LASTPOS=27010540;//kernel.BaseActor:10540
            if (k!="objectPoolAge") {
              //$LASTPOS=27010564;//kernel.BaseActor:10564
              delete p[k];
            }
            
          }
          //$LASTPOS=27010593;//kernel.BaseActor:10593
          o.call(p,param);
          return p;
    ...
    wait :function _trc_BaseActor_wait(t) {
      ...
      //$LASTPOS=27010744;//kernel.BaseActor:10744
      if (null) {
        //$LASTPOS=27010767;//kernel.BaseActor:10767
        null.suspend();
        //$LASTPOS=27010795;//kernel.BaseActor:10795
        if (t) {
          //$LASTPOS=27010817;//kernel.BaseActor:10817
          null.waitCount=t;
          //$LASTPOS=27010851;//kernel.BaseActor:10851
          if (_this.scheduler) {
            //$LASTPOS=27010866;//kernel.BaseActor:10866
            _this.scheduler.addToNext(null);
          }
        ...
        //$LASTPOS=27010919;//kernel.BaseActor:10919
        if (_this._th) {
          //$LASTPOS=27010939;//kernel.BaseActor:10939
          if (t) {
            //$LASTPOS=27010961;//kernel.BaseActor:10961
            _this._th.waitCount=t;
            
          } else {
            //$LASTPOS=27011009;//kernel.BaseActor:11009
            if (_this._th.scheduled) {
              //$LASTPOS=27011028;//kernel.BaseActor:11028
    ...
    notify :function _trc_BaseActor_notify() {
      ...
      //$LASTPOS=27011105;//kernel.BaseActor:11105
      if (_this._th) {
        //$LASTPOS=27011125;//kernel.BaseActor:11125
        if (_this._th.scheduled) {
          //$LASTPOS=27011160;//kernel.BaseActor:11160
          _this._th.waitCount=0;
          
        } else {
          //$LASTPOS=27011208;//kernel.BaseActor:11208
          if (_this.scheduler) {
            //$LASTPOS=27011223;//kernel.BaseActor:11223
            _this.scheduler.addToCur(_this._th);
          }
    ...
    findTouch :function _trc_BaseActor_findTouch(params) {
      ...
      //$LASTPOS=27011303;//kernel.BaseActor:11303
      if (typeof  params==="number") {
        //$LASTPOS=27011333;//kernel.BaseActor:11333
        params={scale: params};
      }
      //$LASTPOS=27011361;//kernel.BaseActor:11361
      params=params||{};
      
      //$LASTPOS=27011397;//kernel.BaseActor:11397
      if (params.width&&params.height) {
        //$LASTPOS=27011443;//kernel.BaseActor:11443
        r={x: _this.x,y: _this.y,width: params.width,height: params.height};
        
      } else {
        //$LASTPOS=27011516;//kernel.BaseActor:11516
        params.scale=params.scale||2;
        //$LASTPOS=27011555;//kernel.BaseActor:11555
        r=_this.getCrashRect();
        //$LASTPOS=27011582;//kernel.BaseActor:11582
        if (! r) {
          return null;
        }
        //$LASTPOS=27011612;//kernel.BaseActor:11612
        r={x: _this.x,y: _this.y,width: r.width*params.scale,height: r.height*params.scale};
        
      }
      //$LASTPOS=27011741;//kernel.BaseActor:11741
      _it_229=Tonyu.iterator(Tonyu.globals.$touches,1);
      while(_it_229.next()) {
        t=_it_229[0];
        
        //$LASTPOS=27011776;//kernel.BaseActor:11776
        if (params.pickup||t.touched==1) {
          //$LASTPOS=27011826;//kernel.BaseActor:11826
...
Tonyu.klass.define({
  ...
  methods: {
    main :function _trc_Boot_main() {
      ...
      _this.initEvents();
      //$LASTPOS=57000329;//kernel.Boot:329
      _this.initLayers();
      //$LASTPOS=57000344;//kernel.Boot:344
      _this.initPeripherals();
      //$LASTPOS=57000364;//kernel.Boot:364
      _this.loadPlugins();
      //$LASTPOS=57000380;//kernel.Boot:380
      _this.loadImages();
      //$LASTPOS=57000395;//kernel.Boot:395
      _this.loadSounds();
      //$LASTPOS=57000410;//kernel.Boot:410
      _this.createMainObject();
      //$LASTPOS=57000431;//kernel.Boot:431
      _this.progress();
      //$LASTPOS=57000444;//kernel.Boot:444
      _this.mainLoop();
    },
    ...
    initialize :function _trc_Boot_initialize(param) {
      ...
      //$LASTPOS=57000478;//kernel.Boot:478
      _this.extend(param);
    },
    update :function _trc_Boot_update() {
      ...
      //$LASTPOS=57000514;//kernel.Boot:514
    ...
    initEvents :function _trc_Boot_initEvents() {
      ...
      //$LASTPOS=57000619;//kernel.Boot:619
    ...
    initPeripherals :function _trc_Boot_initPeripherals() {
      ...
      //$LASTPOS=57000776;//kernel.Boot:776
      Tonyu.globals.$InputDevice=new Tonyu.classes.kernel.InputDevice;
      //$LASTPOS=57000811;//kernel.Boot:811
      Tonyu.globals.$InputDevice.initCanvasEvents(_this.cvj);
      //$LASTPOS=57000852;//kernel.Boot:852
      Tonyu.globals.$ObjectPool=new Tonyu.classes.kernel.ObjectPool;
      //$LASTPOS=57000885;//kernel.Boot:885
      Tonyu.globals.$pat_fruits=30;
      //$LASTPOS=57000906;//kernel.Boot:906
      Tonyu.globals.$Keys=new Tonyu.classes.kernel.Keys;
      //$LASTPOS=57000927;//kernel.Boot:927
      Tonyu.globals.$Math=Math;
      //$LASTPOS=57000944;//kernel.Boot:944
      Tonyu.globals.$consolePanel=new Tonyu.classes.kernel.Panel({align: "center",x: 465/2,y: 465/2,width: 465,height: 465,zOrder: - 10,layer: Tonyu.globals.$FrontSprites});
      //$LASTPOS=57001058;//kernel.Boot:1058
      Tonyu.globals.$consolePrintY=465-15;
      //$LASTPOS=57001086;//kernel.Boot:1086
      Tonyu.globals.$panel=new Tonyu.classes.kernel.Panel({align: "center",x: Tonyu.globals.$screenWidth/2,y: Tonyu.globals.$screenHeight/2,width: Tonyu.globals.$screenWidth,height: Tonyu.globals.$screenHeight,zOrder: - 1,layer: Tonyu.globals.$FrontSprites});
      //$LASTPOS=57001230;//kernel.Boot:1230
      _this.initFPSParams();
      //$LASTPOS=57001252;//kernel.Boot:1252
      Tonyu.globals.$WebPage=new Tonyu.classes.kernel.WebPage;
      //$LASTPOS=57001279;//kernel.Boot:1279
      Tonyu.globals.$Navigator=new Tonyu.classes.kernel.Navigator;
      //$LASTPOS=57001310;//kernel.Boot:1310
      Tonyu.globals.$mouseX=Tonyu.globals.$mouseX||0;
      //$LASTPOS=57001335;//kernel.Boot:1335
      Tonyu.globals.$mouseY=Tonyu.globals.$mouseY||0;
      //$LASTPOS=57001360;//kernel.Boot:1360
      _this.debugCnt=50;
      //$LASTPOS=57001378;//kernel.Boot:1378
      _this.newLimit=1000;
    },
    ...
    initLayers :function _trc_Boot_initLayers() {
      ...
      //$LASTPOS=57001716;//kernel.Boot:1716
      Tonyu.globals.$Screen.on("resize",(function anonymous_1737() {
        
        //$LASTPOS=57001749;//kernel.Boot:1749
        Tonyu.globals.$screenWidth=Tonyu.globals.$Screen.width;
        //$LASTPOS=57001786;//kernel.Boot:1786
        Tonyu.globals.$screenHeight=Tonyu.globals.$Screen.height;
        //$LASTPOS=57001825;//kernel.Boot:1825
        if (Tonyu.globals.$panel) {
          //$LASTPOS=57001850;//kernel.Boot:1850
          Tonyu.globals.$panel.setPanel(Tonyu.globals.$screenWidth,Tonyu.globals.$screenHeight);
          //$LASTPOS=57001908;//kernel.Boot:1908
          Tonyu.globals.$panel.x=Tonyu.globals.$screenWidth/2;
          //$LASTPOS=57001946;//kernel.Boot:1946
          Tonyu.globals.$panel.y=Tonyu.globals.$screenHeight/2;
          
        }
        //$LASTPOS=57001992;//kernel.Boot:1992
        if (Tonyu.globals.$consolePanel) {
          //$LASTPOS=57002024;//kernel.Boot:2024
          Tonyu.globals.$consolePanel.setPanel(Tonyu.globals.$screenWidth,Tonyu.globals.$screenHeight);
          //$LASTPOS=57002089;//kernel.Boot:2089
          Tonyu.globals.$consolePanel.x=Tonyu.globals.$screenWidth/2;
          //$LASTPOS=57002134;//kernel.Boot:2134
          Tonyu.globals.$consolePanel.y=Tonyu.globals.$screenHeight/2;
          //$LASTPOS=57002180;//kernel.Boot:2180
          Tonyu.globals.$consolePrintY=Tonyu.globals.$screenHeight-15;
          
        }
      }));
      //$LASTPOS=57002237;//kernel.Boot:2237
      Tonyu.globals.$Screen.addLayer(Tonyu.globals.$frontLayer);
      //$LASTPOS=57002273;//kernel.Boot:2273
      Tonyu.globals.$Screen.addLayer(Tonyu.globals.$mainLayer);
      //$LASTPOS=57002308;//kernel.Boot:2308
      Tonyu.globals.$Screen.addLayer(Tonyu.globals.$backLayer);
      //$LASTPOS=57002343;//kernel.Boot:2343
      Tonyu.globals.$Screen.setBGColor("rgb(20,80,180)");
      //$LASTPOS=57002386;//kernel.Boot:2386
      Tonyu.globals.$Screen.selectLayer(Tonyu.globals.$mainLayer);
      //$LASTPOS=57002424;//kernel.Boot:2424
      Tonyu.globals.$rootLayer=new Tonyu.classes.kernel.Sprites();
      //$LASTPOS=57002455;//kernel.Boot:2455
      Tonyu.globals.$uiScreen=new Tonyu.classes.kernel.Screen({canvas: $("canvas")[0],layer: Tonyu.globals.$rootLayer});
      //$LASTPOS=57002522;//kernel.Boot:2522
      Tonyu.globals.$uiScreen.setBGColor("#888");
      //$LASTPOS=57002557;//kernel.Boot:2557
      Tonyu.globals.$uiScreen.addLayer(Tonyu.globals.$uiLayer);
      //$LASTPOS=57002592;//kernel.Boot:2592
    ...
    debug :function _trc_Boot_debug() {
      ...
      //$LASTPOS=57002677;//kernel.Boot:2677
      if (! _this.debugCnt) {
        return _this;
      }
      //$LASTPOS=57002705;//kernel.Boot:2705
      _this.debugCnt--;
      //$LASTPOS=57002722;//kernel.Boot:2722
      a = Array.prototype.slice.call(arguments);
      
      //$LASTPOS=57002772;//kernel.Boot:2772
      a.unshift(_this.debugCnt);
      //$LASTPOS=57002798;//kernel.Boot:2798
      a.unshift("DEBUG");
      //$LASTPOS=57002823;//kernel.Boot:2823
    ...
    loadPlugins :function _trc_Boot_loadPlugins() {
      ...
      //$LASTPOS=57003164;//kernel.Boot:3164
      _this.progress("Loading plugins..");
      //$LASTPOS=57003200;//kernel.Boot:3200
      _this.runAsync((function anonymous_3209(r) {
        
        //$LASTPOS=57003225;//kernel.Boot:3225
        Tonyu.globals.$currentProject.loadPlugins(r);
      }));
      //$LASTPOS=57003270;//kernel.Boot:3270
      ...
      _thread.enter(function _trc_Boot_ent_loadPlugins(_thread) {
        ...
        for(var __cnt=100 ; __cnt--;) {
          ...
          case 1:
            ...
            //$LASTPOS=57003200;//kernel.Boot:3200
            _this.fiber$runAsync(_thread, (function anonymous_3209(r) {
    ...
    loadImages :function _trc_Boot_loadImages() {
      ...
      //$LASTPOS=57003329;//kernel.Boot:3329
      _this.progress("Loading pats..");
      //$LASTPOS=57003362;//kernel.Boot:3362
      rs = Tonyu.globals.$currentProject.getResource();
      
      
      //$LASTPOS=57003417;//kernel.Boot:3417
      r=_this.runAsync((function anonymous_3428(succ) {
        
        //$LASTPOS=57003447;//kernel.Boot:3447
        ImageList.load(rs.images,succ,{baseDir: Tonyu.globals.$currentProject.getDir(),prj: Tonyu.globals.$currentProject});
      }));
      //$LASTPOS=57003606;//kernel.Boot:3606
      Tonyu.globals.$imageList=r[0];
      //$LASTPOS=57003664;//kernel.Boot:3664
      _it_456=Tonyu.iterator(r[0].names,2);
      while(_it_456.next()) {
        name=_it_456[0];
        val=_it_456[1];
        
        //$LASTPOS=57003708;//kernel.Boot:3708
      ...
      _thread.enter(function _trc_Boot_ent_loadImages(_thread) {
        ...
        for(var __cnt=100 ; __cnt--;) {
          ...
          case 1:
            ...
            //$LASTPOS=57003417;//kernel.Boot:3417
            _this.fiber$runAsync(_thread, (function anonymous_3428(succ) {
    ...
    loadSounds :function _trc_Boot_loadSounds() {
      ...
      //$LASTPOS=57003805;//kernel.Boot:3805
      _this.progress("Loading sounds...");
      //$LASTPOS=57003841;//kernel.Boot:3841
      _this.initT2MediaPlayer();
      //$LASTPOS=57003867;//kernel.Boot:3867
      _this.loadFromProject(Tonyu.globals.$currentProject);
      //$LASTPOS=57003906;//kernel.Boot:3906
      _this.progress("Loading sounds done.");
      //$LASTPOS=57003945;//kernel.Boot:3945
      _this.on("stop",(function anonymous_3955() {
        
        //$LASTPOS=57003967;//kernel.Boot:3967
        _this.clearSEData();
      }));
      //$LASTPOS=57003995;//kernel.Boot:3995
    ...
    createMainObject :function _trc_Boot_createMainObject() {
      ...
      //$LASTPOS=57004041;//kernel.Boot:4041
      o = Tonyu.currentProject.getOptions();
      
      //$LASTPOS=57004087;//kernel.Boot:4087
      mainClassName = o.run.mainClass;
      
      //$LASTPOS=57004127;//kernel.Boot:4127
      _this.progress("MainClass= "+mainClassName);
      //$LASTPOS=57004171;//kernel.Boot:4171
      _this.mainClass=Tonyu.getClass(mainClassName);
      //$LASTPOS=57004217;//kernel.Boot:4217
      if (! _this.mainClass) {
        throw new Error(mainClassName+" というクラスはありません");
        
        
      }
      //$LASTPOS=57004305;//kernel.Boot:4305
      Tonyu.globals.$excludeFromAll=Tonyu.globals.$Screen.all();
      //$LASTPOS=57004341;//kernel.Boot:4341
      new _this.mainClass();
    },
    ...
    loadPage :function _trc_Boot_loadPage(page,arg) {
      ...
      //$LASTPOS=57004389;//kernel.Boot:4389
      a = Tonyu.globals.$Screen.all();
      
      //$LASTPOS=57004415;//kernel.Boot:4415
      a=a.find((function anonymous_4424(e) {
        
        return ! Tonyu.globals.$excludeFromAll.contains(e);
      }));
      //$LASTPOS=57004476;//kernel.Boot:4476
      a.die();
    ...
    stop :function _trc_Boot_stop() {
      ...
      //$LASTPOS=57004524;//kernel.Boot:4524
      _this.fireEvent("stop");
      //$LASTPOS=57004548;//kernel.Boot:4548
      _this.die();
    },
    ...
    progress :function _trc_Boot_progress(m) {
      ...
      //$LASTPOS=57004840;//kernel.Boot:4840
      if (typeof  SplashScreen=="undefined") {
        return _this;
      }
      //$LASTPOS=57004891;//kernel.Boot:4891
      if (m) {
        //$LASTPOS=57004909;//kernel.Boot:4909
        console.log.apply(console,arguments);
        //$LASTPOS=57004956;//kernel.Boot:4956
    ...
    mainLoop :function _trc_Boot_mainLoop() {
      ...
      //$LASTPOS=57005040;//kernel.Boot:5040
      Tonyu.globals.$frameCount=0;
      //$LASTPOS=57005060;//kernel.Boot:5060
      Tonyu.globals.$drawnFrameCount=0;
      //$LASTPOS=57005085;//kernel.Boot:5085
      while (true) {
        //$LASTPOS=57005106;//kernel.Boot:5106
        if (_this._useRAF) {
          //$LASTPOS=57005119;//kernel.Boot:5119
          _this.loopRAF();
        } else {
          //$LASTPOS=57005141;//kernel.Boot:5141
          _this.loopTimer();
        }
        //$LASTPOS=57005163;//kernel.Boot:5163
        _this.measureFps();
        //$LASTPOS=57005183;//kernel.Boot:5183
        _this.handlePause();
        //$LASTPOS=57005207;//kernel.Boot:5207
    ...
    loopRAF :function _trc_Boot_loopRAF() {
      ...
      //$LASTPOS=57005256;//kernel.Boot:5256
      nowTime = _this.now();
      
      //$LASTPOS=57005297;//kernel.Boot:5297
      frameTime = 1000/_this._fps;
      
      //$LASTPOS=57005341;//kernel.Boot:5341
      moves = 0;
      
      
      //$LASTPOS=57005420;//kernel.Boot:5420
      ...
      //$LASTPOS=57005520;//kernel.Boot:5520
      bufferTime=(0.5*_this._fps/60);
      //$LASTPOS=57005613;//kernel.Boot:5613
      if (_this.procCnt>=1-bufferTime&&_this.procCnt<=1+bufferTime) {
        //$LASTPOS=57005673;//kernel.Boot:5673
        _this.procCnt=1;
      }
      //$LASTPOS=57005693;//kernel.Boot:5693
      _this.procCnt=_this.floor(_this.procCnt);
      //$LASTPOS=57005724;//kernel.Boot:5724
      if (_this.procCnt>_this.maxFrameSkip) {
        //$LASTPOS=57005763;//kernel.Boot:5763
        _this.procCnt=_this.maxFrameSkip;
        //$LASTPOS=57005796;//kernel.Boot:5796
        _this.rafProcNowTime=nowTime;
        
      } else {
        //$LASTPOS=57005845;//kernel.Boot:5845
        _this.rafProcNowTime+=_this.procCnt*frameTime;
        
      }
      //$LASTPOS=57005942;//kernel.Boot:5942
      while (moves<_this.procCnt) {
        //$LASTPOS=57005968;//kernel.Boot:5968
        _this.moveFrame();
        //$LASTPOS=57005984;//kernel.Boot:5984
        moves++;
        //$LASTPOS=57005999;//kernel.Boot:5999
        if (moves<_this.procCnt) {
          //$LASTPOS=57006018;//kernel.Boot:6018
          _this.afterDraw(false);
        }
        
      }
      //$LASTPOS=57006071;//kernel.Boot:6071
      if (moves>0) {
        //$LASTPOS=57006097;//kernel.Boot:6097
        _this.drawFrame();
        //$LASTPOS=57006119;//kernel.Boot:6119
        _this.afterDraw(true);
        
      }
      //$LASTPOS=57006176;//kernel.Boot:6176
      _this.waitRAF();
    },
    ...
    waitRAF :function _trc_Boot_waitRAF() {
      ...
      //$LASTPOS=57006615;//kernel.Boot:6615
    ...
    loopTimer :function _trc_Boot_loopTimer() {
      ...
      //$LASTPOS=57007561;//kernel.Boot:7561
      _this.moveFrame();
      //$LASTPOS=57007579;//kernel.Boot:7579
      _this.doDraw=_this.now()<_this.deadLine;
      //$LASTPOS=57007607;//kernel.Boot:7607
      if (! _this.doDraw&&_this.frameSkipped>=_this.maxFrameSkip) {
        //$LASTPOS=57007661;//kernel.Boot:7661
        _this.doDraw=true;
        //$LASTPOS=57007683;//kernel.Boot:7683
        _this.resetDeadLine();
        
      }
      //$LASTPOS=57007712;//kernel.Boot:7712
      if (_this.doDraw) {
        //$LASTPOS=57007749;//kernel.Boot:7749
        _this.drawFrame();
        //$LASTPOS=57007771;//kernel.Boot:7771
        _this.frameSkipped=0;
        
      } else {
        //$LASTPOS=57007810;//kernel.Boot:7810
        _this.frameSkipped++;
        
      }
      //$LASTPOS=57007838;//kernel.Boot:7838
      _this.afterDraw(_this.doDraw);
      //$LASTPOS=57007862;//kernel.Boot:7862
      _this.waitFrame();
    },
    ...
    handlePause :function _trc_Boot_handlePause() {
      ...
      //$LASTPOS=57007910;//kernel.Boot:7910
      while (_this.paused) {
        //$LASTPOS=57007935;//kernel.Boot:7935
        _this.waitFor(Tonyu.timeout(1));
        //$LASTPOS=57007971;//kernel.Boot:7971
        if (! _this.paused) {
          //$LASTPOS=57007984;//kernel.Boot:7984
          _this.resetDeadLine();
        }
    ...
    drawFrame :function _trc_Boot_drawFrame() {
      ...
      //$LASTPOS=57008039;//kernel.Boot:8039
      s = _this.now();
      
      //$LASTPOS=57008057;//kernel.Boot:8057
      Tonyu.globals.$uiScreen.drawLayers();
      //$LASTPOS=57008086;//kernel.Boot:8086
      _this.drawTime=_this.now()-s;
      //$LASTPOS=57008109;//kernel.Boot:8109
      _this.fps_fpsCnt++;
    },
    moveFrame :function _trc_Boot_moveFrame() {
      ...
      //$LASTPOS=57008438;//kernel.Boot:8438
      s = _this.now();
      
      //$LASTPOS=57008456;//kernel.Boot:8456
      Tonyu.resetLoopCheck();
      //$LASTPOS=57008485;//kernel.Boot:8485
      if (_this.newLimit) {
        //$LASTPOS=57008499;//kernel.Boot:8499
        _this.newLimitCount=_this.newLimit;
      }
      //$LASTPOS=57008557;//kernel.Boot:8557
      _this.scheduler.stepsAll();
      //$LASTPOS=57008613;//kernel.Boot:8613
      Tonyu.globals.$Keys.update();
      //$LASTPOS=57008663;//kernel.Boot:8663
      Tonyu.globals.$InputDevice.update();
      //$LASTPOS=57008720;//kernel.Boot:8720
      Tonyu.globals.$screenWidth=Tonyu.globals.$Screen.width;
      //$LASTPOS=57008753;//kernel.Boot:8753
      Tonyu.globals.$screenHeight=Tonyu.globals.$Screen.height;
      //$LASTPOS=57008788;//kernel.Boot:8788
      _this.moveTime=_this.now()-s;
      //$LASTPOS=57008811;//kernel.Boot:8811
      _this.fps_rpsCnt++;
      //$LASTPOS=57008831;//kernel.Boot:8831
    ...
    afterDraw :function _trc_Boot_afterDraw(drawn) {
      ...
      //$LASTPOS=57008972;//kernel.Boot:8972
      Tonyu.globals.$Sprites.checkHit();
      //$LASTPOS=57009027;//kernel.Boot:9027
    ...
    initFPSParams :function _trc_Boot_initFPSParams() {
      ...
      //$LASTPOS=57009143;//kernel.Boot:9143
      _this._fps=30;
      //$LASTPOS=57009159;//kernel.Boot:9159
      _this.maxFrameSkip=5;
      //$LASTPOS=57009182;//kernel.Boot:9182
      _this.minFrameSkip=1;
      //$LASTPOS=57009232;//kernel.Boot:9232
      _this.frameCnt=0;
      //$LASTPOS=57009251;//kernel.Boot:9251
      _this.resetDeadLine();
      //$LASTPOS=57009273;//kernel.Boot:9273
      _this.lastMeasured=_this.now();
      //$LASTPOS=57009298;//kernel.Boot:9298
      _this.fps_fps=_this.fps_rps=_this.fps_fpsCnt=_this.fps_rpsCnt=0;
      //$LASTPOS=57009344;//kernel.Boot:9344
      _this.drawTime=5;
      //$LASTPOS=57009355;//kernel.Boot:9355
      _this.moveTime=5;
      //$LASTPOS=57009413;//kernel.Boot:9413
      _this._useRAF=true;
      //$LASTPOS=57009467;//kernel.Boot:9467
    ...
    resetDeadLine :function _trc_Boot_resetDeadLine() {
      ...
      //$LASTPOS=57009578;//kernel.Boot:9578
      _this.deadLine=_this.now()+1000/_this._fps;
      //$LASTPOS=57009609;//kernel.Boot:9609
      _this.frameSkipped=0;
    },
    waitFrame :function _trc_Boot_waitFrame() {
      ...
      //$LASTPOS=57009653;//kernel.Boot:9653
      wt = _this.deadLine-_this.now();
      
      //$LASTPOS=57009681;//kernel.Boot:9681
      if (wt<1) {
        //$LASTPOS=57009702;//kernel.Boot:9702
        if (wt<- 1000) {
          //$LASTPOS=57009716;//kernel.Boot:9716
          _this.resetDeadLine();
        }
        //$LASTPOS=57009742;//kernel.Boot:9742
        wt=1;
        
      }
      //$LASTPOS=57009760;//kernel.Boot:9760
      wt=_this.floor(wt);
      //$LASTPOS=57009779;//kernel.Boot:9779
      _this.waitFor(Tonyu.timeout(wt));
      //$LASTPOS=57009812;//kernel.Boot:9812
    ...
    setFrameRate :function _trc_Boot_setFrameRate(fps,maxFrameSkip) {
      ...
      //$LASTPOS=57010096;//kernel.Boot:10096
      _this._fps=fps;
      //$LASTPOS=57010113;//kernel.Boot:10113
      if (typeof  maxFrameSkip!="number") {
        //$LASTPOS=57010148;//kernel.Boot:10148
        maxFrameSkip=5;
      }
      //$LASTPOS=57010169;//kernel.Boot:10169
      if (maxFrameSkip<=0) {
        //$LASTPOS=57010190;//kernel.Boot:10190
        maxFrameSkip=1;
      }
      //$LASTPOS=57010211;//kernel.Boot:10211
    ...
    __setter__useRAF :function _trc_Boot___setter__useRAF(v) {
      ...
      //$LASTPOS=57010354;//kernel.Boot:10354
      if (v) {
        //$LASTPOS=57010372;//kernel.Boot:10372
        _this.rafProcNowTime=_this.now();
        
      } else {
        //$LASTPOS=57010417;//kernel.Boot:10417
        _this.resetDeadLine();
    ...
    measureFps :function _trc_Boot_measureFps() {
      ...
      //$LASTPOS=57010655;//kernel.Boot:10655
      nowTime = _this.now();
      
      //$LASTPOS=57010681;//kernel.Boot:10681
      if (nowTime>=_this.lastMeasured+1000) {
        //$LASTPOS=57010724;//kernel.Boot:10724
        _this.fps_fps=_this.fps_fpsCnt;
        //$LASTPOS=57010753;//kernel.Boot:10753
        _this.fps_rps=_this.fps_rpsCnt;
        //$LASTPOS=57010782;//kernel.Boot:10782
        _this.fps_fpsCnt=0;
        //$LASTPOS=57010805;//kernel.Boot:10805
        _this.fps_rpsCnt=0;
        //$LASTPOS=57010828;//kernel.Boot:10828
