...
Tonyu.klass.define({
  ...
  methods: {
    ...
    stepsAll :function _trc_Scheduler_stepsAll() {
      ...
      _it_186=Tonyu.iterator(_this.cur,1);
      while(_it_186.next()) {
        t=_it_186[0];
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    loadFromProject :function _trc_T2MediaPlayer_loadFromProject(prj) {
      ...
      _it_288=Tonyu.iterator(r.sounds,1);
      while(_it_288.next()) {
        s=_it_288[0];
...
Tonyu.klass.define({
  ...
  methods: {
    ...
    initSprites :function _trc_Boot_initSprites() {
      ...
      _it_325=Tonyu.iterator(r[0].names,2);
      while(_it_325.next()) {
        name=_it_325[0];
        val=_it_325[1];
